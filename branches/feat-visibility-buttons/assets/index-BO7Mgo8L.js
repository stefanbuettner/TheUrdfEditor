...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function yy(n,e,t){const i=new Float32Array(gs),s=new j(0,1,0);return new pi({name:"SphericalGaussianBlur",defines:{n:gs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Ha(),fragmentShader:`
...
`)}const Ab={[$d]:"Linear",[Kd]:"Reinhard",[Jd]:"Cineon",[Zd]:"ACESFilmic",[ep]:"AgX",[tp]:"Neutral",[Qd]:"Custom"};function wb(n,e){const t=Ab[e];return t===void 0?(it("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const jo=new j;function Rb(){vt.getLuminanceCoefficients(jo);const n=jo.x.toFixed(4),e=jo.y.toFixed(4),t=jo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const D=A+m+o,E=A+p+a,R=Af(s,s.VERTEX_SHADER,D),N=Af(s,s.FRAGMENT_SHADER,E);s.attachShader(x,R),s.attachShader(x,N),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function L(F){if(n.debug.checkShaderErrors){const z=s.getProgramInfoLog(x)||"",H=s.getShaderInfoLog(R)||"",ie=s.getShaderInfoLog(N)||"",ne=z.trim(),k=H.trim(),G=ie.trim();let K=!0,ve=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(K=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,R,N);else{const se=Rf(s,R,"vertex"),q=Rf(s,N,"fragment");_t("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+ne+`
`+se+`
`+q)}else ne!==""?it("WebGLProgram: Program Info Log:",ne):(k===""||G==="")&&(ve=!1);ve&&(F.diagnostics={runnable:K,programLog:ne,vertexShader:{log:k,prefix:m},fragmentShader:{log:G,prefix:p}})}s.deleteShader(R),s.deleteShader(N),U=new la(s,x),v=Db(s,x)}let U;this.getUniforms=function(){return U===void 0&&L(this),U};let v;this.getAttributes=function(){return v===void 0&&L(this),v};let b=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return b===!1&&(b=s.getProgramParameter(x,yb)),b},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=bb++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=R,this.fragmentShader=N,this}let jb=0;class Yb{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new $b(e),t.set(e,i)),i}}class $b{constructor(e){this.id=jb++,this.code=e,this.usedTimes=0}}function Kb(n,e,t,i,s,r,o){const a=new Ru,l=new Yb,c=new Set,u=[],h=new Map,f=s.logarithmicDepthBuffer;let d=s.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(v){return c.add(v),v===0?"uv":`uv${v}`}function m(v,b,F,z,H){const ie=z.fog,ne=H.geometry,k=v.isMeshStandardMaterial?z.environment:null,G=(v.isMeshStandardMaterial?t:e).get(v.envMap||k),K=G&&G.mapping===Fa?G.image.height:null,ve=_[v.type];v.precision!==null&&(d=s.getMaxPrecision(v.precision),d!==v.precision&&it("WebGLProgram.getParameters:",v.precision,"not supported, using",d,"instead."));const se=ne.morphAttributes.position||ne.morphAttributes.normal||ne.morphAttributes.color,q=se!==void 0?se.length:0;let te=0;ne.morphAttributes.position!==void 0&&(te=1),ne.morphAttributes.normal!==void 0&&(te=2),ne.morphAttributes.color!==void 0&&(te=3);let pe,_e,Me,X;if(ve){const dt=ri[ve];pe=dt.vertexShader,_e=dt.fragmentShader}else pe=v.vertexShader,_e=v.fragmentShader,l.update(v),Me=l.getVertexShaderID(v),X=l.getFragmentShaderID(v);const $=n.getRenderTarget(),ye=n.state.buffers.depth.getReversed(),Je=H.isInstancedMesh===!0,Ie=H.isBatchedMesh===!0,Mt=!!v.map,O=!!v.matcap,V=!!G,Q=!!v.aoMap,he=!!v.lightMap,ae=!!v.bumpMap,fe=!!v.normalMap,I=!!v.displacementMap,be=!!v.emissiveMap,me=!!v.metalnessMap,ue=!!v.roughnessMap,ge=v.anisotropy>0,T=v.clearcoat>0,g=v.dispersion>0,B=v.iridescence>0,ee=v.sheen>0,ce=v.transmission>0,Z=ge&&!!v.anisotropyMap,Fe=T&&!!v.clearcoatMap,Te=T&&!!v.clearcoatNormalMap,ke=T&&!!v.clearcoatRoughnessMap,Ke=B&&!!v.iridescenceMap,Se=B&&!!v.iridescenceThicknessMap,Ce=ee&&!!v.sheenColorMap,Le=ee&&!!v.sheenRoughnessMap,Ve=!!v.specularMap,Re=!!v.specularColorMap,lt=!!v.specularIntensityMap,W=ce&&!!v.transmissionMap,Be=ce&&!!v.thicknessMap,we=!!v.gradientMap,Ge=!!v.alphaMap,Ae=v.alphaTest>0,xe=!!v.alphaHash,Pe=!!v.extensions;let ot=ui;v.toneMapped&&($===null||$.isXRRenderTarget===!0)&&(ot=n.toneMapping);const Ut={shaderID:ve,shaderType:v.type,shaderName:v.name,vertexShader:pe,fragmentShader:_e,defines:v.defines,customVertexShaderID:Me,customFragmentShaderID:X,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:d,batching:Ie,batchingColor:Ie&&H._colorsTexture!==null,instancing:Je,instancingColor:Je&&H.instanceColor!==null,instancingMorph:Je&&H.morphTexture!==null,outputColorSpace:$===null?n.outputColorSpace:$.isXRRenderTarget===!0?$.texture.colorSpace:ur,alphaToCoverage:!!v.alphaToCoverage,map:Mt,matcap:O,envMap:V,envMapMode:V&&G.mapping,envMapCubeUVHeight:K,aoMap:Q,lightMap:he,bumpMap:ae,normalMap:fe,displacementMap:I,emissiveMap:be,normalMapObjectSpace:fe&&v.normalMapType===n0,normalMapTangentSpace:fe&&v.normalMapType===Su,metalnessMap:me,roughnessMap:ue,anisotropy:ge,anisotropyMap:Z,clearcoat:T,clearcoatMap:Fe,clearcoatNormalMap:Te,clearcoatRoughnessMap:ke,dispersion:g,iridescence:B,iridescenceMap:Ke,iridescenceThicknessMap:Se,sheen:ee,sheenColorMap:Ce,sheenRoughnessMap:Le,specularMap:Ve,specularColorMap:Re,specularIntensityMap:lt,transmission:ce,transmissionMap:W,thicknessMap:Be,gradientMap:we,opaque:v.transparent===!1&&v.blending===nr&&v.alphaToCoverage===!1,alphaMap:Ge,alphaTest:Ae,alphaHash:xe,combine:v.combine,mapUv:Mt&&x(v.map.channel),aoMapUv:Q&&x(v.aoMap.channel),lightMapUv:he&&x(v.lightMap.channel),bumpMapUv:ae&&x(v.bumpMap.channel),normalMapUv:fe&&x(v.normalMap.channel),displacementMapUv:I&&x(v.displacementMap.channel),emissiveMapUv:be&&x(v.emissiveMap.channel),metalnessMapUv:me&&x(v.metalnessMap.channel),roughnessMapUv:ue&&x(v.roughnessMap.channel),anisotropyMapUv:Z&&x(v.anisotropyMap.channel),clearcoatMapUv:Fe&&x(v.clearcoatMap.channel),clearcoatNormalMapUv:Te&&x(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ke&&x(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Ke&&x(v.iridescenceMap.channel),iridescenceThicknessMapUv:Se&&x(v.iridescenceThicknessMap.channel),sheenColorMapUv:Ce&&x(v.sheenColorMap.channel),sheenRoughnessMapUv:Le&&x(v.sheenRoughnessMap.channel),specularMapUv:Ve&&x(v.specularMap.channel),specularColorMapUv:Re&&x(v.specularColorMap.channel),specularIntensityMapUv:lt&&x(v.specularIntensityMap.channel),transmissionMapUv:W&&x(v.transmissionMap.channel),thicknessMapUv:Be&&x(v.thicknessMap.channel),alphaMapUv:Ge&&x(v.alphaMap.channel),vertexTangents:!!ne.attributes.tangent&&(fe||ge),vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!ne.attributes.color&&ne.attributes.color.itemSize===4,pointsUvs:H.isPoints===!0&&!!ne.attributes.uv&&(Mt||Ge),fog:!!ie,useFog:v.fog===!0,fogExp2:!!ie&&ie.isFogExp2,flatShading:v.flatShading===!0&&v.wireframe===!1,sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:ye,skinning:H.isSkinnedMesh===!0,morphTargets:ne.morphAttributes.position!==void 0,morphNormals:ne.morphAttributes.normal!==void 0,morphColors:ne.morphAttributes.color!==void 0,morphTargetsCount:q,morphTextureStride:te,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:v.dithering,shadowMapEnabled:n.shadowMap.enabled&&F.length>0,shadowMapType:n.shadowMap.type,toneMapping:ot,decodeVideoTexture:Mt&&v.map.isVideoTexture===!0&&vt.getTransfer(v.map.colorSpace)===It,decodeVideoTextureEmissive:be&&v.emissiveMap.isVideoTexture===!0&&vt.getTransfer(v.emissiveMap.colorSpace)===It,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===oi,flipSided:v.side===Rn,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:Pe&&v.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Pe&&v.extensions.multiDraw===!0||Ie)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return Ut.vertexUv1s=c.has(1),Ut.vertexUv2s=c.has(2),Ut.vertexUv3s=c.has(3),c.clear(),Ut}function p(v){const b=[];if(v.shaderID?b.push(v.shaderID):(b.push(v.customVertexShaderID),b.push(v.customFragmentShaderID)),v.defines!==void 0)for(const F in v.defines)b.push(F),b.push(v.defines[F]);return v.isRawShaderMaterial===!1&&(A(b,v),D(b,v),b.push(n.outputColorSpace)),b.push(v.customProgramCacheKey),b.join()}function A(v,b){v.push(b.precision),v.push(b.outputColorSpace),v.push(b.envMapMode),v.push(b.envMapCubeUVHeight),v.push(b.mapUv),v.push(b.alphaMapUv),v.push(b.lightMapUv),v.push(b.aoMapUv),v.push(b.bumpMapUv),v.push(b.normalMapUv),v.push(b.displacementMapUv),v.push(b.emissiveMapUv),v.push(b.metalnessMapUv),v.push(b.roughnessMapUv),v.push(b.anisotropyMapUv),v.push(b.clearcoatMapUv),v.push(b.clearcoatNormalMapUv),v.push(b.clearcoatRoughnessMapUv),v.push(b.iridescenceMapUv),v.push(b.iridescenceThicknessMapUv),v.push(b.sheenColorMapUv),v.push(b.sheenRoughnessMapUv),v.push(b.specularMapUv),v.push(b.specularColorMapUv),v.push(b.specularIntensityMapUv),v.push(b.transmissionMapUv),v.push(b.thicknessMapUv),v.push(b.combine),v.push(b.fogExp2),v.push(b.sizeAttenuation),v.push(b.morphTargetsCount),v.push(b.morphAttributeCount),v.push(b.numDirLights),v.push(b.numPointLights),v.push(b.numSpotLights),v.push(b.numSpotLightMaps),v.push(b.numHemiLights),v.push(b.numRectAreaLights),v.push(b.numDirLightShadows),v.push(b.numPointLightShadows),v.push(b.numSpotLightShadows),v.push(b.numSpotLightShadowsWithMaps),v.push(b.numLightProbes),v.push(b.shadowMapType),v.push(b.toneMapping),v.push(b.numClippingPlanes),v.push(b.numClipIntersection),v.push(b.depthPacking)}function D(v,b){a.disableAll(),b.instancing&&a.enable(0),b.instancingColor&&a.enable(1),b.instancingMorph&&a.enable(2),b.matcap&&a.enable(3),b.envMap&&a.enable(4),b.normalMapObjectSpace&&a.enable(5),b.normalMapTangentSpace&&a.enable(6),b.clearcoat&&a.enable(7),b.iridescence&&a.enable(8),b.alphaTest&&a.enable(9),b.vertexColors&&a.enable(10),b.vertexAlphas&&a.enable(11),b.vertexUv1s&&a.enable(12),b.vertexUv2s&&a.enable(13),b.vertexUv3s&&a.enable(14),b.vertexTangents&&a.enable(15),b.anisotropy&&a.enable(16),b.alphaHash&&a.enable(17),b.batching&&a.enable(18),b.dispersion&&a.enable(19),b.batchingColor&&a.enable(20),b.gradientMap&&a.enable(21),v.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.reversedDepthBuffer&&a.enable(4),b.skinning&&a.enable(5),b.morphTargets&&a.enable(6),b.morphNormals&&a.enable(7),b.morphColors&&a.enable(8),b.premultipliedAlpha&&a.enable(9),b.shadowMapEnabled&&a.enable(10),b.doubleSided&&a.enable(11),b.flipSided&&a.enable(12),b.useDepthPacking&&a.enable(13),b.dithering&&a.enable(14),b.transmission&&a.enable(15),b.sheen&&a.enable(16),b.opaque&&a.enable(17),b.pointsUvs&&a.enable(18),b.decodeVideoTexture&&a.enable(19),b.decodeVideoTextureEmissive&&a.enable(20),b.alphaToCoverage&&a.enable(21),v.push(a.mask)}function E(v){const b=_[v.type];let F;if(b){const z=ri[b];F=q0.clone(z.uniforms)}else F=v.uniforms;return F}function R(v,b){let F=h.get(b);return F!==void 0?++F.usedTimes:(F=new qb(n,b,v,r),u.push(F),h.set(b,F)),F}function N(v){if(--v.usedTimes===0){const b=u.indexOf(v);u[b]=u[u.length-1],u.pop(),h.delete(v.cacheKey),v.destroy()}}function L(v){l.remove(v)}function U(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:E,acquireProgram:R,releaseProgram:N,releaseShaderCache:L,programs:u,dispose:U}}function Jb(){let n=new WeakMap;function e(o){return n.has(o)}function t(o){let a=n.get(o);return a===void 0&&(a={},n.set(o,a)),a}function i(o){n.delete(o)}function s(o,a,l){n.get(o)[a]=l}function r(){n=new WeakMap}return{has:e,get:t,remove:i,update:s,dispose:r}}function Zb(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Nf(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function If(){const n=[];let e=0;const t=[],i=[],s=[];function r(){e=0,t.length=0,i.length=0,s.length=0}function o(h,f,d,_,x,m){let p=n[e];return p===void 0?(p={id:h.id,object:h,geometry:f,material:d,groupOrder:_,renderOrder:h.renderOrder,z:x,group:m},n[e]=p):(p.id=h.id,p.object=h,p.geometry=f,p.material=d,p.groupOrder=_,p.renderOrder=h.renderOrder,p.z=x,p.group=m),e++,p}function a(h,f,d,_,x,m){const p=o(h,f,d,_,x,m);d.transmission>0?i.push(p):d.transparent===!0?s.push(p):t.push(p)}function l(h,f,d,_,x,m){const p=o(h,f,d,_,x,m);d.transmission>0?i.unshift(p):d.transparent===!0?s.unshift(p):t.unshift(p)}function c(h,f){t.length>1&&t.sort(h||Zb),i.length>1&&i.sort(f||Nf),s.length>1&&s.sort(f||Nf)}function u(){for(let h=e,f=n.length;h<f;h++){const d=n[h];if(d.id===null)break;d.id=null,d.object=null,d.geometry=null,d.material=null,d.group=null}}return{opaque:t,transmissive:i,transparent:s,init:r,push:a,unshift:l,finish:u,sort:c}}function Qb(){let n=new WeakMap;function e(i,s){const r=n.get(i);let o;return r===void 0?(o=new If,n.set(i,[o])):s>=r.length?(o=new If,r.push(o)):o=r[s],o}function t(){n=new WeakMap}return{get:e,dispose:t}}function eS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new j,color:new ft};break;case"SpotLight":t={position:new j,direction:new j,color:new ft,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new j,color:new ft,distance:0,decay:0};break;case"HemisphereLight":t={direction:new j,skyColor:new ft,groundColor:new ft};break;case"RectAreaLight":t={color:new ft,position:new j,halfWidth:new j,halfHeight:new j};break}return n[e.id]=t,t}}}function tS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new at,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let nS=0;function iS(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function sS(n){const e=new eS,t=tS(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new j);const s=new j,r=new ct,o=new ct;function a(c){let u=0,h=0,f=0;for(let v=0;v<9;v++)i.probe[v].set(0,0,0);let d=0,_=0,x=0,m=0,p=0,A=0,D=0,E=0,R=0,N=0,L=0;c.sort(iS);for(let v=0,b=c.length;v<b;v++){const F=c[v],z=F.color,H=F.intensity,ie=F.distance;let ne=null;if(F.shadow&&F.shadow.map&&(F.shadow.map.texture.format===cr?ne=F.shadow.map.texture:ne=F.shadow.map.depthTexture||F.shadow.map.texture),F.isAmbientLight)u+=z.r*H,h+=z.g*H,f+=z.b*H;else if(F.isLightProbe){for(let k=0;k<9;k++)i.probe[k].addScaledVector(F.sh.coefficients[k],H);L++}else if(F.isDirectionalLight){const k=e.get(F);if(k.color.copy(F.color).multiplyScalar(F.intensity),F.castShadow){const G=F.shadow,K=t.get(F);K.shadowIntensity=G.intensity,K.shadowBias=G.bias,K.shadowNormalBias=G.normalBias,K.shadowRadius=G.radius,K.shadowMapSize=G.mapSize,i.directionalShadow[d]=K,i.directionalShadowMap[d]=ne,i.directionalShadowMatrix[d]=F.shadow.matrix,A++}i.directional[d]=k,d++}else if(F.isSpotLight){const k=e.get(F);k.position.setFromMatrixPosition(F.matrixWorld),k.color.copy(z).multiplyScalar(H),k.distance=ie,k.coneCos=Math.cos(F.angle),k.penumbraCos=Math.cos(F.angle*(1-F.penumbra)),k.decay=F.decay,i.spot[x]=k;const G=F.shadow;if(F.map&&(i.spotLightMap[R]=F.map,R++,G.updateMatrices(F),F.castShadow&&N++),i.spotLightMatrix[x]=G.matrix,F.castShadow){const K=t.get(F);K.shadowIntensity=G.intensity,K.shadowBias=G.bias,K.shadowNormalBias=G.normalBias,K.shadowRadius=G.radius,K.shadowMapSize=G.mapSize,i.spotShadow[x]=K,i.spotShadowMap[x]=ne,E++}x++}else if(F.isRectAreaLight){const k=e.get(F);k.color.copy(z).multiplyScalar(H),k.halfWidth.set(F.width*.5,0,0),k.halfHeight.set(0,F.height*.5,0),i.rectArea[m]=k,m++}else if(F.isPointLight){const k=e.get(F);if(k.color.copy(F.color).multiplyScalar(F.intensity),k.distance=F.distance,k.decay=F.decay,F.castShadow){const G=F.shadow,K=t.get(F);K.shadowIntensity=G.intensity,K.shadowBias=G.bias,K.shadowNormalBias=G.normalBias,K.shadowRadius=G.radius,K.shadowMapSize=G.mapSize,K.shadowCameraNear=G.camera.near,K.shadowCameraFar=G.camera.far,i.pointShadow[_]=K,i.pointShadowMap[_]=ne,i.pointShadowMatrix[_]=F.shadow.matrix,D++}i.point[_]=k,_++}else if(F.isHemisphereLight){const k=e.get(F);k.skyColor.copy(F.color).multiplyScalar(H),k.groundColor.copy(F.groundColor).multiplyScalar(H),i.hemi[p]=k,p++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Oe.LTC_FLOAT_1,i.rectAreaLTC2=Oe.LTC_FLOAT_2):(i.rectAreaLTC1=Oe.LTC_HALF_1,i.rectAreaLTC2=Oe.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=h,i.ambient[2]=f;const U=i.hash;(U.directionalLength!==d||U.pointLength!==_||U.spotLength!==x||U.rectAreaLength!==m||U.hemiLength!==p||U.numDirectionalShadows!==A||U.numPointShadows!==D||U.numSpotShadows!==E||U.numSpotMaps!==R||U.numLightProbes!==L)&&(i.directional.length=d,i.spot.length=x,i.rectArea.length=m,i.point.length=_,i.hemi.length=p,i.directionalShadow.length=A,i.directionalShadowMap.length=A,i.pointShadow.length=D,i.pointShadowMap.length=D,i.spotShadow.length=E,i.spotShadowMap.length=E,i.directionalShadowMatrix.length=A,i.pointShadowMatrix.length=D,i.spotLightMatrix.length=E+R-N,i.spotLightMap.length=R,i.numSpotLightShadowsWithMaps=N,i.numLightProbes=L,U.directionalLength=d,U.pointLength=_,U.spotLength=x,U.rectAreaLength=m,U.hemiLength=p,U.numDirectionalShadows=A,U.numPointShadows=D,U.numSpotShadows=E,U.numSpotMaps=R,U.numLightProbes=L,i.version=nS++)}function l(c,u){let h=0,f=0,d=0,_=0,x=0;const m=u.matrixWorldInverse;for(let p=0,A=c.length;p<A;p++){const D=c[p];if(D.isDirectionalLight){const E=i.directional[h];E.direction.setFromMatrixPosition(D.matrixWorld),s.setFromMatrixPosition(D.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),h++}else if(D.isSpotLight){const E=i.spot[d];E.position.setFromMatrixPosition(D.matrixWorld),E.position.applyMatrix4(m),E.direction.setFromMatrixPosition(D.matrixWorld),s.setFromMatrixPosition(D.target.matrixWorld),E.direction.sub(s),E.direction.transformDirection(m),d++}else if(D.isRectAreaLight){const E=i.rectArea[_];E.position.setFromMatrixPosition(D.matrixWorld),E.position.applyMatrix4(m),o.identity(),r.copy(D.matrixWorld),r.premultiply(m),o.extractRotation(r),E.halfWidth.set(D.width*.5,0,0),E.halfHeight.set(0,D.height*.5,0),E.halfWidth.applyMatrix4(o),E.halfHeight.applyMatrix4(o),_++}else if(D.isPointLight){const E=i.point[f];E.position.setFromMatrixPosition(D.matrixWorld),E.position.applyMatrix4(m),f++}else if(D.isHemisphereLight){const E=i.hemi[x];E.direction.setFromMatrixPosition(D.matrixWorld),E.direction.transformDirection(m),x++}}}return{setup:a,setupView:l,state:i}}function Uf(n){const e=new sS(n),t=[],i=[];function s(u){c.camera=u,t.length=0,i.length=0}function r(u){t.push(u)}function o(u){i.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function rS(n){let e=new WeakMap;function t(s,r=0){const o=e.get(s);let a;return o===void 0?(a=new Uf(n),e.set(s,[a])):r>=o.length?(a=new Uf(n),o.push(a)):a=o[r],a}function i(){e=new WeakMap}return{get:t,dispose:i}}const oS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,lS=[new j(1,0,0),new j(-1,0,0),new j(0,1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1)],cS=[new j(0,-1,0),new j(0,-1,0),new j(0,0,1),new j(0,0,-1),new j(0,-1,0),new j(0,-1,0)],Ff=new ct,Ir=new j,zl=new j;function uS(n,e,t){let i=new Du;const s=new at,r=new at,o=new kt,a=new ax,l=new lx,c={},u=t.maxTextureSize,h={[Fi]:Rn,[Rn]:Fi,[oi]:oi},f=new pi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new at},radius:{value:4}},vertexShader:oS,fragmentShader:aS}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const _=new en;_.setAttribute("position",new kn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new pn(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ia;let p=this.type;this.render=function(N,L,U){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||N.length===0)return;N.type===D_&&(it("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),N.type=ia);const v=n.getRenderTarget(),b=n.getActiveCubeFace(),F=n.getActiveMipmapLevel(),z=n.state;z.setBlending(Pi),z.buffers.depth.getReversed()===!0?z.buffers.color.setClear(0,0,0,0):z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const H=p!==this.type;H&&L.traverse(function(ie){ie.material&&(Array.isArray(ie.material)?ie.material.forEach(ne=>ne.needsUpdate=!0):ie.material.needsUpdate=!0)});for(let ie=0,ne=N.length;ie<ne;ie++){const k=N[ie],G=k.shadow;if(G===void 0){it("WebGLShadowMap:",k,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const K=G.getFrameExtents();if(s.multiply(K),r.copy(G.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/K.x),s.x=r.x*K.x,G.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/K.y),s.y=r.y*K.y,G.mapSize.y=r.y)),G.map===null||H===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Fr){if(k.isPointLight){it("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new hi(s.x,s.y,{format:cr,type:Oi,minFilter:Kt,magFilter:Kt,generateMipmaps:!1}),G.map.texture.name=k.name+".shadowMap",G.map.depthTexture=new so(s.x,s.y,Kn),G.map.depthTexture.name=k.name+".shadowMapDepth",G.map.depthTexture.format=Bi,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=rn,G.map.depthTexture.magFilter=rn}else{k.isPointLight?(G.map=new xp(s.x),G.map.depthTexture=new ix(s.x,di)):(G.map=new hi(s.x,s.y),G.map.depthTexture=new so(s.x,s.y,di)),G.map.depthTexture.name=k.name+".shadowMap",G.map.depthTexture.format=Bi;const se=n.state.buffers.depth.getReversed();this.type===ia?(G.map.depthTexture.compareFunction=se?Tu:Eu,G.map.depthTexture.minFilter=Kt,G.map.depthTexture.magFilter=Kt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=rn,G.map.depthTexture.magFilter=rn)}G.camera.updateProjectionMatrix()}const ve=G.map.isWebGLCubeRenderTarget?6:1;for(let se=0;se<ve;se++){if(G.map.isWebGLCubeRenderTarget)n.setRenderTarget(G.map,se),n.clear();else{se===0&&(n.setRenderTarget(G.map),n.clear());const q=G.getViewport(se);o.set(r.x*q.x,r.y*q.y,r.x*q.z,r.y*q.w),z.viewport(o)}if(k.isPointLight){const q=G.camera,te=G.matrix,pe=k.distance||q.far;pe!==q.far&&(q.far=pe,q.updateProjectionMatrix()),Ir.setFromMatrixPosition(k.matrixWorld),q.position.copy(Ir),zl.copy(q.position),zl.add(lS[se]),q.up.copy(cS[se]),q.lookAt(zl),q.updateMatrixWorld(),te.makeTranslation(-Ir.x,-Ir.y,-Ir.z),Ff.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),G._frustum.setFromProjectionMatrix(Ff,q.coordinateSystem,q.reversedDepth)}else G.updateMatrices(k);i=G.getFrustum(),E(L,U,G.camera,k,this.type)}G.isPointLightShadow!==!0&&this.type===Fr&&A(G,U),G.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(v,b,F)};function A(N,L){const U=e.update(x);f.defines.VSM_SAMPLES!==N.blurSamples&&(f.defines.VSM_SAMPLES=N.blurSamples,d.defines.VSM_SAMPLES=N.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new hi(s.x,s.y,{format:cr,type:Oi})),f.uniforms.shadow_pass.value=N.map.depthTexture,f.uniforms.resolution.value=N.mapSize,f.uniforms.radius.value=N.radius,n.setRenderTarget(N.mapPass),n.clear(),n.renderBufferDirect(L,null,U,f,x,null),d.uniforms.shadow_pass.value=N.mapPass.texture,d.uniforms.resolution.value=N.mapSize,d.uniforms.radius.value=N.radius,n.setRenderTarget(N.map),n.clear(),n.renderBufferDirect(L,null,U,d,x,null)}function D(N,L,U,v){let b=null;const F=U.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(F!==void 0)b=F;else if(b=U.isPointLight===!0?l:a,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const z=b.uuid,H=L.uuid;let ie=c[z];ie===void 0&&(ie={},c[z]=ie);let ne=ie[H];ne===void 0&&(ne=b.clone(),ie[H]=ne,L.addEventListener("dispose",R)),b=ne}if(b.visible=L.visible,b.wireframe=L.wireframe,v===Fr?b.side=L.shadowSide!==null?L.shadowSide:L.side:b.side=L.shadowSide!==null?L.shadowSide:h[L.side],b.alphaMap=L.alphaMap,b.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,b.map=L.map,b.clipShadows=L.clipShadows,b.clippingPlanes=L.clippingPlanes,b.clipIntersection=L.clipIntersection,b.displacementMap=L.displacementMap,b.displacementScale=L.displacementScale,b.displacementBias=L.displacementBias,b.wireframeLinewidth=L.wireframeLinewidth,b.linewidth=L.linewidth,U.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const z=n.properties.get(b);z.light=U}return b}function E(N,L,U,v,b){if(N.visible===!1)return;if(N.layers.test(L.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&b===Fr)&&(!N.frustumCulled||i.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,N.matrixWorld);const H=e.update(N),ie=N.material;if(Array.isArray(ie)){const ne=H.groups;for(let k=0,G=ne.length;k<G;k++){const K=ne[k],ve=ie[K.materialIndex];if(ve&&ve.visible){const se=D(N,ve,v,b);N.onBeforeShadow(n,N,L,U,H,se,K),n.renderBufferDirect(U,null,H,se,N,K),N.onAfterShadow(n,N,L,U,H,se,K)}}}else if(ie.visible){const ne=D(N,ie,v,b);N.onBeforeShadow(n,N,L,U,H,ne,null),n.renderBufferDirect(U,null,H,ne,N,null),N.onAfterShadow(n,N,L,U,H,ne,null)}}const z=N.children;for(let H=0,ie=z.length;H<ie;H++)E(z[H],L,U,v,b)}function R(N){N.target.removeEventListener("dispose",R);for(const U in c){const v=c[U],b=N.target.uuid;b in v&&(v[b].dispose(),delete v[b])}}}const hS={[sc]:rc,[oc]:cc,[ac]:uc,[ar]:lc,[rc]:sc,[cc]:oc,[uc]:ac,[lc]:ar};function fS(n,e){function t(){let W=!1;const Be=new kt;let we=null;const Ge=new kt(0,0,0,0);return{setMask:function(Ae){we!==Ae&&!W&&(n.colorMask(Ae,Ae,Ae,Ae),we=Ae)},setLocked:function(Ae){W=Ae},setClear:function(Ae,xe,Pe,ot,Ut){Ut===!0&&(Ae*=ot,xe*=ot,Pe*=ot),Be.set(Ae,xe,Pe,ot),Ge.equals(Be)===!1&&(n.clearColor(Ae,xe,Pe,ot),Ge.copy(Be))},reset:function(){W=!1,we=null,Ge.set(-1,0,0,0)}}}function i(){let W=!1,Be=!1,we=null,Ge=null,Ae=null;return{setReversed:function(xe){if(Be!==xe){const Pe=e.get("EXT_clip_control");xe?Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.ZERO_TO_ONE_EXT):Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.NEGATIVE_ONE_TO_ONE_EXT),Be=xe;const ot=Ae;Ae=null,this.setClear(ot)}},getReversed:function(){return Be},setTest:function(xe){xe?$(n.DEPTH_TEST):ye(n.DEPTH_TEST)},setMask:function(xe){we!==xe&&!W&&(n.depthMask(xe),we=xe)},setFunc:function(xe){if(Be&&(xe=hS[xe]),Ge!==xe){switch(xe){case sc:n.depthFunc(n.NEVER);break;case rc:n.depthFunc(n.ALWAYS);break;case oc:n.depthFunc(n.LESS);break;case ar:n.depthFunc(n.LEQUAL);break;case ac:n.depthFunc(n.EQUAL);break;case lc:n.depthFunc(n.GEQUAL);break;case cc:n.depthFunc(n.GREATER);break;case uc:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Ge=xe}},setLocked:function(xe){W=xe},setClear:function(xe){Ae!==xe&&(Be&&(xe=1-xe),n.clearDepth(xe),Ae=xe)},reset:function(){W=!1,we=null,Ge=null,Ae=null,Be=!1}}}function s(){let W=!1,Be=null,we=null,Ge=null,Ae=null,xe=null,Pe=null,ot=null,Ut=null;return{setTest:function(dt){W||(dt?$(n.STENCIL_TEST):ye(n.STENCIL_TEST))},setMask:function(dt){Be!==dt&&!W&&(n.stencilMask(dt),Be=dt)},setFunc:function(dt,Pn,qn){(we!==dt||Ge!==Pn||Ae!==qn)&&(n.stencilFunc(dt,Pn,qn),we=dt,Ge=Pn,Ae=qn)},setOp:function(dt,Pn,qn){(xe!==dt||Pe!==Pn||ot!==qn)&&(n.stencilOp(dt,Pn,qn),xe=dt,Pe=Pn,ot=qn)},setLocked:function(dt){W=dt},setClear:function(dt){Ut!==dt&&(n.clearStencil(dt),Ut=dt)},reset:function(){W=!1,Be=null,we=null,Ge=null,Ae=null,xe=null,Pe=null,ot=null,Ut=null}}}const r=new t,o=new i,a=new s,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,d=[],_=null,x=!1,m=null,p=null,A=null,D=null,E=null,R=null,N=null,L=new ft(0,0,0),U=0,v=!1,b=null,F=null,z=null,H=null,ie=null;const ne=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,G=0;const K=n.getParameter(n.VERSION);K.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(K)[1]),k=G>=1):K.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),k=G>=2);let ve=null,se={};const q=n.getParameter(n.SCISSOR_BOX),te=n.getParameter(n.VIEWPORT),pe=new kt().fromArray(q),_e=new kt().fromArray(te);function Me(W,Be,we,Ge){const Ae=new Uint8Array(4),xe=n.createTexture();n.bindTexture(W,xe),n.texParameteri(W,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(W,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Pe=0;Pe<we;Pe++)W===n.TEXTURE_3D||W===n.TEXTURE_2D_ARRAY?n.texImage3D(Be,0,n.RGBA,1,1,Ge,0,n.RGBA,n.UNSIGNED_BYTE,Ae):n.texImage2D(Be+Pe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Ae);return xe}const X={};X[n.TEXTURE_2D]=Me(n.TEXTURE_2D,n.TEXTURE_2D,1),X[n.TEXTURE_CUBE_MAP]=Me(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),X[n.TEXTURE_2D_ARRAY]=Me(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),X[n.TEXTURE_3D]=Me(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),$(n.DEPTH_TEST),o.setFunc(ar),ae(!1),fe(vh),$(n.CULL_FACE),Q(Pi);function $(W){u[W]!==!0&&(n.enable(W),u[W]=!0)}function ye(W){u[W]!==!1&&(n.disable(W),u[W]=!1)}function Je(W,Be){return h[W]!==Be?(n.bindFramebuffer(W,Be),h[W]=Be,W===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=Be),W===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=Be),!0):!1}function Ie(W,Be){let we=d,Ge=!1;if(W){we=f.get(Be),we===void 0&&(we=[],f.set(Be,we));const Ae=W.textures;if(we.length!==Ae.length||we[0]!==n.COLOR_ATTACHMENT0){for(let xe=0,Pe=Ae.length;xe<Pe;xe++)we[xe]=n.COLOR_ATTACHMENT0+xe;we.length=Ae.length,Ge=!0}}else we[0]!==n.BACK&&(we[0]=n.BACK,Ge=!0);Ge&&n.drawBuffers(we)}function Mt(W){return _!==W?(n.useProgram(W),_=W,!0):!1}const O={[ms]:n.FUNC_ADD,[N_]:n.FUNC_SUBTRACT,[I_]:n.FUNC_REVERSE_SUBTRACT};O[U_]=n.MIN,O[F_]=n.MAX;const V={[O_]:n.ZERO,[B_]:n.ONE,[k_]:n.SRC_COLOR,[nc]:n.SRC_ALPHA,[X_]:n.SRC_ALPHA_SATURATE,[G_]:n.DST_COLOR,[z_]:n.DST_ALPHA,[V_]:n.ONE_MINUS_SRC_COLOR,[ic]:n.ONE_MINUS_SRC_ALPHA,[W_]:n.ONE_MINUS_DST_COLOR,[H_]:n.ONE_MINUS_DST_ALPHA,[q_]:n.CONSTANT_COLOR,[j_]:n.ONE_MINUS_CONSTANT_COLOR,[Y_]:n.CONSTANT_ALPHA,[$_]:n.ONE_MINUS_CONSTANT_ALPHA};function Q(W,Be,we,Ge,Ae,xe,Pe,ot,Ut,dt){if(W===Pi){x===!0&&(ye(n.BLEND),x=!1);return}if(x===!1&&($(n.BLEND),x=!0),W!==L_){if(W!==m||dt!==v){if((p!==ms||E!==ms)&&(n.blendEquation(n.FUNC_ADD),p=ms,E=ms),dt)switch(W){case nr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Mh:n.blendFunc(n.ONE,n.ONE);break;case yh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case bh:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:_t("WebGLState: Invalid blending: ",W);break}else switch(W){case nr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Mh:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case yh:_t("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case bh:_t("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:_t("WebGLState: Invalid blending: ",W);break}A=null,D=null,R=null,N=null,L.set(0,0,0),U=0,m=W,v=dt}return}Ae=Ae||Be,xe=xe||we,Pe=Pe||Ge,(Be!==p||Ae!==E)&&(n.blendEquationSeparate(O[Be],O[Ae]),p=Be,E=Ae),(we!==A||Ge!==D||xe!==R||Pe!==N)&&(n.blendFuncSeparate(V[we],V[Ge],V[xe],V[Pe]),A=we,D=Ge,R=xe,N=Pe),(ot.equals(L)===!1||Ut!==U)&&(n.blendColor(ot.r,ot.g,ot.b,Ut),L.copy(ot),U=Ut),m=W,v=!1}function he(W,Be){W.side===oi?ye(n.CULL_FACE):$(n.CULL_FACE);let we=W.side===Rn;Be&&(we=!we),ae(we),W.blending===nr&&W.transparent===!1?Q(Pi):Q(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),o.setFunc(W.depthFunc),o.setTest(W.depthTest),o.setMask(W.depthWrite),r.setMask(W.colorWrite);const Ge=W.stencilWrite;a.setTest(Ge),Ge&&(a.setMask(W.stencilWriteMask),a.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),a.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),be(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?$(n.SAMPLE_ALPHA_TO_COVERAGE):ye(n.SAMPLE_ALPHA_TO_COVERAGE)}function ae(W){b!==W&&(W?n.frontFace(n.CW):n.frontFace(n.CCW),b=W)}function fe(W){W!==C_?($(n.CULL_FACE),W!==F&&(W===vh?n.cullFace(n.BACK):W===P_?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ye(n.CULL_FACE),F=W}function I(W){W!==z&&(k&&n.lineWidth(W),z=W)}function be(W,Be,we){W?($(n.POLYGON_OFFSET_FILL),(H!==Be||ie!==we)&&(n.polygonOffset(Be,we),H=Be,ie=we)):ye(n.POLYGON_OFFSET_FILL)}function me(W){W?$(n.SCISSOR_TEST):ye(n.SCISSOR_TEST)}function ue(W){W===void 0&&(W=n.TEXTURE0+ne-1),ve!==W&&(n.activeTexture(W),ve=W)}function ge(W,Be,we){we===void 0&&(ve===null?we=n.TEXTURE0+ne-1:we=ve);let Ge=se[we];Ge===void 0&&(Ge={type:void 0,texture:void 0},se[we]=Ge),(Ge.type!==W||Ge.texture!==Be)&&(ve!==we&&(n.activeTexture(we),ve=we),n.bindTexture(W,Be||X[W]),Ge.type=W,Ge.texture=Be)}function T(){const W=se[ve];W!==void 0&&W.type!==void 0&&(n.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function g(){try{n.compressedTexImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function B(){try{n.compressedTexImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function ee(){try{n.texSubImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function ce(){try{n.texSubImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function Z(){try{n.compressedTexSubImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function Fe(){try{n.compressedTexSubImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function Te(){try{n.texStorage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function ke(){try{n.texStorage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function Ke(){try{n.texImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function Se(){try{n.texImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function Ce(W){pe.equals(W)===!1&&(n.scissor(W.x,W.y,W.z,W.w),pe.copy(W))}function Le(W){_e.equals(W)===!1&&(n.viewport(W.x,W.y,W.z,W.w),_e.copy(W))}function Ve(W,Be){let we=c.get(Be);we===void 0&&(we=new WeakMap,c.set(Be,we));let Ge=we.get(W);Ge===void 0&&(Ge=n.getUniformBlockIndex(Be,W.name),we.set(W,Ge))}function Re(W,Be){const Ge=c.get(Be).get(W);l.get(Be)!==Ge&&(n.uniformBlockBinding(Be,Ge,W.__bindingPointIndex),l.set(Be,Ge))}function lt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},ve=null,se={},h={},f=new WeakMap,d=[],_=null,x=!1,m=null,p=null,A=null,D=null,E=null,R=null,N=null,L=new ft(0,0,0),U=0,v=!1,b=null,F=null,z=null,H=null,ie=null,pe.set(0,0,n.canvas.width,n.canvas.height),_e.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:$,disable:ye,bindFramebuffer:Je,drawBuffers:Ie,useProgram:Mt,setBlending:Q,setMaterial:he,setFlipSided:ae,setCullFace:fe,setLineWidth:I,setPolygonOffset:be,setScissorTest:me,activeTexture:ue,bindTexture:ge,unbindTexture:T,compressedTexImage2D:g,compressedTexImage3D:B,texImage2D:Ke,texImage3D:Se,updateUBOMapping:Ve,uniformBlockBinding:Re,texStorage2D:Te,texStorage3D:ke,texSubImage2D:ee,texSubImage3D:ce,compressedTexSubImage2D:Z,compressedTexSubImage3D:Fe,scissor:Ce,viewport:Le,reset:lt}}function dS(n,e,t,i,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new at,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return d?new OffscreenCanvas(T,g):to("canvas")}function x(T,g,B){let ee=1;const ce=ge(T);if((ce.width>B||ce.height>B)&&(ee=B/Math.max(ce.width,ce.height)),ee<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const Z=Math.floor(ee*ce.width),Fe=Math.floor(ee*ce.height);h===void 0&&(h=_(Z,Fe));const Te=g?_(Z,Fe):h;return Te.width=Z,Te.height=Fe,Te.getContext("2d").drawImage(T,0,0,Z,Fe),it("WebGLRenderer: Texture has been resized from ("+ce.width+"x"+ce.height+") to ("+Z+"x"+Fe+")."),Te}else return"data"in T&&it("WebGLRenderer: Image in DataTexture is too big ("+ce.width+"x"+ce.height+")."),T;return T}function m(T){return T.generateMipmaps}function p(T){n.generateMipmap(T)}function A(T){return T.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?n.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function D(T,g,B,ee,ce=!1){if(T!==null){if(n[T]!==void 0)return n[T];it("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let Z=g;if(g===n.RED&&(B===n.FLOAT&&(Z=n.R32F),B===n.HALF_FLOAT&&(Z=n.R16F),B===n.UNSIGNED_BYTE&&(Z=n.R8)),g===n.RED_INTEGER&&(B===n.UNSIGNED_BYTE&&(Z=n.R8UI),B===n.UNSIGNED_SHORT&&(Z=n.R16UI),B===n.UNSIGNED_INT&&(Z=n.R32UI),B===n.BYTE&&(Z=n.R8I),B===n.SHORT&&(Z=n.R16I),B===n.INT&&(Z=n.R32I)),g===n.RG&&(B===n.FLOAT&&(Z=n.RG32F),B===n.HALF_FLOAT&&(Z=n.RG16F),B===n.UNSIGNED_BYTE&&(Z=n.RG8)),g===n.RG_INTEGER&&(B===n.UNSIGNED_BYTE&&(Z=n.RG8UI),B===n.UNSIGNED_SHORT&&(Z=n.RG16UI),B===n.UNSIGNED_INT&&(Z=n.RG32UI),B===n.BYTE&&(Z=n.RG8I),B===n.SHORT&&(Z=n.RG16I),B===n.INT&&(Z=n.RG32I)),g===n.RGB_INTEGER&&(B===n.UNSIGNED_BYTE&&(Z=n.RGB8UI),B===n.UNSIGNED_SHORT&&(Z=n.RGB16UI),B===n.UNSIGNED_INT&&(Z=n.RGB32UI),B===n.BYTE&&(Z=n.RGB8I),B===n.SHORT&&(Z=n.RGB16I),B===n.INT&&(Z=n.RGB32I)),g===n.RGBA_INTEGER&&(B===n.UNSIGNED_BYTE&&(Z=n.RGBA8UI),B===n.UNSIGNED_SHORT&&(Z=n.RGBA16UI),B===n.UNSIGNED_INT&&(Z=n.RGBA32UI),B===n.BYTE&&(Z=n.RGBA8I),B===n.SHORT&&(Z=n.RGBA16I),B===n.INT&&(Z=n.RGBA32I)),g===n.RGB&&(B===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),B===n.UNSIGNED_INT_10F_11F_11F_REV&&(Z=n.R11F_G11F_B10F)),g===n.RGBA){const Fe=ce?_a:vt.getTransfer(ee);B===n.FLOAT&&(Z=n.RGBA32F),B===n.HALF_FLOAT&&(Z=n.RGBA16F),B===n.UNSIGNED_BYTE&&(Z=Fe===It?n.SRGB8_ALPHA8:n.RGBA8),B===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),B===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function E(T,g){let B;return T?g===null||g===di||g===eo?B=n.DEPTH24_STENCIL8:g===Kn?B=n.DEPTH32F_STENCIL8:g===Qr&&(B=n.DEPTH24_STENCIL8,it("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===di||g===eo?B=n.DEPTH_COMPONENT24:g===Kn?B=n.DEPTH_COMPONENT32F:g===Qr&&(B=n.DEPTH_COMPONENT16),B}function R(T,g){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==rn&&T.minFilter!==Kt?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function N(T){const g=T.target;g.removeEventListener("dispose",N),U(g),g.isVideoTexture&&u.delete(g)}function L(T){const g=T.target;g.removeEventListener("dispose",L),b(g)}function U(T){const g=i.get(T);if(g.__webglInit===void 0)return;const B=T.source,ee=f.get(B);if(ee){const ce=ee[g.__cacheKey];ce.usedTimes--,ce.usedTimes===0&&v(T),Object.keys(ee).length===0&&f.delete(B)}i.remove(T)}function v(T){const g=i.get(T);n.deleteTexture(g.__webglTexture);const B=T.source,ee=f.get(B);delete ee[g.__cacheKey],o.memory.textures--}function b(T){const g=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(g.__webglFramebuffer[ee]))for(let ce=0;ce<g.__webglFramebuffer[ee].length;ce++)n.deleteFramebuffer(g.__webglFramebuffer[ee][ce]);else n.deleteFramebuffer(g.__webglFramebuffer[ee]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[ee])}else{if(Array.isArray(g.__webglFramebuffer))for(let ee=0;ee<g.__webglFramebuffer.length;ee++)n.deleteFramebuffer(g.__webglFramebuffer[ee]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let ee=0;ee<g.__webglColorRenderbuffer.length;ee++)g.__webglColorRenderbuffer[ee]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[ee]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const B=T.textures;for(let ee=0,ce=B.length;ee<ce;ee++){const Z=i.get(B[ee]);Z.__webglTexture&&(n.deleteTexture(Z.__webglTexture),o.memory.textures--),i.remove(B[ee])}i.remove(T)}let F=0;function z(){F=0}function H(){const T=F;return T>=s.maxTextures&&it("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),F+=1,T}function ie(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function ne(T,g){const B=i.get(T);if(T.isVideoTexture&&me(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&B.__version!==T.version){const ee=T.image;if(ee===null)it("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)it("WebGLRenderer: Texture marked for update but image is incomplete");else{X(B,T,g);return}}else T.isExternalTexture&&(B.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,B.__webglTexture,n.TEXTURE0+g)}function k(T,g){const B=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&B.__version!==T.version){X(B,T,g);return}else T.isExternalTexture&&(B.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,B.__webglTexture,n.TEXTURE0+g)}function G(T,g){const B=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&B.__version!==T.version){X(B,T,g);return}t.bindTexture(n.TEXTURE_3D,B.__webglTexture,n.TEXTURE0+g)}function K(T,g){const B=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&B.__version!==T.version){$(B,T,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,B.__webglTexture,n.TEXTURE0+g)}const ve={[_s]:n.REPEAT,[Bn]:n.CLAMP_TO_EDGE,[dc]:n.MIRRORED_REPEAT},se={[rn]:n.NEAREST,[Q_]:n.NEAREST_MIPMAP_NEAREST,[yo]:n.NEAREST_MIPMAP_LINEAR,[Kt]:n.LINEAR,[al]:n.LINEAR_MIPMAP_NEAREST,[Ri]:n.LINEAR_MIPMAP_LINEAR},q={[i0]:n.NEVER,[l0]:n.ALWAYS,[s0]:n.LESS,[Eu]:n.LEQUAL,[r0]:n.EQUAL,[Tu]:n.GEQUAL,[o0]:n.GREATER,[a0]:n.NOTEQUAL};function te(T,g){if(g.type===Kn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Kt||g.magFilter===al||g.magFilter===yo||g.magFilter===Ri||g.minFilter===Kt||g.minFilter===al||g.minFilter===yo||g.minFilter===Ri)&&it("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(T,n.TEXTURE_WRAP_S,ve[g.wrapS]),n.texParameteri(T,n.TEXTURE_WRAP_T,ve[g.wrapT]),(T===n.TEXTURE_3D||T===n.TEXTURE_2D_ARRAY)&&n.texParameteri(T,n.TEXTURE_WRAP_R,ve[g.wrapR]),n.texParameteri(T,n.TEXTURE_MAG_FILTER,se[g.magFilter]),n.texParameteri(T,n.TEXTURE_MIN_FILTER,se[g.minFilter]),g.compareFunction&&(n.texParameteri(T,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(T,n.TEXTURE_COMPARE_FUNC,q[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===rn||g.minFilter!==yo&&g.minFilter!==Ri||g.type===Kn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");n.texParameterf(T,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function pe(T,g){let B=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",N));const ee=g.source;let ce=f.get(ee);ce===void 0&&(ce={},f.set(ee,ce));const Z=ie(g);if(Z!==T.__cacheKey){ce[Z]===void 0&&(ce[Z]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,B=!0),ce[Z].usedTimes++;const Fe=ce[T.__cacheKey];Fe!==void 0&&(ce[T.__cacheKey].usedTimes--,Fe.usedTimes===0&&v(g)),T.__cacheKey=Z,T.__webglTexture=ce[Z].texture}return B}function _e(T,g,B){return Math.floor(Math.floor(T/B)/g)}function Me(T,g,B,ee){const Z=T.updateRanges;if(Z.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,g.width,g.height,B,ee,g.data);else{Z.sort((Se,Ce)=>Se.start-Ce.start);let Fe=0;for(let Se=1;Se<Z.length;Se++){const Ce=Z[Fe],Le=Z[Se],Ve=Ce.start+Ce.count,Re=_e(Le.start,g.width,4),lt=_e(Ce.start,g.width,4);Le.start<=Ve+1&&Re===lt&&_e(Le.start+Le.count-1,g.width,4)===Re?Ce.count=Math.max(Ce.count,Le.start+Le.count-Ce.start):(++Fe,Z[Fe]=Le)}Z.length=Fe+1;const Te=n.getParameter(n.UNPACK_ROW_LENGTH),ke=n.getParameter(n.UNPACK_SKIP_PIXELS),Ke=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,g.width);for(let Se=0,Ce=Z.length;Se<Ce;Se++){const Le=Z[Se],Ve=Math.floor(Le.start/4),Re=Math.ceil(Le.count/4),lt=Ve%g.width,W=Math.floor(Ve/g.width),Be=Re,we=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,lt),n.pixelStorei(n.UNPACK_SKIP_ROWS,W),t.texSubImage2D(n.TEXTURE_2D,0,lt,W,Be,we,B,ee,g.data)}T.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,Te),n.pixelStorei(n.UNPACK_SKIP_PIXELS,ke),n.pixelStorei(n.UNPACK_SKIP_ROWS,Ke)}}function X(T,g,B){let ee=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(ee=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(ee=n.TEXTURE_3D);const ce=pe(T,g),Z=g.source;t.bindTexture(ee,T.__webglTexture,n.TEXTURE0+B);const Fe=i.get(Z);if(Z.version!==Fe.__version||ce===!0){t.activeTexture(n.TEXTURE0+B);const Te=vt.getPrimaries(vt.workingColorSpace),ke=g.colorSpace===Zi?null:vt.getPrimaries(g.colorSpace),Ke=g.colorSpace===Zi||Te===ke?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);let Se=x(g.image,!1,s.maxTextureSize);Se=ue(g,Se);const Ce=r.convert(g.format,g.colorSpace),Le=r.convert(g.type);let Ve=D(g.internalFormat,Ce,Le,g.colorSpace,g.isVideoTexture);te(ee,g);let Re;const lt=g.mipmaps,W=g.isVideoTexture!==!0,Be=Fe.__version===void 0||ce===!0,we=Z.dataReady,Ge=R(g,Se);if(g.isDepthTexture)Ve=E(g.format===xs,g.type),Be&&(W?t.texStorage2D(n.TEXTURE_2D,1,Ve,Se.width,Se.height):t.texImage2D(n.TEXTURE_2D,0,Ve,Se.width,Se.height,0,Ce,Le,null));else if(g.isDataTexture)if(lt.length>0){W&&Be&&t.texStorage2D(n.TEXTURE_2D,Ge,Ve,lt[0].width,lt[0].height);for(let Ae=0,xe=lt.length;Ae<xe;Ae++)Re=lt[Ae],W?we&&t.texSubImage2D(n.TEXTURE_2D,Ae,0,0,Re.width,Re.height,Ce,Le,Re.data):t.texImage2D(n.TEXTURE_2D,Ae,Ve,Re.width,Re.height,0,Ce,Le,Re.data);g.generateMipmaps=!1}else W?(Be&&t.texStorage2D(n.TEXTURE_2D,Ge,Ve,Se.width,Se.height),we&&Me(g,Se,Ce,Le)):t.texImage2D(n.TEXTURE_2D,0,Ve,Se.width,Se.height,0,Ce,Le,Se.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){W&&Be&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ge,Ve,lt[0].width,lt[0].height,Se.depth);for(let Ae=0,xe=lt.length;Ae<xe;Ae++)if(Re=lt[Ae],g.format!==Hn)if(Ce!==null)if(W){if(we)if(g.layerUpdates.size>0){const Pe=df(Re.width,Re.height,g.format,g.type);for(const ot of g.layerUpdates){const Ut=Re.data.subarray(ot*Pe/Re.data.BYTES_PER_ELEMENT,(ot+1)*Pe/Re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Ae,0,0,ot,Re.width,Re.height,1,Ce,Ut)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,Ae,0,0,0,Re.width,Re.height,Se.depth,Ce,Re.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,Ae,Ve,Re.width,Re.height,Se.depth,0,Re.data,0,0);else it("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else W?we&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,Ae,0,0,0,Re.width,Re.height,Se.depth,Ce,Le,Re.data):t.texImage3D(n.TEXTURE_2D_ARRAY,Ae,Ve,Re.width,Re.height,Se.depth,0,Ce,Le,Re.data)}else{W&&Be&&t.texStorage2D(n.TEXTURE_2D,Ge,Ve,lt[0].width,lt[0].height);for(let Ae=0,xe=lt.length;Ae<xe;Ae++)Re=lt[Ae],g.format!==Hn?Ce!==null?W?we&&t.compressedTexSubImage2D(n.TEXTURE_2D,Ae,0,0,Re.width,Re.height,Ce,Re.data):t.compressedTexImage2D(n.TEXTURE_2D,Ae,Ve,Re.width,Re.height,0,Re.data):it("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):W?we&&t.texSubImage2D(n.TEXTURE_2D,Ae,0,0,Re.width,Re.height,Ce,Le,Re.data):t.texImage2D(n.TEXTURE_2D,Ae,Ve,Re.width,Re.height,0,Ce,Le,Re.data)}else if(g.isDataArrayTexture)if(W){if(Be&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ge,Ve,Se.width,Se.height,Se.depth),we)if(g.layerUpdates.size>0){const Ae=df(Se.width,Se.height,g.format,g.type);for(const xe of g.layerUpdates){const Pe=Se.data.subarray(xe*Ae/Se.data.BYTES_PER_ELEMENT,(xe+1)*Ae/Se.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,xe,Se.width,Se.height,1,Ce,Le,Pe)}g.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Se.width,Se.height,Se.depth,Ce,Le,Se.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ve,Se.width,Se.height,Se.depth,0,Ce,Le,Se.data);else if(g.isData3DTexture)W?(Be&&t.texStorage3D(n.TEXTURE_3D,Ge,Ve,Se.width,Se.height,Se.depth),we&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Se.width,Se.height,Se.depth,Ce,Le,Se.data)):t.texImage3D(n.TEXTURE_3D,0,Ve,Se.width,Se.height,Se.depth,0,Ce,Le,Se.data);else if(g.isFramebufferTexture){if(Be)if(W)t.texStorage2D(n.TEXTURE_2D,Ge,Ve,Se.width,Se.height);else{let Ae=Se.width,xe=Se.height;for(let Pe=0;Pe<Ge;Pe++)t.texImage2D(n.TEXTURE_2D,Pe,Ve,Ae,xe,0,Ce,Le,null),Ae>>=1,xe>>=1}}else if(lt.length>0){if(W&&Be){const Ae=ge(lt[0]);t.texStorage2D(n.TEXTURE_2D,Ge,Ve,Ae.width,Ae.height)}for(let Ae=0,xe=lt.length;Ae<xe;Ae++)Re=lt[Ae],W?we&&t.texSubImage2D(n.TEXTURE_2D,Ae,0,0,Ce,Le,Re):t.texImage2D(n.TEXTURE_2D,Ae,Ve,Ce,Le,Re);g.generateMipmaps=!1}else if(W){if(Be){const Ae=ge(Se);t.texStorage2D(n.TEXTURE_2D,Ge,Ve,Ae.width,Ae.height)}we&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ce,Le,Se)}else t.texImage2D(n.TEXTURE_2D,0,Ve,Ce,Le,Se);m(g)&&p(ee),Fe.__version=Z.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function $(T,g,B){if(g.image.length!==6)return;const ee=pe(T,g),ce=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,T.__webglTexture,n.TEXTURE0+B);const Z=i.get(ce);if(ce.version!==Z.__version||ee===!0){t.activeTexture(n.TEXTURE0+B);const Fe=vt.getPrimaries(vt.workingColorSpace),Te=g.colorSpace===Zi?null:vt.getPrimaries(g.colorSpace),ke=g.colorSpace===Zi||Fe===Te?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ke);const Ke=g.isCompressedTexture||g.image[0].isCompressedTexture,Se=g.image[0]&&g.image[0].isDataTexture,Ce=[];for(let xe=0;xe<6;xe++)!Ke&&!Se?Ce[xe]=x(g.image[xe],!0,s.maxCubemapSize):Ce[xe]=Se?g.image[xe].image:g.image[xe],Ce[xe]=ue(g,Ce[xe]);const Le=Ce[0],Ve=r.convert(g.format,g.colorSpace),Re=r.convert(g.type),lt=D(g.internalFormat,Ve,Re,g.colorSpace),W=g.isVideoTexture!==!0,Be=Z.__version===void 0||ee===!0,we=ce.dataReady;let Ge=R(g,Le);te(n.TEXTURE_CUBE_MAP,g);let Ae;if(Ke){W&&Be&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ge,lt,Le.width,Le.height);for(let xe=0;xe<6;xe++){Ae=Ce[xe].mipmaps;for(let Pe=0;Pe<Ae.length;Pe++){const ot=Ae[Pe];g.format!==Hn?Ve!==null?W?we&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe,0,0,ot.width,ot.height,Ve,ot.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe,lt,ot.width,ot.height,0,ot.data):it("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):W?we&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe,0,0,ot.width,ot.height,Ve,Re,ot.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe,lt,ot.width,ot.height,0,Ve,Re,ot.data)}}}else{if(Ae=g.mipmaps,W&&Be){Ae.length>0&&Ge++;const xe=ge(Ce[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Ge,lt,xe.width,xe.height)}for(let xe=0;xe<6;xe++)if(Se){W?we&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Ce[xe].width,Ce[xe].height,Ve,Re,Ce[xe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,lt,Ce[xe].width,Ce[xe].height,0,Ve,Re,Ce[xe].data);for(let Pe=0;Pe<Ae.length;Pe++){const Ut=Ae[Pe].image[xe].image;W?we&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe+1,0,0,Ut.width,Ut.height,Ve,Re,Ut.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe+1,lt,Ut.width,Ut.height,0,Ve,Re,Ut.data)}}else{W?we&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,0,0,Ve,Re,Ce[xe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,0,lt,Ve,Re,Ce[xe]);for(let Pe=0;Pe<Ae.length;Pe++){const ot=Ae[Pe];W?we&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe+1,0,0,Ve,Re,ot.image[xe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+xe,Pe+1,lt,Ve,Re,ot.image[xe])}}}m(g)&&p(n.TEXTURE_CUBE_MAP),Z.__version=ce.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function ye(T,g,B,ee,ce,Z){const Fe=r.convert(B.format,B.colorSpace),Te=r.convert(B.type),ke=D(B.internalFormat,Fe,Te,B.colorSpace),Ke=i.get(g),Se=i.get(B);if(Se.__renderTarget=g,!Ke.__hasExternalTextures){const Ce=Math.max(1,g.width>>Z),Le=Math.max(1,g.height>>Z);ce===n.TEXTURE_3D||ce===n.TEXTURE_2D_ARRAY?t.texImage3D(ce,Z,ke,Ce,Le,g.depth,0,Fe,Te,null):t.texImage2D(ce,Z,ke,Ce,Le,0,Fe,Te,null)}t.bindFramebuffer(n.FRAMEBUFFER,T),be(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ee,ce,Se.__webglTexture,0,I(g)):(ce===n.TEXTURE_2D||ce>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ce<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ee,ce,Se.__webglTexture,Z),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Je(T,g,B){if(n.bindRenderbuffer(n.RENDERBUFFER,T),g.depthBuffer){const ee=g.depthTexture,ce=ee&&ee.isDepthTexture?ee.type:null,Z=E(g.stencilBuffer,ce),Fe=g.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;be(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,I(g),Z,g.width,g.height):B?n.renderbufferStorageMultisample(n.RENDERBUFFER,I(g),Z,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,Z,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Fe,n.RENDERBUFFER,T)}else{const ee=g.textures;for(let ce=0;ce<ee.length;ce++){const Z=ee[ce],Fe=r.convert(Z.format,Z.colorSpace),Te=r.convert(Z.type),ke=D(Z.internalFormat,Fe,Te,Z.colorSpace);be(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,I(g),ke,g.width,g.height):B?n.renderbufferStorageMultisample(n.RENDERBUFFER,I(g),ke,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,ke,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ie(T,g,B){const ee=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ce=i.get(g.depthTexture);if(ce.__renderTarget=g,(!ce.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),ee){if(ce.__webglInit===void 0&&(ce.__webglInit=!0,g.depthTexture.addEventListener("dispose",N)),ce.__webglTexture===void 0){ce.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,ce.__webglTexture),te(n.TEXTURE_CUBE_MAP,g.depthTexture);const Ke=r.convert(g.depthTexture.format),Se=r.convert(g.depthTexture.type);let Ce;g.depthTexture.format===Bi?Ce=n.DEPTH_COMPONENT24:g.depthTexture.format===xs&&(Ce=n.DEPTH24_STENCIL8);for(let Le=0;Le<6;Le++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0,Ce,g.width,g.height,0,Ke,Se,null)}}else ne(g.depthTexture,0);const Z=ce.__webglTexture,Fe=I(g),Te=ee?n.TEXTURE_CUBE_MAP_POSITIVE_X+B:n.TEXTURE_2D,ke=g.depthTexture.format===xs?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(g.depthTexture.format===Bi)be(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ke,Te,Z,0,Fe):n.framebufferTexture2D(n.FRAMEBUFFER,ke,Te,Z,0);else if(g.depthTexture.format===xs)be(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ke,Te,Z,0,Fe):n.framebufferTexture2D(n.FRAMEBUFFER,ke,Te,Z,0);else throw new Error("Unknown depthTexture format")}function Mt(T){const g=i.get(T),B=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const ee=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),ee){const ce=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,ee.removeEventListener("dispose",ce)};ee.addEventListener("dispose",ce),g.__depthDisposeCallback=ce}g.__boundDepthTexture=ee}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(B)for(let ee=0;ee<6;ee++)Ie(g.__webglFramebuffer[ee],T,ee);else{const ee=T.texture.mipmaps;ee&&ee.length>0?Ie(g.__webglFramebuffer[0],T,0):Ie(g.__webglFramebuffer,T,0)}else if(B){g.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[ee]),g.__webglDepthbuffer[ee]===void 0)g.__webglDepthbuffer[ee]=n.createRenderbuffer(),Je(g.__webglDepthbuffer[ee],T,!1);else{const ce=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Z=g.__webglDepthbuffer[ee];n.bindRenderbuffer(n.RENDERBUFFER,Z),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,Z)}}else{const ee=T.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=n.createRenderbuffer(),Je(g.__webglDepthbuffer,T,!1);else{const ce=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Z=g.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,Z),n.framebufferRenderbuffer(n.FRAMEBUFFER,ce,n.RENDERBUFFER,Z)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function O(T,g,B){const ee=i.get(T);g!==void 0&&ye(ee.__webglFramebuffer,T,T.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),B!==void 0&&Mt(T)}function V(T){const g=T.texture,B=i.get(T),ee=i.get(g);T.addEventListener("dispose",L);const ce=T.textures,Z=T.isWebGLCubeRenderTarget===!0,Fe=ce.length>1;if(Fe||(ee.__webglTexture===void 0&&(ee.__webglTexture=n.createTexture()),ee.__version=g.version,o.memory.textures++),Z){B.__webglFramebuffer=[];for(let Te=0;Te<6;Te++)if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer[Te]=[];for(let ke=0;ke<g.mipmaps.length;ke++)B.__webglFramebuffer[Te][ke]=n.createFramebuffer()}else B.__webglFramebuffer[Te]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer=[];for(let Te=0;Te<g.mipmaps.length;Te++)B.__webglFramebuffer[Te]=n.createFramebuffer()}else B.__webglFramebuffer=n.createFramebuffer();if(Fe)for(let Te=0,ke=ce.length;Te<ke;Te++){const Ke=i.get(ce[Te]);Ke.__webglTexture===void 0&&(Ke.__webglTexture=n.createTexture(),o.memory.textures++)}if(T.samples>0&&be(T)===!1){B.__webglMultisampledFramebuffer=n.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let Te=0;Te<ce.length;Te++){const ke=ce[Te];B.__webglColorRenderbuffer[Te]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,B.__webglColorRenderbuffer[Te]);const Ke=r.convert(ke.format,ke.colorSpace),Se=r.convert(ke.type),Ce=D(ke.internalFormat,Ke,Se,ke.colorSpace,T.isXRRenderTarget===!0),Le=I(T);n.renderbufferStorageMultisample(n.RENDERBUFFER,Le,Ce,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Te,n.RENDERBUFFER,B.__webglColorRenderbuffer[Te])}n.bindRenderbuffer(n.RENDERBUFFER,null),T.depthBuffer&&(B.__webglDepthRenderbuffer=n.createRenderbuffer(),Je(B.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Z){t.bindTexture(n.TEXTURE_CUBE_MAP,ee.__webglTexture),te(n.TEXTURE_CUBE_MAP,g);for(let Te=0;Te<6;Te++)if(g.mipmaps&&g.mipmaps.length>0)for(let ke=0;ke<g.mipmaps.length;ke++)ye(B.__webglFramebuffer[Te][ke],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Te,ke);else ye(B.__webglFramebuffer[Te],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Te,0);m(g)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Fe){for(let Te=0,ke=ce.length;Te<ke;Te++){const Ke=ce[Te],Se=i.get(Ke);let Ce=n.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Ce=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Ce,Se.__webglTexture),te(Ce,Ke),ye(B.__webglFramebuffer,T,Ke,n.COLOR_ATTACHMENT0+Te,Ce,0),m(Ke)&&p(Ce)}t.unbindTexture()}else{let Te=n.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Te=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Te,ee.__webglTexture),te(Te,g),g.mipmaps&&g.mipmaps.length>0)for(let ke=0;ke<g.mipmaps.length;ke++)ye(B.__webglFramebuffer[ke],T,g,n.COLOR_ATTACHMENT0,Te,ke);else ye(B.__webglFramebuffer,T,g,n.COLOR_ATTACHMENT0,Te,0);m(g)&&p(Te),t.unbindTexture()}T.depthBuffer&&Mt(T)}function Q(T){const g=T.textures;for(let B=0,ee=g.length;B<ee;B++){const ce=g[B];if(m(ce)){const Z=A(T),Fe=i.get(ce).__webglTexture;t.bindTexture(Z,Fe),p(Z),t.unbindTexture()}}}const he=[],ae=[];function fe(T){if(T.samples>0){if(be(T)===!1){const g=T.textures,B=T.width,ee=T.height;let ce=n.COLOR_BUFFER_BIT;const Z=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Fe=i.get(T),Te=g.length>1;if(Te)for(let Ke=0;Ke<g.length;Ke++)t.bindFramebuffer(n.FRAMEBUFFER,Fe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ke,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Fe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ke,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Fe.__webglMultisampledFramebuffer);const ke=T.texture.mipmaps;ke&&ke.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Fe.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Fe.__webglFramebuffer);for(let Ke=0;Ke<g.length;Ke++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(ce|=n.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(ce|=n.STENCIL_BUFFER_BIT)),Te){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Fe.__webglColorRenderbuffer[Ke]);const Se=i.get(g[Ke]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Se,0)}n.blitFramebuffer(0,0,B,ee,0,0,B,ee,ce,n.NEAREST),l===!0&&(he.length=0,ae.length=0,he.push(n.COLOR_ATTACHMENT0+Ke),T.depthBuffer&&T.resolveDepthBuffer===!1&&(he.push(Z),ae.push(Z),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,ae)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,he))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Te)for(let Ke=0;Ke<g.length;Ke++){t.bindFramebuffer(n.FRAMEBUFFER,Fe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ke,n.RENDERBUFFER,Fe.__webglColorRenderbuffer[Ke]);const Se=i.get(g[Ke]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Fe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Ke,n.TEXTURE_2D,Se,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Fe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function I(T){return Math.min(s.maxSamples,T.samples)}function be(T){const g=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function me(T){const g=o.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function ue(T,g){const B=T.colorSpace,ee=T.format,ce=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||B!==ur&&B!==Zi&&(vt.getTransfer(B)===It?(ee!==Hn||ce!==In)&&it("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):_t("WebGLTextures: Unsupported texture color space:",B)),g}function ge(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=z,this.setTexture2D=ne,this.setTexture2DArray=k,this.setTexture3D=G,this.setTextureCube=K,this.rebindTextures=O,this.setupRenderTarget=V,this.updateRenderTargetMipmap=Q,this.updateMultisampleRenderTarget=fe,this.setupDepthRenderbuffer=Mt,this.setupFrameBufferTexture=ye,this.useMultisampledRTT=be,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function pS(n,e){function t(i,s=Zi){let r;const o=vt.getTransfer(s);if(i===In)return n.UNSIGNED_BYTE;if(i===xu)return n.UNSIGNED_SHORT_4_4_4_4;if(i===vu)return n.UNSIGNED_SHORT_5_5_5_1;if(i===rp)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===op)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===ip)return n.BYTE;if(i===sp)return n.SHORT;if(i===Qr)return n.UNSIGNED_SHORT;if(i===_u)return n.INT;if(i===di)return n.UNSIGNED_INT;if(i===Kn)return n.FLOAT;if(i===Oi)return n.HALF_FLOAT;if(i===ap)return n.ALPHA;if(i===lp)return n.RGB;if(i===Hn)return n.RGBA;if(i===Bi)return n.DEPTH_COMPONENT;if(i===xs)return n.DEPTH_STENCIL;if(i===cp)return n.RED;if(i===Mu)return n.RED_INTEGER;if(i===cr)return n.RG;if(i===yu)return n.RG_INTEGER;if(i===bu)return n.RGBA_INTEGER;if(i===sa||i===ra||i===oa||i===aa)if(o===It)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===sa)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ra)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===oa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===aa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===sa)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ra)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===oa)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===aa)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===pc||i===mc||i===gc||i===_c)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===pc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===mc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===gc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===_c)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===xc||i===vc||i===Mc||i===yc||i===bc||i===Sc||i===Ec)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===xc||i===vc)return o===It?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Mc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===yc)return r.COMPRESSED_R11_EAC;if(i===bc)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Sc)return r.COMPRESSED_RG11_EAC;if(i===Ec)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Tc||i===Ac||i===wc||i===Rc||i===Cc||i===Pc||i===Dc||i===Lc||i===Nc||i===Ic||i===Uc||i===Fc||i===Oc||i===Bc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Tc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ac)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===wc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Rc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Cc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Pc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Dc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Lc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Nc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ic)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Uc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Fc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Oc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Bc)return o===It?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===kc||i===Vc||i===zc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===kc)return o===It?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Vc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===zc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Hc||i===Gc||i===Wc||i===Xc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Hc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Gc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Wc)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Xc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===eo?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const mS=`
void main() {
...
}`;class _S{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new bp(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new pi({vertexShader:mS,fragmentShader:gS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new pn(new Ba(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class xS extends bs{constructor(e,t){super();const i=this;let s=null,r=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,f=null,d=null,_=null;const x=typeof XRWebGLBinding<"u",m=new _S,p={},A=t.getContextAttributes();let D=null,E=null;const R=[],N=[],L=new at;let U=null;const v=new fn;v.viewport=new kt;const b=new fn;b.viewport=new kt;const F=[v,b],z=new Ex;let H=null,ie=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let $=R[X];return $===void 0&&($=new Cl,R[X]=$),$.getTargetRaySpace()},this.getControllerGrip=function(X){let $=R[X];return $===void 0&&($=new Cl,R[X]=$),$.getGripSpace()},this.getHand=function(X){let $=R[X];return $===void 0&&($=new Cl,R[X]=$),$.getHandSpace()};function ne(X){const $=N.indexOf(X.inputSource);if($===-1)return;const ye=R[$];ye!==void 0&&(ye.update(X.inputSource,X.frame,c||o),ye.dispatchEvent({type:X.type,data:X.inputSource}))}function k(){s.removeEventListener("select",ne),s.removeEventListener("selectstart",ne),s.removeEventListener("selectend",ne),s.removeEventListener("squeeze",ne),s.removeEventListener("squeezestart",ne),s.removeEventListener("squeezeend",ne),s.removeEventListener("end",k),s.removeEventListener("inputsourceschange",G);for(let X=0;X<R.length;X++){const $=N[X];$!==null&&(N[X]=null,R[X].disconnect($))}H=null,ie=null,m.reset();for(const X in p)delete p[X];e.setRenderTarget(D),d=null,f=null,h=null,s=null,E=null,Me.stop(),i.isPresenting=!1,e.setPixelRatio(U),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,i.isPresenting===!0&&it("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){a=X,i.isPresenting===!0&&it("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return f!==null?f:d},this.getBinding=function(){return h===null&&x&&(h=new XRWebGLBinding(s,t)),h},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(X){if(s=X,s!==null){if(D=e.getRenderTarget(),s.addEventListener("select",ne),s.addEventListener("selectstart",ne),s.addEventListener("selectend",ne),s.addEventListener("squeeze",ne),s.addEventListener("squeezestart",ne),s.addEventListener("squeezeend",ne),s.addEventListener("end",k),s.addEventListener("inputsourceschange",G),A.xrCompatible!==!0&&await t.makeXRCompatible(),U=e.getPixelRatio(),e.getSize(L),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let ye=null,Je=null,Ie=null;A.depth&&(Ie=A.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ye=A.stencil?xs:Bi,Je=A.stencil?eo:di);const Mt={colorFormat:t.RGBA8,depthFormat:Ie,scaleFactor:r};h=this.getBinding(),f=h.createProjectionLayer(Mt),s.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),E=new hi(f.textureWidth,f.textureHeight,{format:Hn,type:In,depthTexture:new so(f.textureWidth,f.textureHeight,Je,void 0,void 0,void 0,void 0,void 0,void 0,ye),stencilBuffer:A.stencil,colorSpace:e.outputColorSpace,samples:A.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const ye={antialias:A.antialias,alpha:!0,depth:A.depth,stencil:A.stencil,framebufferScaleFactor:r};d=new XRWebGLLayer(s,t,ye),s.updateRenderState({baseLayer:d}),e.setPixelRatio(1),e.setSize(d.framebufferWidth,d.framebufferHeight,!1),E=new hi(d.framebufferWidth,d.framebufferHeight,{format:Hn,type:In,colorSpace:e.outputColorSpace,stencilBuffer:A.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),Me.setContext(s),Me.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function G(X){for(let $=0;$<X.removed.length;$++){const ye=X.removed[$],Je=N.indexOf(ye);Je>=0&&(N[Je]=null,R[Je].disconnect(ye))}for(let $=0;$<X.added.length;$++){const ye=X.added[$];let Je=N.indexOf(ye);if(Je===-1){for(let Mt=0;Mt<R.length;Mt++)if(Mt>=N.length){N.push(ye),Je=Mt;break}else if(N[Mt]===null){N[Mt]=ye,Je=Mt;break}if(Je===-1)break}const Ie=R[Je];Ie&&Ie.connect(ye)}}const K=new j,ve=new j;function se(X,$,ye){K.setFromMatrixPosition($.matrixWorld),ve.setFromMatrixPosition(ye.matrixWorld);const Je=K.distanceTo(ve),Ie=$.projectionMatrix.elements,Mt=ye.projectionMatrix.elements,O=Ie[14]/(Ie[10]-1),V=Ie[14]/(Ie[10]+1),Q=(Ie[9]+1)/Ie[5],he=(Ie[9]-1)/Ie[5],ae=(Ie[8]-1)/Ie[0],fe=(Mt[8]+1)/Mt[0],I=O*ae,be=O*fe,me=Je/(-ae+fe),ue=me*-ae;if($.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(ue),X.translateZ(me),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Ie[10]===-1)X.projectionMatrix.copy($.projectionMatrix),X.projectionMatrixInverse.copy($.projectionMatrixInverse);else{const ge=O+me,T=V+me,g=I-ue,B=be+(Je-ue),ee=Q*V/T*ge,ce=he*V/T*ge;X.projectionMatrix.makePerspective(g,B,ee,ce,ge,T),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function q(X,$){$===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices($.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(s===null)return;let $=X.near,ye=X.far;m.texture!==null&&(m.depthNear>0&&($=m.depthNear),m.depthFar>0&&(ye=m.depthFar)),z.near=b.near=v.near=$,z.far=b.far=v.far=ye,(H!==z.near||ie!==z.far)&&(s.updateRenderState({depthNear:z.near,depthFar:z.far}),H=z.near,ie=z.far),z.layers.mask=X.layers.mask|6,v.layers.mask=z.layers.mask&3,b.layers.mask=z.layers.mask&5;const Je=X.parent,Ie=z.cameras;q(z,Je);for(let Mt=0;Mt<Ie.length;Mt++)q(Ie[Mt],Je);Ie.length===2?se(z,v,b):z.projectionMatrix.copy(v.projectionMatrix),te(X,z,Je)};function te(X,$,ye){ye===null?X.matrix.copy($.matrixWorld):(X.matrix.copy(ye.matrixWorld),X.matrix.invert(),X.matrix.multiply($.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy($.projectionMatrix),X.projectionMatrixInverse.copy($.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=hr*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return z},this.getFoveation=function(){if(!(f===null&&d===null))return l},this.setFoveation=function(X){l=X,f!==null&&(f.fixedFoveation=X),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=X)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(z)},this.getCameraTexture=function(X){return p[X]};let pe=null;function _e(X,$){if(u=$.getViewerPose(c||o),_=$,u!==null){const ye=u.views;d!==null&&(e.setRenderTargetFramebuffer(E,d.framebuffer),e.setRenderTarget(E));let Je=!1;ye.length!==z.cameras.length&&(z.cameras.length=0,Je=!0);for(let V=0;V<ye.length;V++){const Q=ye[V];let he=null;if(d!==null)he=d.getViewport(Q);else{const fe=h.getViewSubImage(f,Q);he=fe.viewport,V===0&&(e.setRenderTargetTextures(E,fe.colorTexture,fe.depthStencilTexture),e.setRenderTarget(E))}let ae=F[V];ae===void 0&&(ae=new fn,ae.layers.enable(V),ae.viewport=new kt,F[V]=ae),ae.matrix.fromArray(Q.transform.matrix),ae.matrix.decompose(ae.position,ae.quaternion,ae.scale),ae.projectionMatrix.fromArray(Q.projectionMatrix),ae.projectionMatrixInverse.copy(ae.projectionMatrix).invert(),ae.viewport.set(he.x,he.y,he.width,he.height),V===0&&(z.matrix.copy(ae.matrix),z.matrix.decompose(z.position,z.quaternion,z.scale)),Je===!0&&z.cameras.push(ae)}const Ie=s.enabledFeatures;if(Ie&&Ie.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&x){h=i.getBinding();const V=h.getDepthInformation(ye[0]);V&&V.isValid&&V.texture&&m.init(V,s.renderState)}if(Ie&&Ie.includes("camera-access")&&x){e.state.unbindTexture(),h=i.getBinding();for(let V=0;V<ye.length;V++){const Q=ye[V].camera;if(Q){let he=p[Q];he||(he=new bp,p[Q]=he);const ae=h.getCameraImage(Q);he.sourceTexture=ae}}}}for(let ye=0;ye<R.length;ye++){const Je=N[ye],Ie=R[ye];Je!==null&&Ie!==void 0&&Ie.update(Je,$,c||o)}pe&&pe(X,$),$.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:$}),_=null}const Me=new Dp;Me.setAnimationLoop(_e),this.setAnimationLoop=function(X){pe=X},this.dispose=function(){}}}const ds=new Cn,vS=new ct;function MS(n,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,mp(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,A,D,E){p.isMeshBasicMaterial||p.isMeshLambertMaterial?r(m,p):p.isMeshToonMaterial?(r(m,p),h(m,p)):p.isMeshPhongMaterial?(r(m,p),u(m,p)):p.isMeshStandardMaterial?(r(m,p),f(m,p),p.isMeshPhysicalMaterial&&d(m,p,E)):p.isMeshMatcapMaterial?(r(m,p),_(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),x(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,A,D):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Rn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Rn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const A=e.get(p),D=A.envMap,E=A.envMapRotation;D&&(m.envMap.value=D,ds.copy(E),ds.x*=-1,ds.y*=-1,ds.z*=-1,D.isCubeTexture&&D.isRenderTargetTexture===!1&&(ds.y*=-1,ds.z*=-1),m.envMapRotation.value.setFromMatrix4(vS.makeRotationFromEuler(ds)),m.flipEnvMap.value=D.isCubeTexture&&D.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,A,D){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*A,m.scale.value=D*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function h(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function f(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,A){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Rn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=A.texture,m.transmissionSamplerSize.value.set(A.width,A.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function x(m,p){const A=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(A.matrixWorld),m.nearDistance.value=A.shadow.camera.near,m.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function yS(n,e,t,i){let s={},r={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(A,D){const E=D.program;i.uniformBlockBinding(A,E)}function c(A,D){let E=s[A.id];E===void 0&&(_(A),E=u(A),s[A.id]=E,A.addEventListener("dispose",m));const R=D.program;i.updateUBOMapping(A,R);const N=e.render.frame;r[A.id]!==N&&(f(A),r[A.id]=N)}function u(A){const D=h();A.__bindingPointIndex=D;const E=n.createBuffer(),R=A.__size,N=A.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,R,N),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,D,E),E}function h(){for(let A=0;A<a;A++)if(o.indexOf(A)===-1)return o.push(A),A;return _t("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(A){const D=s[A.id],E=A.uniforms,R=A.__cache;n.bindBuffer(n.UNIFORM_BUFFER,D);for(let N=0,L=E.length;N<L;N++){const U=Array.isArray(E[N])?E[N]:[E[N]];for(let v=0,b=U.length;v<b;v++){const F=U[v];if(d(F,N,v,R)===!0){const z=F.__offset,H=Array.isArray(F.value)?F.value:[F.value];let ie=0;for(let ne=0;ne<H.length;ne++){const k=H[ne],G=x(k);typeof k=="number"||typeof k=="boolean"?(F.__data[0]=k,n.bufferSubData(n.UNIFORM_BUFFER,z+ie,F.__data)):k.isMatrix3?(F.__data[0]=k.elements[0],F.__data[1]=k.elements[1],F.__data[2]=k.elements[2],F.__data[3]=0,F.__data[4]=k.elements[3],F.__data[5]=k.elements[4],F.__data[6]=k.elements[5],F.__data[7]=0,F.__data[8]=k.elements[6],F.__data[9]=k.elements[7],F.__data[10]=k.elements[8],F.__data[11]=0):(k.toArray(F.__data,ie),ie+=G.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,z,F.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function d(A,D,E,R){const N=A.value,L=D+"_"+E;if(R[L]===void 0)return typeof N=="number"||typeof N=="boolean"?R[L]=N:R[L]=N.clone(),!0;{const U=R[L];if(typeof N=="number"||typeof N=="boolean"){if(U!==N)return R[L]=N,!0}else if(U.equals(N)===!1)return U.copy(N),!0}return!1}function _(A){const D=A.uniforms;let E=0;const R=16;for(let L=0,U=D.length;L<U;L++){const v=Array.isArray(D[L])?D[L]:[D[L]];for(let b=0,F=v.length;b<F;b++){const z=v[b],H=Array.isArray(z.value)?z.value:[z.value];for(let ie=0,ne=H.length;ie<ne;ie++){const k=H[ie],G=x(k),K=E%R,ve=K%G.boundary,se=K+ve;E+=ve,se!==0&&R-se<G.storage&&(E+=R-se),z.__data=new Float32Array(G.storage/Float32Array.BYTES_PER_ELEMENT),z.__offset=E,E+=G.storage}}}const N=E%R;return N>0&&(E+=R-N),A.__size=E,A.__cache={},this}function x(A){const D={boundary:0,storage:0};return typeof A=="number"||typeof A=="boolean"?(D.boundary=4,D.storage=4):A.isVector2?(D.boundary=8,D.storage=8):A.isVector3||A.isColor?(D.boundary=16,D.storage=12):A.isVector4?(D.boundary=16,D.storage=16):A.isMatrix3?(D.boundary=48,D.storage=48):A.isMatrix4?(D.boundary=64,D.storage=64):A.isTexture?it("WebGLRenderer: Texture samplers can not be part of an uniforms group."):it("WebGLRenderer: Unsupported uniform value type.",A),D}function m(A){const D=A.target;D.removeEventListener("dispose",m);const E=o.indexOf(D.__bindingPointIndex);o.splice(E,1),n.deleteBuffer(s[D.id]),delete s[D.id],delete r[D.id]}function p(){for(const A in s)n.deleteBuffer(s[A]);o=[],s={},r={}}return{bind:l,update:c,dispose:p}}const bS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ni=null;function SS(){return ni===null&&(ni=new Cu(bS,16,16,cr,Oi),ni.name="DFG_LUT",ni.minFilter=Kt,ni.magFilter=Kt,ni.wrapS=Bn,ni.wrapT=Bn,ni.generateMipmaps=!1,ni.needsUpdate=!0),ni}class ES{constructor(e={}){const{canvas:t=u0(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1,outputBufferType:d=In}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=o;const x=d,m=new Set([bu,yu,Mu]),p=new Set([In,di,Qr,eo,xu,vu]),A=new Uint32Array(4),D=new Int32Array(4);let E=null,R=null;const N=[],L=[];let U=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ui,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const v=this;let b=!1;this._outputColorSpace=Wt;let F=0,z=0,H=null,ie=-1,ne=null;const k=new kt,G=new kt;let K=null;const ve=new ft(0);let se=0,q=t.width,te=t.height,pe=1,_e=null,Me=null;const X=new kt(0,0,q,te),$=new kt(0,0,q,te);let ye=!1;const Je=new Du;let Ie=!1,Mt=!1;const O=new ct,V=new j,Q=new kt,he={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ae=!1;function fe(){return H===null?pe:1}let I=i;function be(w,Y){return t.getContext(w,Y)}try{const w={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${gu}`),t.addEventListener("webglcontextlost",ot,!1),t.addEventListener("webglcontextrestored",Ut,!1),t.addEventListener("webglcontextcreationerror",dt,!1),I===null){const Y="webgl2";if(I=be(Y,w),I===null)throw be(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw _t("WebGLRenderer: "+w.message),w}let me,ue,ge,T,g,B,ee,ce,Z,Fe,Te,ke,Ke,Se,Ce,Le,Ve,Re,lt,W,Be,we,Ge,Ae;function xe(){me=new Sy(I),me.init(),we=new pS(I,me),ue=new py(I,me,e,we),ge=new fS(I,me),ue.reversedDepthBuffer&&f&&ge.buffers.depth.setReversed(!0),T=new Ay(I),g=new Jb,B=new dS(I,me,ge,g,ue,we,T),ee=new gy(v),ce=new by(v),Z=new Px(I),Ge=new fy(I,Z),Fe=new Ey(I,Z,T,Ge),Te=new Ry(I,Fe,Z,T),lt=new wy(I,ue,B),Le=new my(g),ke=new Kb(v,ee,ce,me,ue,Ge,Le),Ke=new MS(v,g),Se=new Qb,Ce=new rS(me),Re=new hy(v,ee,ce,ge,Te,_,l),Ve=new uS(v,Te,ue),Ae=new yS(I,T,ue,ge),W=new dy(I,me,T),Be=new Ty(I,me,T),T.programs=ke.programs,v.capabilities=ue,v.extensions=me,v.properties=g,v.renderLists=Se,v.shadowMap=Ve,v.state=ge,v.info=T}xe(),x!==In&&(U=new Py(x,t.width,t.height,s,r));const Pe=new xS(v,I);this.xr=Pe,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const w=me.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=me.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return pe},this.setPixelRatio=function(w){w!==void 0&&(pe=w,this.setSize(q,te,!1))},this.getSize=function(w){return w.set(q,te)},this.setSize=function(w,Y,oe=!0){if(Pe.isPresenting){it("WebGLRenderer: Can't change size while VR device is presenting.");return}q=w,te=Y,t.width=Math.floor(w*pe),t.height=Math.floor(Y*pe),oe===!0&&(t.style.width=w+"px",t.style.height=Y+"px"),U!==null&&U.setSize(t.width,t.height),this.setViewport(0,0,w,Y)},this.getDrawingBufferSize=function(w){return w.set(q*pe,te*pe).floor()},this.setDrawingBufferSize=function(w,Y,oe){q=w,te=Y,pe=oe,t.width=Math.floor(w*oe),t.height=Math.floor(Y*oe),this.setViewport(0,0,w,Y)},this.setEffects=function(w){if(x===In){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(w){for(let Y=0;Y<w.length;Y++)if(w[Y].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}U.setEffects(w||[])},this.getCurrentViewport=function(w){return w.copy(k)},this.getViewport=function(w){return w.copy(X)},this.setViewport=function(w,Y,oe,re){w.isVector4?X.set(w.x,w.y,w.z,w.w):X.set(w,Y,oe,re),ge.viewport(k.copy(X).multiplyScalar(pe).round())},this.getScissor=function(w){return w.copy($)},this.setScissor=function(w,Y,oe,re){w.isVector4?$.set(w.x,w.y,w.z,w.w):$.set(w,Y,oe,re),ge.scissor(G.copy($).multiplyScalar(pe).round())},this.getScissorTest=function(){return ye},this.setScissorTest=function(w){ge.setScissorTest(ye=w)},this.setOpaqueSort=function(w){_e=w},this.setTransparentSort=function(w){Me=w},this.getClearColor=function(w){return w.copy(Re.getClearColor())},this.setClearColor=function(){Re.setClearColor(...arguments)},this.getClearAlpha=function(){return Re.getClearAlpha()},this.setClearAlpha=function(){Re.setClearAlpha(...arguments)},this.clear=function(w=!0,Y=!0,oe=!0){let re=0;if(w){let J=!1;if(H!==null){const Ne=H.texture.format;J=m.has(Ne)}if(J){const Ne=H.texture.type,qe=p.has(Ne),Ue=Re.getClearColor(),We=Re.getClearAlpha(),Ze=Ue.r,rt=Ue.g,nt=Ue.b;qe?(A[0]=Ze,A[1]=rt,A[2]=nt,A[3]=We,I.clearBufferuiv(I.COLOR,0,A)):(D[0]=Ze,D[1]=rt,D[2]=nt,D[3]=We,I.clearBufferiv(I.COLOR,0,D))}else re|=I.COLOR_BUFFER_BIT}Y&&(re|=I.DEPTH_BUFFER_BIT),oe&&(re|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(re)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ot,!1),t.removeEventListener("webglcontextrestored",Ut,!1),t.removeEventListener("webglcontextcreationerror",dt,!1),Re.dispose(),Se.dispose(),Ce.dispose(),g.dispose(),ee.dispose(),ce.dispose(),Te.dispose(),Ge.dispose(),Ae.dispose(),ke.dispose(),Pe.dispose(),Pe.removeEventListener("sessionstart",ho),Pe.removeEventListener("sessionend",Er),mi.stop()};function ot(w){w.preventDefault(),Dh("WebGLRenderer: Context Lost."),b=!0}function Ut(){Dh("WebGLRenderer: Context Restored."),b=!1;const w=T.autoReset,Y=Ve.enabled,oe=Ve.autoUpdate,re=Ve.needsUpdate,J=Ve.type;xe(),T.autoReset=w,Ve.enabled=Y,Ve.autoUpdate=oe,Ve.needsUpdate=re,Ve.type=J}function dt(w){_t("WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function Pn(w){const Y=w.target;Y.removeEventListener("dispose",Pn),qn(Y)}function qn(w){Xa(w),g.remove(w)}function Xa(w){const Y=g.get(w).programs;Y!==void 0&&(Y.forEach(function(oe){ke.releaseProgram(oe)}),w.isShaderMaterial&&ke.releaseShaderCache(w))}this.renderBufferDirect=function(w,Y,oe,re,J,Ne){Y===null&&(Y=he);const qe=J.isMesh&&J.matrixWorld.determinant()<0,Ue=ja(w,Y,oe,re,J);ge.setMaterial(re,qe);let We=oe.index,Ze=1;if(re.wireframe===!0){if(We=Fe.getWireframeAttribute(oe),We===void 0)return;Ze=2}const rt=oe.drawRange,nt=oe.attributes.position;let pt=rt.start*Ze,Rt=(rt.start+rt.count)*Ze;Ne!==null&&(pt=Math.max(pt,Ne.start*Ze),Rt=Math.min(Rt,(Ne.start+Ne.count)*Ze)),We!==null?(pt=Math.max(pt,0),Rt=Math.min(Rt,We.count)):nt!=null&&(pt=Math.max(pt,0),Rt=Math.min(Rt,nt.count));const Vt=Rt-pt;if(Vt<0||Vt===1/0)return;Ge.setup(J,re,Ue,oe,We);let zt,Ct=W;if(We!==null&&(zt=Z.get(We),Ct=Be,Ct.setIndex(zt)),J.isMesh)re.wireframe===!0?(ge.setLineWidth(re.wireframeLinewidth*fe()),Ct.setMode(I.LINES)):Ct.setMode(I.TRIANGLES);else if(J.isLine){let ze=re.linewidth;ze===void 0&&(ze=1),ge.setLineWidth(ze*fe()),J.isLineSegments?Ct.setMode(I.LINES):J.isLineLoop?Ct.setMode(I.LINE_LOOP):Ct.setMode(I.LINE_STRIP)}else J.isPoints?Ct.setMode(I.POINTS):J.isSprite&&Ct.setMode(I.TRIANGLES);if(J.isBatchedMesh)if(J._multiDrawInstances!==null)no("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ct.renderMultiDrawInstances(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount,J._multiDrawInstances);else if(me.get("WEBGL_multi_draw"))Ct.renderMultiDraw(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount);else{const ze=J._multiDrawStarts,bt=J._multiDrawCounts,yt=J._multiDrawCount,on=We?Z.get(We).bytesPerElement:1,gi=g.get(re).currentProgram.getUniforms();for(let tn=0;tn<yt;tn++)gi.setValue(I,"_gl_DrawID",tn),Ct.render(ze[tn]/on,bt[tn])}else if(J.isInstancedMesh)Ct.renderInstances(pt,Vt,J.count);else if(oe.isInstancedBufferGeometry){const ze=oe._maxInstanceCount!==void 0?oe._maxInstanceCount:1/0,bt=Math.min(oe.instanceCount,ze);Ct.renderInstances(pt,Vt,bt)}else Ct.render(pt,Vt)};function uo(w,Y,oe){w.transparent===!0&&w.side===oi&&w.forceSinglePass===!1?(w.side=Rn,w.needsUpdate=!0,As(w,Y,oe),w.side=Fi,w.needsUpdate=!0,As(w,Y,oe),w.side=oi):As(w,Y,oe)}this.compile=function(w,Y,oe=null){oe===null&&(oe=w),R=Ce.get(oe),R.init(Y),L.push(R),oe.traverseVisible(function(J){J.isLight&&J.layers.test(Y.layers)&&(R.pushLight(J),J.castShadow&&R.pushShadow(J))}),w!==oe&&w.traverseVisible(function(J){J.isLight&&J.layers.test(Y.layers)&&(R.pushLight(J),J.castShadow&&R.pushShadow(J))}),R.setupLights();const re=new Set;return w.traverse(function(J){if(!(J.isMesh||J.isPoints||J.isLine||J.isSprite))return;const Ne=J.material;if(Ne)if(Array.isArray(Ne))for(let qe=0;qe<Ne.length;qe++){const Ue=Ne[qe];uo(Ue,oe,J),re.add(Ue)}else uo(Ne,oe,J),re.add(Ne)}),R=L.pop(),re},this.compileAsync=function(w,Y,oe=null){const re=this.compile(w,Y,oe);return new Promise(J=>{function Ne(){if(re.forEach(function(qe){g.get(qe).currentProgram.isReady()&&re.delete(qe)}),re.size===0){J(w);return}setTimeout(Ne,10)}me.get("KHR_parallel_shader_compile")!==null?Ne():setTimeout(Ne,10)})};let Sr=null;function qa(w){Sr&&Sr(w)}function ho(){mi.stop()}function Er(){mi.start()}const mi=new Dp;mi.setAnimationLoop(qa),typeof self<"u"&&mi.setContext(self),this.setAnimationLoop=function(w){Sr=w,Pe.setAnimationLoop(w),w===null?mi.stop():mi.start()},Pe.addEventListener("sessionstart",ho),Pe.addEventListener("sessionend",Er),this.render=function(w,Y){if(Y!==void 0&&Y.isCamera!==!0){_t("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;const oe=Pe.enabled===!0&&Pe.isPresenting===!0,re=U!==null&&(H===null||oe)&&U.begin(v,H);if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),Pe.enabled===!0&&Pe.isPresenting===!0&&(U===null||U.isCompositing()===!1)&&(Pe.cameraAutoUpdate===!0&&Pe.updateCamera(Y),Y=Pe.getCamera()),w.isScene===!0&&w.onBeforeRender(v,w,Y,H),R=Ce.get(w,L.length),R.init(Y),L.push(R),O.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),Je.setFromProjectionMatrix(O,li,Y.reversedDepth),Mt=this.localClippingEnabled,Ie=Le.init(this.clippingPlanes,Mt),E=Se.get(w,N.length),E.init(),N.push(E),Pe.enabled===!0&&Pe.isPresenting===!0){const qe=v.xr.getDepthSensingMesh();qe!==null&&Es(qe,Y,-1/0,v.sortObjects)}Es(w,Y,0,v.sortObjects),E.finish(),v.sortObjects===!0&&E.sort(_e,Me),ae=Pe.enabled===!1||Pe.isPresenting===!1||Pe.hasDepthSensing()===!1,ae&&Re.addToRenderList(E,w),this.info.render.frame++,Ie===!0&&Le.beginShadows();const J=R.state.shadowsArray;if(Ve.render(J,w,Y),Ie===!0&&Le.endShadows(),this.info.autoReset===!0&&this.info.reset(),(re&&U.hasRenderPass())===!1){const qe=E.opaque,Ue=E.transmissive;if(R.setupLights(),Y.isArrayCamera){const We=Y.cameras;if(Ue.length>0)for(let Ze=0,rt=We.length;Ze<rt;Ze++){const nt=We[Ze];po(qe,Ue,w,nt)}ae&&Re.render(w);for(let Ze=0,rt=We.length;Ze<rt;Ze++){const nt=We[Ze];fo(E,w,nt,nt.viewport)}}else Ue.length>0&&po(qe,Ue,w,Y),ae&&Re.render(w),fo(E,w,Y)}H!==null&&z===0&&(B.updateMultisampleRenderTarget(H),B.updateRenderTargetMipmap(H)),re&&U.end(v),w.isScene===!0&&w.onAfterRender(v,w,Y),Ge.resetDefaultState(),ie=-1,ne=null,L.pop(),L.length>0?(R=L[L.length-1],Ie===!0&&Le.setGlobalState(v.clippingPlanes,R.state.camera)):R=null,N.pop(),N.length>0?E=N[N.length-1]:E=null};function Es(w,Y,oe,re){if(w.visible===!1)return;if(w.layers.test(Y.layers)){if(w.isGroup)oe=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(Y);else if(w.isLight)R.pushLight(w),w.castShadow&&R.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Je.intersectsSprite(w)){re&&Q.setFromMatrixPosition(w.matrixWorld).applyMatrix4(O);const qe=Te.update(w),Ue=w.material;Ue.visible&&E.push(w,qe,Ue,oe,Q.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Je.intersectsObject(w))){const qe=Te.update(w),Ue=w.material;if(re&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),Q.copy(w.boundingSphere.center)):(qe.boundingSphere===null&&qe.computeBoundingSphere(),Q.copy(qe.boundingSphere.center)),Q.applyMatrix4(w.matrixWorld).applyMatrix4(O)),Array.isArray(Ue)){const We=qe.groups;for(let Ze=0,rt=We.length;Ze<rt;Ze++){const nt=We[Ze],pt=Ue[nt.materialIndex];pt&&pt.visible&&E.push(w,qe,pt,oe,Q.z,nt)}}else Ue.visible&&E.push(w,qe,Ue,oe,Q.z,null)}}const Ne=w.children;for(let qe=0,Ue=Ne.length;qe<Ue;qe++)Es(Ne[qe],Y,oe,re)}function fo(w,Y,oe,re){const{opaque:J,transmissive:Ne,transparent:qe}=w;R.setupLightsView(oe),Ie===!0&&Le.setGlobalState(v.clippingPlanes,oe),re&&ge.viewport(k.copy(re)),J.length>0&&Ts(J,Y,oe),Ne.length>0&&Ts(Ne,Y,oe),qe.length>0&&Ts(qe,Y,oe),ge.buffers.depth.setTest(!0),ge.buffers.depth.setMask(!0),ge.buffers.color.setMask(!0),ge.setPolygonOffset(!1)}function po(w,Y,oe,re){if((oe.isScene===!0?oe.overrideMaterial:null)!==null)return;if(R.state.transmissionRenderTarget[re.id]===void 0){const pt=me.has("EXT_color_buffer_half_float")||me.has("EXT_color_buffer_float");R.state.transmissionRenderTarget[re.id]=new hi(1,1,{generateMipmaps:!0,type:pt?Oi:In,minFilter:Ri,samples:ue.samples,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:vt.workingColorSpace})}const Ne=R.state.transmissionRenderTarget[re.id],qe=re.viewport||k;Ne.setSize(qe.z*v.transmissionResolutionScale,qe.w*v.transmissionResolutionScale);const Ue=v.getRenderTarget(),We=v.getActiveCubeFace(),Ze=v.getActiveMipmapLevel();v.setRenderTarget(Ne),v.getClearColor(ve),se=v.getClearAlpha(),se<1&&v.setClearColor(16777215,.5),v.clear(),ae&&Re.render(oe);const rt=v.toneMapping;v.toneMapping=ui;const nt=re.viewport;if(re.viewport!==void 0&&(re.viewport=void 0),R.setupLightsView(re),Ie===!0&&Le.setGlobalState(v.clippingPlanes,re),Ts(w,oe,re),B.updateMultisampleRenderTarget(Ne),B.updateRenderTargetMipmap(Ne),me.has("WEBGL_multisampled_render_to_texture")===!1){let pt=!1;for(let Rt=0,Vt=Y.length;Rt<Vt;Rt++){const zt=Y[Rt],{object:Ct,geometry:ze,material:bt,group:yt}=zt;if(bt.side===oi&&Ct.layers.test(re.layers)){const on=bt.side;bt.side=Rn,bt.needsUpdate=!0,mo(Ct,oe,re,ze,bt,yt),bt.side=on,bt.needsUpdate=!0,pt=!0}}pt===!0&&(B.updateMultisampleRenderTarget(Ne),B.updateRenderTargetMipmap(Ne))}v.setRenderTarget(Ue,We,Ze),v.setClearColor(ve,se),nt!==void 0&&(re.viewport=nt),v.toneMapping=rt}function Ts(w,Y,oe){const re=Y.isScene===!0?Y.overrideMaterial:null;for(let J=0,Ne=w.length;J<Ne;J++){const qe=w[J],{object:Ue,geometry:We,group:Ze}=qe;let rt=qe.material;rt.allowOverride===!0&&re!==null&&(rt=re),Ue.layers.test(oe.layers)&&mo(Ue,Y,oe,We,rt,Ze)}}function mo(w,Y,oe,re,J,Ne){w.onBeforeRender(v,Y,oe,re,J,Ne),w.modelViewMatrix.multiplyMatrices(oe.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),J.onBeforeRender(v,Y,oe,re,w,Ne),J.transparent===!0&&J.side===oi&&J.forceSinglePass===!1?(J.side=Rn,J.needsUpdate=!0,v.renderBufferDirect(oe,Y,re,J,w,Ne),J.side=Fi,J.needsUpdate=!0,v.renderBufferDirect(oe,Y,re,J,w,Ne),J.side=oi):v.renderBufferDirect(oe,Y,re,J,w,Ne),w.onAfterRender(v,Y,oe,re,J,Ne)}function As(w,Y,oe){Y.isScene!==!0&&(Y=he);const re=g.get(w),J=R.state.lights,Ne=R.state.shadowsArray,qe=J.state.version,Ue=ke.getParameters(w,J.state,Ne,Y,oe),We=ke.getProgramCacheKey(Ue);let Ze=re.programs;re.environment=w.isMeshStandardMaterial?Y.environment:null,re.fog=Y.fog,re.envMap=(w.isMeshStandardMaterial?ce:ee).get(w.envMap||re.environment),re.envMapRotation=re.environment!==null&&w.envMap===null?Y.environmentRotation:w.envMapRotation,Ze===void 0&&(w.addEventListener("dispose",Pn),Ze=new Map,re.programs=Ze);let rt=Ze.get(We);if(rt!==void 0){if(re.currentProgram===rt&&re.lightsStateVersion===qe)return _o(w,Ue),rt}else Ue.uniforms=ke.getUniforms(w),w.onBeforeCompile(Ue,v),rt=ke.acquireProgram(Ue,We),Ze.set(We,rt),re.uniforms=Ue.uniforms;const nt=re.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(nt.clippingPlanes=Le.uniform),_o(w,Ue),re.needsLights=$a(w),re.lightsStateVersion=qe,re.needsLights&&(nt.ambientLightColor.value=J.state.ambient,nt.lightProbe.value=J.state.probe,nt.directionalLights.value=J.state.directional,nt.directionalLightShadows.value=J.state.directionalShadow,nt.spotLights.value=J.state.spot,nt.spotLightShadows.value=J.state.spotShadow,nt.rectAreaLights.value=J.state.rectArea,nt.ltc_1.value=J.state.rectAreaLTC1,nt.ltc_2.value=J.state.rectAreaLTC2,nt.pointLights.value=J.state.point,nt.pointLightShadows.value=J.state.pointShadow,nt.hemisphereLights.value=J.state.hemi,nt.directionalShadowMap.value=J.state.directionalShadowMap,nt.directionalShadowMatrix.value=J.state.directionalShadowMatrix,nt.spotShadowMap.value=J.state.spotShadowMap,nt.spotLightMatrix.value=J.state.spotLightMatrix,nt.spotLightMap.value=J.state.spotLightMap,nt.pointShadowMap.value=J.state.pointShadowMap,nt.pointShadowMatrix.value=J.state.pointShadowMatrix),re.currentProgram=rt,re.uniformsList=null,rt}function go(w){if(w.uniformsList===null){const Y=w.currentProgram.getUniforms();w.uniformsList=la.seqWithValue(Y.seq,w.uniforms)}return w.uniformsList}function _o(w,Y){const oe=g.get(w);oe.outputColorSpace=Y.outputColorSpace,oe.batching=Y.batching,oe.batchingColor=Y.batchingColor,oe.instancing=Y.instancing,oe.instancingColor=Y.instancingColor,oe.instancingMorph=Y.instancingMorph,oe.skinning=Y.skinning,oe.morphTargets=Y.morphTargets,oe.morphNormals=Y.morphNormals,oe.morphColors=Y.morphColors,oe.morphTargetsCount=Y.morphTargetsCount,oe.numClippingPlanes=Y.numClippingPlanes,oe.numIntersection=Y.numClipIntersection,oe.vertexAlphas=Y.vertexAlphas,oe.vertexTangents=Y.vertexTangents,oe.toneMapping=Y.toneMapping}function ja(w,Y,oe,re,J){Y.isScene!==!0&&(Y=he),B.resetTextureUnits();const Ne=Y.fog,qe=re.isMeshStandardMaterial?Y.environment:null,Ue=H===null?v.outputColorSpace:H.isXRRenderTarget===!0?H.texture.colorSpace:ur,We=(re.isMeshStandardMaterial?ce:ee).get(re.envMap||qe),Ze=re.vertexColors===!0&&!!oe.attributes.color&&oe.attributes.color.itemSize===4,rt=!!oe.attributes.tangent&&(!!re.normalMap||re.anisotropy>0),nt=!!oe.morphAttributes.position,pt=!!oe.morphAttributes.normal,Rt=!!oe.morphAttributes.color;let Vt=ui;re.toneMapped&&(H===null||H.isXRRenderTarget===!0)&&(Vt=v.toneMapping);const zt=oe.morphAttributes.position||oe.morphAttributes.normal||oe.morphAttributes.color,Ct=zt!==void 0?zt.length:0,ze=g.get(re),bt=R.state.lights;if(Ie===!0&&(Mt===!0||w!==ne)){const Ye=w===ne&&re.id===ie;Le.setState(re,w,Ye)}let yt=!1;re.version===ze.__version?(ze.needsLights&&ze.lightsStateVersion!==bt.state.version||ze.outputColorSpace!==Ue||J.isBatchedMesh&&ze.batching===!1||!J.isBatchedMesh&&ze.batching===!0||J.isBatchedMesh&&ze.batchingColor===!0&&J.colorTexture===null||J.isBatchedMesh&&ze.batchingColor===!1&&J.colorTexture!==null||J.isInstancedMesh&&ze.instancing===!1||!J.isInstancedMesh&&ze.instancing===!0||J.isSkinnedMesh&&ze.skinning===!1||!J.isSkinnedMesh&&ze.skinning===!0||J.isInstancedMesh&&ze.instancingColor===!0&&J.instanceColor===null||J.isInstancedMesh&&ze.instancingColor===!1&&J.instanceColor!==null||J.isInstancedMesh&&ze.instancingMorph===!0&&J.morphTexture===null||J.isInstancedMesh&&ze.instancingMorph===!1&&J.morphTexture!==null||ze.envMap!==We||re.fog===!0&&ze.fog!==Ne||ze.numClippingPlanes!==void 0&&(ze.numClippingPlanes!==Le.numPlanes||ze.numIntersection!==Le.numIntersection)||ze.vertexAlphas!==Ze||ze.vertexTangents!==rt||ze.morphTargets!==nt||ze.morphNormals!==pt||ze.morphColors!==Rt||ze.toneMapping!==Vt||ze.morphTargetsCount!==Ct)&&(yt=!0):(yt=!0,ze.__version=re.version);let on=ze.currentProgram;yt===!0&&(on=As(re,Y,J));let gi=!1,tn=!1,ei=!1;const At=on.getUniforms(),nn=ze.uniforms;if(ge.useProgram(on.program)&&(gi=!0,tn=!0,ei=!0),re.id!==ie&&(ie=re.id,tn=!0),gi||ne!==w){ge.buffers.depth.getReversed()&&w.reversedDepth!==!0&&(w._reversedDepth=!0,w.updateProjectionMatrix()),At.setValue(I,"projectionMatrix",w.projectionMatrix),At.setValue(I,"viewMatrix",w.matrixWorldInverse);const Yt=At.map.cameraPosition;Yt!==void 0&&Yt.setValue(I,V.setFromMatrixPosition(w.matrixWorld)),ue.logarithmicDepthBuffer&&At.setValue(I,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(re.isMeshPhongMaterial||re.isMeshToonMaterial||re.isMeshLambertMaterial||re.isMeshBasicMaterial||re.isMeshStandardMaterial||re.isShaderMaterial)&&At.setValue(I,"isOrthographic",w.isOrthographicCamera===!0),ne!==w&&(ne=w,tn=!0,ei=!0)}if(ze.needsLights&&(bt.state.directionalShadowMap.length>0&&At.setValue(I,"directionalShadowMap",bt.state.directionalShadowMap,B),bt.state.spotShadowMap.length>0&&At.setValue(I,"spotShadowMap",bt.state.spotShadowMap,B),bt.state.pointShadowMap.length>0&&At.setValue(I,"pointShadowMap",bt.state.pointShadowMap,B)),J.isSkinnedMesh){At.setOptional(I,J,"bindMatrix"),At.setOptional(I,J,"bindMatrixInverse");const Ye=J.skeleton;Ye&&(Ye.boneTexture===null&&Ye.computeBoneTexture(),At.setValue(I,"boneTexture",Ye.boneTexture,B))}J.isBatchedMesh&&(At.setOptional(I,J,"batchingTexture"),At.setValue(I,"batchingTexture",J._matricesTexture,B),At.setOptional(I,J,"batchingIdTexture"),At.setValue(I,"batchingIdTexture",J._indirectTexture,B),At.setOptional(I,J,"batchingColorTexture"),J._colorsTexture!==null&&At.setValue(I,"batchingColorTexture",J._colorsTexture,B));const Sn=oe.morphAttributes;if((Sn.position!==void 0||Sn.normal!==void 0||Sn.color!==void 0)&&lt.update(J,oe,on),(tn||ze.receiveShadow!==J.receiveShadow)&&(ze.receiveShadow=J.receiveShadow,At.setValue(I,"receiveShadow",J.receiveShadow)),re.isMeshGouraudMaterial&&re.envMap!==null&&(nn.envMap.value=We,nn.flipEnvMap.value=We.isCubeTexture&&We.isRenderTargetTexture===!1?-1:1),re.isMeshStandardMaterial&&re.envMap===null&&Y.environment!==null&&(nn.envMapIntensity.value=Y.environmentIntensity),nn.dfgLUT!==void 0&&(nn.dfgLUT.value=SS()),tn&&(At.setValue(I,"toneMappingExposure",v.toneMappingExposure),ze.needsLights&&Ya(nn,ei),Ne&&re.fog===!0&&Ke.refreshFogUniforms(nn,Ne),Ke.refreshMaterialUniforms(nn,re,pe,te,R.state.transmissionRenderTarget[w.id]),la.upload(I,go(ze),nn,B)),re.isShaderMaterial&&re.uniformsNeedUpdate===!0&&(la.upload(I,go(ze),nn,B),re.uniformsNeedUpdate=!1),re.isSpriteMaterial&&At.setValue(I,"center",J.center),At.setValue(I,"modelViewMatrix",J.modelViewMatrix),At.setValue(I,"normalMatrix",J.normalMatrix),At.setValue(I,"modelMatrix",J.matrixWorld),re.isShaderMaterial||re.isRawShaderMaterial){const Ye=re.uniformsGroups;for(let Yt=0,y=Ye.length;Yt<y;Yt++){const M=Ye[Yt];Ae.update(M,on),Ae.bind(M,on)}}return on}function Ya(w,Y){w.ambientLightColor.needsUpdate=Y,w.lightProbe.needsUpdate=Y,w.directionalLights.needsUpdate=Y,w.directionalLightShadows.needsUpdate=Y,w.pointLights.needsUpdate=Y,w.pointLightShadows.needsUpdate=Y,w.spotLights.needsUpdate=Y,w.spotLightShadows.needsUpdate=Y,w.rectAreaLights.needsUpdate=Y,w.hemisphereLights.needsUpdate=Y}function $a(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return F},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return H},this.setRenderTargetTextures=function(w,Y,oe){const re=g.get(w);re.__autoAllocateDepthBuffer=w.resolveDepthBuffer===!1,re.__autoAllocateDepthBuffer===!1&&(re.__useRenderToTexture=!1),g.get(w.texture).__webglTexture=Y,g.get(w.depthTexture).__webglTexture=re.__autoAllocateDepthBuffer?void 0:oe,re.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(w,Y){const oe=g.get(w);oe.__webglFramebuffer=Y,oe.__useDefaultFramebuffer=Y===void 0};const xn=I.createFramebuffer();this.setRenderTarget=function(w,Y=0,oe=0){H=w,F=Y,z=oe;let re=null,J=!1,Ne=!1;if(w){const Ue=g.get(w);if(Ue.__useDefaultFramebuffer!==void 0){ge.bindFramebuffer(I.FRAMEBUFFER,Ue.__webglFramebuffer),k.copy(w.viewport),G.copy(w.scissor),K=w.scissorTest,ge.viewport(k),ge.scissor(G),ge.setScissorTest(K),ie=-1;return}else if(Ue.__webglFramebuffer===void 0)B.setupRenderTarget(w);else if(Ue.__hasExternalTextures)B.rebindTextures(w,g.get(w.texture).__webglTexture,g.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){const rt=w.depthTexture;if(Ue.__boundDepthTexture!==rt){if(rt!==null&&g.has(rt)&&(w.width!==rt.image.width||w.height!==rt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");B.setupDepthRenderbuffer(w)}}const We=w.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Ne=!0);const Ze=g.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(Ze[Y])?re=Ze[Y][oe]:re=Ze[Y],J=!0):w.samples>0&&B.useMultisampledRTT(w)===!1?re=g.get(w).__webglMultisampledFramebuffer:Array.isArray(Ze)?re=Ze[oe]:re=Ze,k.copy(w.viewport),G.copy(w.scissor),K=w.scissorTest}else k.copy(X).multiplyScalar(pe).floor(),G.copy($).multiplyScalar(pe).floor(),K=ye;if(oe!==0&&(re=xn),ge.bindFramebuffer(I.FRAMEBUFFER,re)&&ge.drawBuffers(w,re),ge.viewport(k),ge.scissor(G),ge.setScissorTest(K),J){const Ue=g.get(w.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+Y,Ue.__webglTexture,oe)}else if(Ne){const Ue=Y;for(let We=0;We<w.textures.length;We++){const Ze=g.get(w.textures[We]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+We,Ze.__webglTexture,oe,Ue)}}else if(w!==null&&oe!==0){const Ue=g.get(w.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Ue.__webglTexture,oe)}ie=-1},this.readRenderTargetPixels=function(w,Y,oe,re,J,Ne,qe,Ue=0){if(!(w&&w.isWebGLRenderTarget)){_t("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let We=g.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&qe!==void 0&&(We=We[qe]),We){ge.bindFramebuffer(I.FRAMEBUFFER,We);try{const Ze=w.textures[Ue],rt=Ze.format,nt=Ze.type;if(!ue.textureFormatReadable(rt)){_t("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ue.textureTypeReadable(nt)){_t("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=w.width-re&&oe>=0&&oe<=w.height-J&&(w.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Ue),I.readPixels(Y,oe,re,J,we.convert(rt),we.convert(nt),Ne))}finally{const Ze=H!==null?g.get(H).__webglFramebuffer:null;ge.bindFramebuffer(I.FRAMEBUFFER,Ze)}}},this.readRenderTargetPixelsAsync=async function(w,Y,oe,re,J,Ne,qe,Ue=0){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let We=g.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&qe!==void 0&&(We=We[qe]),We)if(Y>=0&&Y<=w.width-re&&oe>=0&&oe<=w.height-J){ge.bindFramebuffer(I.FRAMEBUFFER,We);const Ze=w.textures[Ue],rt=Ze.format,nt=Ze.type;if(!ue.textureFormatReadable(rt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ue.textureTypeReadable(nt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const pt=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,pt),I.bufferData(I.PIXEL_PACK_BUFFER,Ne.byteLength,I.STREAM_READ),w.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+Ue),I.readPixels(Y,oe,re,J,we.convert(rt),we.convert(nt),0);const Rt=H!==null?g.get(H).__webglFramebuffer:null;ge.bindFramebuffer(I.FRAMEBUFFER,Rt);const Vt=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await h0(I,Vt,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,pt),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,Ne),I.deleteBuffer(pt),I.deleteSync(Vt),Ne}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(w,Y=null,oe=0){const re=Math.pow(2,-oe),J=Math.floor(w.image.width*re),Ne=Math.floor(w.image.height*re),qe=Y!==null?Y.x:0,Ue=Y!==null?Y.y:0;B.setTexture2D(w,0),I.copyTexSubImage2D(I.TEXTURE_2D,oe,0,0,qe,Ue,J,Ne),ge.unbindTexture()};const Vi=I.createFramebuffer(),Tr=I.createFramebuffer();this.copyTextureToTexture=function(w,Y,oe=null,re=null,J=0,Ne=null){Ne===null&&(J!==0?(no("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Ne=J,J=0):Ne=0);let qe,Ue,We,Ze,rt,nt,pt,Rt,Vt;const zt=w.isCompressedTexture?w.mipmaps[Ne]:w.image;if(oe!==null)qe=oe.max.x-oe.min.x,Ue=oe.max.y-oe.min.y,We=oe.isBox3?oe.max.z-oe.min.z:1,Ze=oe.min.x,rt=oe.min.y,nt=oe.isBox3?oe.min.z:0;else{const Sn=Math.pow(2,-J);qe=Math.floor(zt.width*Sn),Ue=Math.floor(zt.height*Sn),w.isDataArrayTexture?We=zt.depth:w.isData3DTexture?We=Math.floor(zt.depth*Sn):We=1,Ze=0,rt=0,nt=0}re!==null?(pt=re.x,Rt=re.y,Vt=re.z):(pt=0,Rt=0,Vt=0);const Ct=we.convert(Y.format),ze=we.convert(Y.type);let bt;Y.isData3DTexture?(B.setTexture3D(Y,0),bt=I.TEXTURE_3D):Y.isDataArrayTexture||Y.isCompressedArrayTexture?(B.setTexture2DArray(Y,0),bt=I.TEXTURE_2D_ARRAY):(B.setTexture2D(Y,0),bt=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,Y.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,Y.unpackAlignment);const yt=I.getParameter(I.UNPACK_ROW_LENGTH),on=I.getParameter(I.UNPACK_IMAGE_HEIGHT),gi=I.getParameter(I.UNPACK_SKIP_PIXELS),tn=I.getParameter(I.UNPACK_SKIP_ROWS),ei=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,zt.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,zt.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Ze),I.pixelStorei(I.UNPACK_SKIP_ROWS,rt),I.pixelStorei(I.UNPACK_SKIP_IMAGES,nt);const At=w.isDataArrayTexture||w.isData3DTexture,nn=Y.isDataArrayTexture||Y.isData3DTexture;if(w.isDepthTexture){const Sn=g.get(w),Ye=g.get(Y),Yt=g.get(Sn.__renderTarget),y=g.get(Ye.__renderTarget);ge.bindFramebuffer(I.READ_FRAMEBUFFER,Yt.__webglFramebuffer),ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,y.__webglFramebuffer);for(let M=0;M<We;M++)At&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,g.get(w).__webglTexture,J,nt+M),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,g.get(Y).__webglTexture,Ne,Vt+M)),I.blitFramebuffer(Ze,rt,qe,Ue,pt,Rt,qe,Ue,I.DEPTH_BUFFER_BIT,I.NEAREST);ge.bindFramebuffer(I.READ_FRAMEBUFFER,null),ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(J!==0||w.isRenderTargetTexture||g.has(w)){const Sn=g.get(w),Ye=g.get(Y);ge.bindFramebuffer(I.READ_FRAMEBUFFER,Vi),ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,Tr);for(let Yt=0;Yt<We;Yt++)At?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Sn.__webglTexture,J,nt+Yt):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Sn.__webglTexture,J),nn?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Ye.__webglTexture,Ne,Vt+Yt):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Ye.__webglTexture,Ne),J!==0?I.blitFramebuffer(Ze,rt,qe,Ue,pt,Rt,qe,Ue,I.COLOR_BUFFER_BIT,I.NEAREST):nn?I.copyTexSubImage3D(bt,Ne,pt,Rt,Vt+Yt,Ze,rt,qe,Ue):I.copyTexSubImage2D(bt,Ne,pt,Rt,Ze,rt,qe,Ue);ge.bindFramebuffer(I.READ_FRAMEBUFFER,null),ge.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else nn?w.isDataTexture||w.isData3DTexture?I.texSubImage3D(bt,Ne,pt,Rt,Vt,qe,Ue,We,Ct,ze,zt.data):Y.isCompressedArrayTexture?I.compressedTexSubImage3D(bt,Ne,pt,Rt,Vt,qe,Ue,We,Ct,zt.data):I.texSubImage3D(bt,Ne,pt,Rt,Vt,qe,Ue,We,Ct,ze,zt):w.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,Ne,pt,Rt,qe,Ue,Ct,ze,zt.data):w.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,Ne,pt,Rt,zt.width,zt.height,Ct,zt.data):I.texSubImage2D(I.TEXTURE_2D,Ne,pt,Rt,qe,Ue,Ct,ze,zt);I.pixelStorei(I.UNPACK_ROW_LENGTH,yt),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,on),I.pixelStorei(I.UNPACK_SKIP_PIXELS,gi),I.pixelStorei(I.UNPACK_SKIP_ROWS,tn),I.pixelStorei(I.UNPACK_SKIP_IMAGES,ei),Ne===0&&Y.generateMipmaps&&I.generateMipmap(bt),ge.unbindTexture()},this.initRenderTarget=function(w){g.get(w).__webglFramebuffer===void 0&&B.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?B.setTextureCube(w,0):w.isData3DTexture?B.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?B.setTexture2DArray(w,0):B.setTexture2D(w,0),ge.unbindTexture()},this.resetState=function(){F=0,z=0,H=null,ge.reset(),Ge.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return li}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=vt._getDrawingBufferColorSpace(e),t.unpackColorSpace=vt._getUnpackColorSpace()}}const Of={type:"change"},Fu={type:"start"},Fp={type:"end"},Yo=new lo,Bf=new Ji,TS=Math.cos(70*Ys.DEG2RAD),$t=new j,Tn=2*Math.PI,Ft={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Hl=1e-6;class AS extends Rx{constructor(e,t=null){super(e,t),this.state=Ft.NONE,this.target=new j,this.cursor=new j,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:tr.ROTATE,MIDDLE:tr.DOLLY,RIGHT:tr.PAN},this.touches={ONE:$s.ROTATE,TWO:$s.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new j,this._lastQuaternion=new Xn,this._lastTargetPosition=new j,this._quat=new Xn().setFromUnitVectors(e.up,new j(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ff,this._sphericalDelta=new ff,this._scale=1,this._panOffset=new j,this._rotateStart=new at,this._rotateEnd=new at,this._rotateDelta=new at,this._panStart=new at,this._panEnd=new at,this._panDelta=new at,this._dollyStart=new at,this._dollyEnd=new at,this._dollyDelta=new at,this._dollyDirection=new j,this._mouse=new at,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=RS.bind(this),this._onPointerDown=wS.bind(this),this._onPointerUp=CS.bind(this),this._onContextMenu=FS.bind(this),this._onMouseWheel=LS.bind(this),this._onKeyDown=NS.bind(this),this._onTouchStart=IS.bind(this),this._onTouchMove=US.bind(this),this._onMouseDown=PS.bind(this),this._onMouseMove=DS.bind(this),this._interceptControlDown=OS.bind(this),this._interceptControlUp=BS.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Of),this.update(),this.state=Ft.NONE}update(e=null){const t=this.object.position;$t.copy(t).sub(this.target),$t.applyQuaternion(this._quat),this._spherical.setFromVector3($t),this.autoRotate&&this.state===Ft.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(i)&&isFinite(s)&&(i<-Math.PI?i+=Tn:i>Math.PI&&(i-=Tn),s<-Math.PI?s+=Tn:s>Math.PI&&(s-=Tn),i<=s?this._spherical.theta=Math.max(i,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+s)/2?Math.max(i,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=o!=this._spherical.radius}if($t.setFromSpherical(this._spherical),$t.applyQuaternion(this._quatInverse),t.copy(this.target).add($t),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=$t.length();o=this._clampDistance(a*this._scale);const l=a-o;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){const a=new j(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;const c=new j(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(a),this.object.updateMatrixWorld(),o=$t.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(Yo.origin.copy(this.object.position),Yo.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Yo.direction))<TS?this.object.lookAt(this.target):(Bf.setFromNormalAndCoplanarPoint(this.object.up,this.target),Yo.intersectPlane(Bf,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>Hl||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Hl||this._lastTargetPosition.distanceToSquared(this.target)>Hl?(this.dispatchEvent(Of),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?Tn/60*this.autoRotateSpeed*e:Tn/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){$t.setFromMatrixColumn(t,0),$t.multiplyScalar(-e),this._panOffset.add($t)}_panUp(e,t){this.screenSpacePanning===!0?$t.setFromMatrixColumn(t,1):($t.setFromMatrixColumn(t,0),$t.crossVectors(this.object.up,$t)),$t.multiplyScalar(e),this._panOffset.add($t)}_pan(e,t){const i=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;$t.copy(s).sub(this.target);let r=$t.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*r/i.clientHeight,this.object.matrix),this._panUp(2*t*r/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),s=e-i.left,r=t-i.top,o=i.width,a=i.height;this._mouse.x=s/o*2-1,this._mouse.y=-(r/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Tn*this._rotateDelta.x/t.clientHeight),this._rotateUp(Tn*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Tn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Tn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Tn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Tn*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._rotateStart.set(i,s)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panStart.set(i,s)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,s=e.pageY-t.y,r=Math.sqrt(i*i+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),s=.5*(e.pageX+i.x),r=.5*(e.pageY+i.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(Tn*this._rotateDelta.x/t.clientHeight),this._rotateUp(Tn*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),s=.5*(e.pageY+t.y);this._panEnd.set(i,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,s=e.pageY-t.y,r=Math.sqrt(i*i+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(e.pageX+t.x)*.5,a=(e.pageY+t.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new at,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function wS(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.ownerDocument.addEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function RS(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function CS(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.ownerDocument.removeEventListener("pointermove",this._onPointerMove),this.domElement.ownerDocument.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Fp),this.state=Ft.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function PS(n){let e;switch(n.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case tr.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=Ft.DOLLY;break;case tr.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=Ft.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=Ft.ROTATE}break;case tr.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=Ft.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=Ft.PAN}break;default:this.state=Ft.NONE}this.state!==Ft.NONE&&this.dispatchEvent(Fu)}function DS(n){switch(this.state){case Ft.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case Ft.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case Ft.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function LS(n){this.enabled===!1||this.enableZoom===!1||this.state!==Ft.NONE||(n.preventDefault(),this.dispatchEvent(Fu),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(Fp))}function NS(n){this.enabled!==!1&&this._handleKeyDown(n)}function IS(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case $s.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=Ft.TOUCH_ROTATE;break;case $s.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=Ft.TOUCH_PAN;break;default:this.state=Ft.NONE}break;case 2:switch(this.touches.TWO){case $s.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=Ft.TOUCH_DOLLY_PAN;break;case $s.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=Ft.TOUCH_DOLLY_ROTATE;break;default:this.state=Ft.NONE}break;default:this.state=Ft.NONE}this.state!==Ft.NONE&&this.dispatchEvent(Fu)}function US(n){switch(this._trackPointer(n),this.state){case Ft.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case Ft.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case Ft.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case Ft.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=Ft.NONE}}function FS(n){this.enabled!==!1&&n.preventDefault()}function OS(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function BS(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}class kS extends ns{constructor(e){super(e)}load(e,t,i,s){const r=this,o=new Iu(this.manager);o.setPath(this.path),o.setResponseType("arraybuffer"),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(e,function(a){try{t(r.parse(a))}catch(l){s?s(l):console.error(l),r.manager.itemError(e)}},i,s)}parse(e){function t(c){const u=new DataView(c),h=32/8*3+32/8*3*3+16/8,f=u.getUint32(80,!0);if(80+32/8+f*h===u.byteLength)return!0;const _=[115,111,108,105,100];for(let x=0;x<5;x++)if(i(_,u,x))return!1;return!0}function i(c,u,h){for(let f=0,d=c.length;f<d;f++)if(c[f]!==u.getUint8(h+f))return!1;return!0}function s(c){const u=new DataView(c),h=u.getUint32(80,!0);let f,d,_,x=!1,m,p,A,D,E;for(let F=0;F<70;F++)u.getUint32(F,!1)==1129270351&&u.getUint8(F+4)==82&&u.getUint8(F+5)==61&&(x=!0,m=new Float32Array(h*3*3),p=u.getUint8(F+6)/255,A=u.getUint8(F+7)/255,D=u.getUint8(F+8)/255,E=u.getUint8(F+9)/255);const R=84,N=50,L=new en,U=new Float32Array(h*3*3),v=new Float32Array(h*3*3),b=new ft;for(let F=0;F<h;F++){const z=R+F*N,H=u.getFloat32(z,!0),ie=u.getFloat32(z+4,!0),ne=u.getFloat32(z+8,!0);if(x){const k=u.getUint16(z+48,!0);(k&32768)===0?(f=(k&31)/31,d=(k>>5&31)/31,_=(k>>10&31)/31):(f=p,d=A,_=D)}for(let k=1;k<=3;k++){const G=z+k*12,K=F*3*3+(k-1)*3;U[K]=u.getFloat32(G,!0),U[K+1]=u.getFloat32(G+4,!0),U[K+2]=u.getFloat32(G+8,!0),v[K]=H,v[K+1]=ie,v[K+2]=ne,x&&(b.setRGB(f,d,_,Wt),m[K]=b.r,m[K+1]=b.g,m[K+2]=b.b)}}return L.setAttribute("position",new kn(U,3)),L.setAttribute("normal",new kn(v,3)),x&&(L.setAttribute("color",new kn(m,3)),L.hasColors=!0,L.alpha=E),L}function r(c){const u=new en,h=/solid([\s\S]*?)endsolid/g,f=/facet([\s\S]*?)endfacet/g,d=/solid\s(.+)/;let _=0;const x=/[\s]+([+-]?(?:\d*)(?:\.\d*)?(?:[eE][+-]?\d+)?)/.source,m=new RegExp("vertex"+x+x+x,"g"),p=new RegExp("normal"+x+x+x,"g"),A=[],D=[],E=[],R=new j;let N,L=0,U=0,v=0;for(;(N=h.exec(c))!==null;){U=v;const b=N[0],F=(N=d.exec(b))!==null?N[1]:"";for(E.push(F);(N=f.exec(b))!==null;){let ie=0,ne=0;const k=N[0];for(;(N=p.exec(k))!==null;)R.x=parseFloat(N[1]),R.y=parseFloat(N[2]),R.z=parseFloat(N[3]),ne++;for(;(N=m.exec(k))!==null;)A.push(parseFloat(N[1]),parseFloat(N[2]),parseFloat(N[3])),D.push(R.x,R.y,R.z),ie++,v++;ne!==1&&console.error("THREE.STLLoader: Something isn't right with the normal of face number "+_),ie!==3&&console.error("THREE.STLLoader: Something isn't right with the vertices of face number "+_),_++}const z=U,H=v-U;u.userData.groupNames=E,u.addGroup(z,H,L),L++}return u.setAttribute("position",new wt(A,3)),u.setAttribute("normal",new wt(D,3)),u}function o(c){return typeof c!="string"?new TextDecoder().decode(c):c}function a(c){if(typeof c=="string"){const u=new Uint8Array(c.length);for(let h=0;h<c.length;h++)u[h]=c.charCodeAt(h)&255;return u.buffer||u}else return c}const l=a(e);return t(l)?s(l):r(o(e))}}class kf extends xx{constructor(e){super(e)}parse(e){function t(k){switch(k.image_type){case f:case x:if(k.colormap_length>256||k.colormap_size!==24||k.colormap_type!==1)throw new Error("THREE.TGALoader: Invalid type colormap data for indexed type.");break;case d:case _:case m:case p:if(k.colormap_type)throw new Error("THREE.TGALoader: Invalid type colormap data for colormap type.");break;case h:throw new Error("THREE.TGALoader: No data.");default:throw new Error("THREE.TGALoader: Invalid type "+k.image_type)}if(k.width<=0||k.height<=0)throw new Error("THREE.TGALoader: Invalid image size.");if(k.pixel_size!==8&&k.pixel_size!==16&&k.pixel_size!==24&&k.pixel_size!==32)throw new Error("THREE.TGALoader: Invalid pixel size "+k.pixel_size)}function i(k,G,K,ve,se){let q,te;const pe=K.pixel_size>>3,_e=K.width*K.height*pe;if(G&&(te=se.subarray(ve,ve+=K.colormap_length*(K.colormap_size>>3))),k){q=new Uint8Array(_e);let Me,X,$,ye=0;const Je=new Uint8Array(pe);for(;ye<_e;)if(Me=se[ve++],X=(Me&127)+1,Me&128){for($=0;$<pe;++$)Je[$]=se[ve++];for($=0;$<X;++$)q.set(Je,ye+$*pe);ye+=pe*X}else{for(X*=pe,$=0;$<X;++$)q[ye+$]=se[ve++];ye+=X}}else q=se.subarray(ve,ve+=G?K.width*K.height:_e);return{pixel_data:q,palettes:te}}function s(k,G,K,ve,se,q,te,pe,_e){const Me=_e;let X,$=0,ye,Je;const Ie=b.width;for(Je=G;Je!==ve;Je+=K)for(ye=se;ye!==te;ye+=q,$++)X=pe[$],k[(ye+Ie*Je)*4+3]=255,k[(ye+Ie*Je)*4+2]=Me[X*3+0],k[(ye+Ie*Je)*4+1]=Me[X*3+1],k[(ye+Ie*Je)*4+0]=Me[X*3+2];return k}function r(k,G,K,ve,se,q,te,pe){let _e,Me=0,X,$;const ye=b.width;for($=G;$!==ve;$+=K)for(X=se;X!==te;X+=q,Me+=2)_e=pe[Me+0]+(pe[Me+1]<<8),k[(X+ye*$)*4+0]=(_e&31744)>>7,k[(X+ye*$)*4+1]=(_e&992)>>2,k[(X+ye*$)*4+2]=(_e&31)<<3,k[(X+ye*$)*4+3]=_e&32768?0:255;return k}function o(k,G,K,ve,se,q,te,pe){let _e=0,Me,X;const $=b.width;for(X=G;X!==ve;X+=K)for(Me=se;Me!==te;Me+=q,_e+=3)k[(Me+$*X)*4+3]=255,k[(Me+$*X)*4+2]=pe[_e+0],k[(Me+$*X)*4+1]=pe[_e+1],k[(Me+$*X)*4+0]=pe[_e+2];return k}function a(k,G,K,ve,se,q,te,pe){let _e=0,Me,X;const $=b.width;for(X=G;X!==ve;X+=K)for(Me=se;Me!==te;Me+=q,_e+=4)k[(Me+$*X)*4+2]=pe[_e+0],k[(Me+$*X)*4+1]=pe[_e+1],k[(Me+$*X)*4+0]=pe[_e+2],k[(Me+$*X)*4+3]=pe[_e+3];return k}function l(k,G,K,ve,se,q,te,pe){let _e,Me=0,X,$;const ye=b.width;for($=G;$!==ve;$+=K)for(X=se;X!==te;X+=q,Me++)_e=pe[Me],k[(X+ye*$)*4+0]=_e,k[(X+ye*$)*4+1]=_e,k[(X+ye*$)*4+2]=_e,k[(X+ye*$)*4+3]=255;return k}function c(k,G,K,ve,se,q,te,pe){let _e=0,Me,X;const $=b.width;for(X=G;X!==ve;X+=K)for(Me=se;Me!==te;Me+=q,_e+=2)k[(Me+$*X)*4+0]=pe[_e+0],k[(Me+$*X)*4+1]=pe[_e+0],k[(Me+$*X)*4+2]=pe[_e+0],k[(Me+$*X)*4+3]=pe[_e+1];return k}function u(k,G,K,ve,se){let q,te,pe,_e,Me,X;switch((b.flags&A)>>D){default:case N:q=0,pe=1,Me=G,te=0,_e=1,X=K;break;case E:q=0,pe=1,Me=G,te=K-1,_e=-1,X=-1;break;case L:q=G-1,pe=-1,Me=-1,te=0,_e=1,X=K;break;case R:q=G-1,pe=-1,Me=-1,te=K-1,_e=-1,X=-1;break}if(H)switch(b.pixel_size){case 8:l(k,te,_e,X,q,pe,Me,ve);break;case 16:c(k,te,_e,X,q,pe,Me,ve);break;default:throw new Error("THREE.TGALoader: Format not supported.")}else switch(b.pixel_size){case 8:s(k,te,_e,X,q,pe,Me,ve,se);break;case 16:r(k,te,_e,X,q,pe,Me,ve);break;case 24:o(k,te,_e,X,q,pe,Me,ve);break;case 32:a(k,te,_e,X,q,pe,Me,ve);break;default:throw new Error("THREE.TGALoader: Format not supported.")}return k}const h=0,f=1,d=2,_=3,x=9,m=10,p=11,A=48,D=4,E=0,R=1,N=2,L=3;if(e.length<19)throw new Error("THREE.TGALoader: Not enough data to contain header.");let U=0;const v=new Uint8Array(e),b={id_length:v[U++],colormap_type:v[U++],image_type:v[U++],colormap_index:v[U++]|v[U++]<<8,colormap_length:v[U++]|v[U++]<<8,colormap_size:v[U++],origin:[v[U++]|v[U++]<<8,v[U++]|v[U++]<<8],width:v[U++]|v[U++]<<8,height:v[U++]|v[U++]<<8,pixel_size:v[U++],flags:v[U++]};if(t(b),b.id_length+U>e.length)throw new Error("THREE.TGALoader: No data.");U+=b.id_length;let F=!1,z=!1,H=!1;switch(b.image_type){case x:F=!0,z=!0;break;case f:z=!0;break;case m:F=!0;break;case d:break;case p:F=!0,H=!0;break;case _:H=!0;break}const ie=new Uint8Array(b.width*b.height*4),ne=i(F,z,b,U,v);return u(ie,b.width,b.height,ne.pixel_data,ne.palettes),{data:ie,width:b.width,height:b.height,flipY:!0,generateMipmaps:!0,minFilter:Ri}}}class VS extends ns{load(e,t,i,s){const r=this,o=r.path===""?Pp.extractUrlBase(e):r.path,a=new Iu(r.manager);a.setPath(r.path),a.setRequestHeader(r.requestHeader),a.setWithCredentials(r.withCredentials),a.load(e,function(l){try{t(r.parse(l,o))}catch(c){s?s(c):console.error(c),r.manager.itemError(e)}},i,s)}parse(e,t){function i(y,M){const C=[],S=y.childNodes;for(let P=0,le=S.length;P<le;P++){const de=S[P];de.nodeName===M&&C.push(de)}return C}function s(y){if(y.length===0)return[];const M=y.trim().split(/\s+/),C=new Array(M.length);for(let S=0,P=M.length;S<P;S++)C[S]=M[S];return C}function r(y){if(y.length===0)return[];const M=y.trim().split(/\s+/),C=new Array(M.length);for(let S=0,P=M.length;S<P;S++)C[S]=parseFloat(M[S]);return C}function o(y){if(y.length===0)return[];const M=y.trim().split(/\s+/),C=new Array(M.length);for(let S=0,P=M.length;S<P;S++)C[S]=parseInt(M[S]);return C}function a(y){return y.substring(1)}function l(){return"three_default_"+Sn++}function c(y){return Object.keys(y).length===0}function u(y){return{unit:h(i(y,"unit")[0]),upAxis:f(i(y,"up_axis")[0])}}function h(y){return y!==void 0&&y.hasAttribute("meter")===!0?parseFloat(y.getAttribute("meter")):1}function f(y){return y!==void 0?y.textContent:"Y_UP"}function d(y,M,C,S){const P=i(y,M)[0];if(P!==void 0){const le=i(P,C);for(let de=0;de<le.length;de++)S(le[de])}}function _(y,M){for(const C in y){const S=y[C];S.build=M(y[C])}}function x(y,M){return y.build!==void 0||(y.build=M(y)),y.build}function m(y){const M={sources:{},samplers:{},channels:{}};let C=!1;for(let S=0,P=y.childNodes.length;S<P;S++){const le=y.childNodes[S];if(le.nodeType!==1)continue;let de;switch(le.nodeName){case"source":de=le.getAttribute("id"),M.sources[de]=we(le);break;case"sampler":de=le.getAttribute("id"),M.samplers[de]=p(le);break;case"channel":de=le.getAttribute("target"),M.channels[de]=A(le);break;case"animation":m(le),C=!0;break;default:console.log(le)}}C===!1&&(Ye.animations[y.getAttribute("id")||Ys.generateUUID()]=M)}function p(y){const M={inputs:{}};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1&&P.nodeName==="input"){const le=a(P.getAttribute("source")),de=P.getAttribute("semantic");M.inputs[de]=le}}return M}function A(y){const M={};let S=y.getAttribute("target").split("/");const P=S.shift();let le=S.shift();const de=le.indexOf("(")!==-1,je=le.indexOf(".")!==-1;if(je)S=le.split("."),le=S.shift(),M.member=S.shift();else if(de){const De=le.split("(");le=De.shift();for(let He=0;He<De.length;He++)De[He]=parseInt(De[He].replace(/\)/,""));M.indices=De}return M.id=P,M.sid=le,M.arraySyntax=de,M.memberSyntax=je,M.sampler=a(y.getAttribute("source")),M}function D(y){const M=[],C=y.channels,S=y.samplers,P=y.sources;for(const le in C)if(C.hasOwnProperty(le)){const de=C[le],je=S[de.sampler],De=je.inputs.INPUT,He=je.inputs.OUTPUT,et=P[De],Ee=P[He],Qe=R(de,et,Ee);b(Qe,M)}return M}function E(y){return x(Ye.animations[y],D)}function R(y,M,C){const S=Ye.nodes[y.id],P=We(S.id),le=S.transforms[y.sid],de=S.matrix.clone().transpose();let je,De,He,et,Ee,Qe;const $e={};switch(le){case"matrix":for(He=0,et=M.array.length;He<et;He++)if(je=M.array[He],De=He*C.stride,$e[je]===void 0&&($e[je]={}),y.arraySyntax===!0){const Gt=C.array[De],Nt=y.indices[0]+4*y.indices[1];$e[je][Nt]=Gt}else for(Ee=0,Qe=C.stride;Ee<Qe;Ee++)$e[je][Ee]=C.array[De+Ee];break;case"translate":console.warn('THREE.ColladaLoader: Animation transform type "%s" not yet implemented.',le);break;case"rotate":console.warn('THREE.ColladaLoader: Animation transform type "%s" not yet implemented.',le);break;case"scale":console.warn('THREE.ColladaLoader: Animation transform type "%s" not yet implemented.',le);break}const st=N($e,de);return{name:P.uuid,keyframes:st}}function N(y,M){const C=[];for(const P in y)C.push({time:parseFloat(P),value:y[P]});C.sort(S);for(let P=0;P<16;P++)F(C,P,M.elements[P]);return C;function S(P,le){return P.time-le.time}}const L=new j,U=new j,v=new Xn;function b(y,M){const C=y.keyframes,S=y.name,P=[],le=[],de=[],je=[];for(let De=0,He=C.length;De<He;De++){const et=C[De],Ee=et.time,Qe=et.value;xn.fromArray(Qe).transpose(),xn.decompose(L,v,U),P.push(Ee),le.push(L.x,L.y,L.z),de.push(v.x,v.y,v.z,v.w),je.push(U.x,U.y,U.z)}return le.length>0&&M.push(new pr(S+".position",P,le)),de.length>0&&M.push(new co(S+".quaternion",P,de)),je.length>0&&M.push(new pr(S+".scale",P,je)),M}function F(y,M,C){let S,P=!0,le,de;for(le=0,de=y.length;le<de;le++)S=y[le],S.value[M]===void 0?S.value[M]=null:P=!1;if(P===!0)for(le=0,de=y.length;le<de;le++)S=y[le],S.value[M]=C;else z(y,M)}function z(y,M){let C,S;for(let P=0,le=y.length;P<le;P++){const de=y[P];if(de.value[M]===null){if(C=H(y,P,M),S=ie(y,P,M),C===null){de.value[M]=S.value[M];continue}if(S===null){de.value[M]=C.value[M];continue}ne(de,C,S,M)}}}function H(y,M,C){for(;M>=0;){const S=y[M];if(S.value[C]!==null)return S;M--}return null}function ie(y,M,C){for(;M<y.length;){const S=y[M];if(S.value[C]!==null)return S;M++}return null}function ne(y,M,C,S){if(C.time-M.time===0){y.value[S]=M.value[S];return}y.value[S]=(y.time-M.time)*(C.value[S]-M.value[S])/(C.time-M.time)+M.value[S]}function k(y){const M={name:y.getAttribute("id")||"default",start:parseFloat(y.getAttribute("start")||0),end:parseFloat(y.getAttribute("end")||0),animations:[]};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="instance_animation"&&M.animations.push(a(P.getAttribute("url")))}Ye.clips[y.getAttribute("id")]=M}function G(y){const M=[],C=y.name,S=y.end-y.start||-1,P=y.animations;for(let le=0,de=P.length;le<de;le++){const je=E(P[le]);for(let De=0,He=je.length;De<He;De++)M.push(je[De])}return new af(C,S,M)}function K(y){return x(Ye.clips[y],G)}function ve(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"skin":M.id=a(P.getAttribute("source")),M.skin=se(P);break;case"morph":M.id=a(P.getAttribute("source")),console.warn("THREE.ColladaLoader: Morph target animation not supported yet.");break}}Ye.controllers[y.getAttribute("id")]=M}function se(y){const M={sources:{}};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"bind_shape_matrix":M.bindShapeMatrix=r(P.textContent);break;case"source":const le=P.getAttribute("id");M.sources[le]=we(P);break;case"joints":M.joints=q(P);break;case"vertex_weights":M.vertexWeights=te(P);break}}return M}function q(y){const M={inputs:{}};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1&&P.nodeName==="input"){const le=P.getAttribute("semantic"),de=a(P.getAttribute("source"));M.inputs[le]=de}}return M}function te(y){const M={inputs:{}};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"input":const le=P.getAttribute("semantic"),de=a(P.getAttribute("source")),je=parseInt(P.getAttribute("offset"));M.inputs[le]={id:de,offset:je};break;case"vcount":M.vcount=o(P.textContent);break;case"v":M.v=o(P.textContent);break}}return M}function pe(y){const M={id:y.id},C=Ye.geometries[M.id];return y.skin!==void 0&&(M.skin=_e(y.skin),C.sources.skinIndices=M.skin.indices,C.sources.skinWeights=M.skin.weights),M}function _e(y){const C={joints:[],indices:{array:[],stride:4},weights:{array:[],stride:4}},S=y.sources,P=y.vertexWeights,le=P.vcount,de=P.v,je=P.inputs.JOINT.offset,De=P.inputs.WEIGHT.offset,He=y.sources[y.joints.inputs.JOINT],et=y.sources[y.joints.inputs.INV_BIND_MATRIX],Ee=S[P.inputs.WEIGHT.id].array;let Qe=0,$e,st,tt;for($e=0,tt=le.length;$e<tt;$e++){const Nt=le[$e],Et=[];for(st=0;st<Nt;st++){const Tt=de[Qe+je],_i=de[Qe+De],En=Ee[_i];Et.push({index:Tt,weight:En}),Qe+=2}for(Et.sort(Gt),st=0;st<4;st++){const Tt=Et[st];Tt!==void 0?(C.indices.array.push(Tt.index),C.weights.array.push(Tt.weight)):(C.indices.array.push(0),C.weights.array.push(0))}}for(y.bindShapeMatrix?C.bindMatrix=new ct().fromArray(y.bindShapeMatrix).transpose():C.bindMatrix=new ct().identity(),$e=0,tt=He.array.length;$e<tt;$e++){const Nt=He.array[$e],Et=new ct().fromArray(et.array,$e*et.stride).transpose();C.joints.push({name:Nt,boneInverse:Et})}return C;function Gt(Nt,Et){return Et.weight-Nt.weight}}function Me(y){return x(Ye.controllers[y],pe)}function X(y){const M={init_from:i(y,"init_from")[0].textContent};Ye.images[y.getAttribute("id")]=M}function $(y){return y.build!==void 0?y.build:y.init_from}function ye(y){const M=Ye.images[y];return M!==void 0?x(M,$):(console.warn("THREE.ColladaLoader: Couldn't find image with ID:",y),null)}function Je(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="profile_COMMON"&&(M.profile=Ie(P))}Ye.effects[y.getAttribute("id")]=M}function Ie(y){const M={surfaces:{},samplers:{}};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"newparam":Mt(P,M);break;case"technique":M.technique=Q(P);break;case"extra":M.extra=me(P);break}}return M}function Mt(y,M){const C=y.getAttribute("sid");for(let S=0,P=y.childNodes.length;S<P;S++){const le=y.childNodes[S];if(le.nodeType===1)switch(le.nodeName){case"surface":M.surfaces[C]=O(le);break;case"sampler2D":M.samplers[C]=V(le);break}}}function O(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="init_from"&&(M.init_from=P.textContent)}return M}function V(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="source"&&(M.source=P.textContent)}return M}function Q(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"constant":case"lambert":case"blinn":case"phong":M.type=P.nodeName,M.parameters=he(P);break;case"extra":M.extra=me(P);break}}return M}function he(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"emission":case"diffuse":case"specular":case"bump":case"ambient":case"shininess":case"transparency":M[P.nodeName]=ae(P);break;case"transparent":M[P.nodeName]={opaque:P.hasAttribute("opaque")?P.getAttribute("opaque"):"A_ONE",data:ae(P)};break}}return M}function ae(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"color":M[P.nodeName]=r(P.textContent);break;case"float":M[P.nodeName]=parseFloat(P.textContent);break;case"texture":M[P.nodeName]={id:P.getAttribute("texture"),extra:fe(P)};break}}return M}function fe(y){const M={technique:{}};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="extra"&&I(P,M)}return M}function I(y,M){for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="technique"&&be(P,M)}}function be(y,M){for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"repeatU":case"repeatV":case"offsetU":case"offsetV":M.technique[P.nodeName]=parseFloat(P.textContent);break;case"wrapU":case"wrapV":P.textContent.toUpperCase()==="TRUE"?M.technique[P.nodeName]=1:P.textContent.toUpperCase()==="FALSE"?M.technique[P.nodeName]=0:M.technique[P.nodeName]=parseInt(P.textContent);break;case"bump":M[P.nodeName]=ge(P);break}}}function me(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="technique"&&(M.technique=ue(P))}return M}function ue(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"double_sided":M[P.nodeName]=parseInt(P.textContent);break;case"bump":M[P.nodeName]=ge(P);break}}return M}function ge(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="texture"&&(M[P.nodeName]={id:P.getAttribute("texture"),texcoord:P.getAttribute("texcoord"),extra:fe(P)})}return M}function T(y){return y}function g(y){return x(Ye.effects[y],T)}function B(y){const M={name:y.getAttribute("name")};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="instance_effect"&&(M.url=a(P.getAttribute("url")))}Ye.materials[y.getAttribute("id")]=M}function ee(y){let M,C=y.slice((y.lastIndexOf(".")-1>>>0)+2);return C=C.toLowerCase(),C==="tga"?M=tn:M=gi,M}function ce(y){const M=g(y.url),C=M.profile.technique;let S;switch(C.type){case"phong":case"blinn":S=new qr;break;case"lambert":S=new ox;break;default:S=new io;break}S.name=y.name||"";function P(De,He=null){const et=M.profile.samplers[De.id];let Ee=null;if(et!==void 0){const Qe=M.profile.surfaces[et.source];Ee=ye(Qe.init_from)}else console.warn("THREE.ColladaLoader: Undefined sampler. Access image directly (see #12530)."),Ee=ye(De.id);if(Ee!==null){const Qe=ee(Ee);if(Qe!==void 0){const $e=Qe.load(Ee),st=De.extra;if(st!==void 0&&st.technique!==void 0&&c(st.technique)===!1){const tt=st.technique;$e.wrapS=tt.wrapU?_s:Bn,$e.wrapT=tt.wrapV?_s:Bn,$e.offset.set(tt.offsetU||0,tt.offsetV||0),$e.repeat.set(tt.repeatU||1,tt.repeatV||1)}else $e.wrapS=_s,$e.wrapT=_s;return He!==null&&($e.colorSpace=He),$e}else return console.warn("THREE.ColladaLoader: Loader for texture %s not found.",Ee),null}else return console.warn("THREE.ColladaLoader: Couldn't create texture with ID:",De.id),null}const le=C.parameters;for(const De in le){const He=le[De];switch(De){case"diffuse":He.color&&S.color.fromArray(He.color),He.texture&&(S.map=P(He.texture,Wt));break;case"specular":He.color&&S.specular&&S.specular.fromArray(He.color),He.texture&&(S.specularMap=P(He.texture));break;case"bump":He.texture&&(S.normalMap=P(He.texture));break;case"ambient":He.texture&&(S.lightMap=P(He.texture,Wt));break;case"shininess":He.float&&S.shininess&&(S.shininess=He.float);break;case"emission":He.color&&S.emissive&&S.emissive.fromArray(He.color),He.texture&&(S.emissiveMap=P(He.texture,Wt));break}}vt.colorSpaceToWorking(S.color,Wt),S.specular&&vt.colorSpaceToWorking(S.specular,Wt),S.emissive&&vt.colorSpaceToWorking(S.emissive,Wt);let de=le.transparent,je=le.transparency;if(je===void 0&&de&&(je={float:1}),de===void 0&&je&&(de={opaque:"A_ONE",data:{color:[1,1,1,1]}}),de&&je)if(de.data.texture)S.transparent=!0;else{const De=de.data.color;switch(de.opaque){case"A_ONE":S.opacity=De[3]*je.float;break;case"RGB_ZERO":S.opacity=1-De[0]*je.float;break;case"A_ZERO":S.opacity=1-De[3]*je.float;break;case"RGB_ONE":S.opacity=De[0]*je.float;break;default:console.warn('THREE.ColladaLoader: Invalid opaque type "%s" of transparent tag.',de.opaque)}S.opacity<1&&(S.transparent=!0)}if(C.extra!==void 0&&C.extra.technique!==void 0){const De=C.extra.technique;for(const He in De){const et=De[He];switch(He){case"double_sided":S.side=et===1?oi:Fi;break;case"bump":S.normalMap=P(et.texture),S.normalScale=new at(1,1);break}}}return S}function Z(y){return x(Ye.materials[y],ce)}function Fe(y){const M={name:y.getAttribute("name")};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="optics"&&(M.optics=Te(P))}Ye.cameras[y.getAttribute("id")]=M}function Te(y){for(let M=0;M<y.childNodes.length;M++){const C=y.childNodes[M];if(C.nodeName==="technique_common")return ke(C)}return{}}function ke(y){const M={};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];switch(S.nodeName){case"perspective":case"orthographic":M.technique=S.nodeName,M.parameters=Ke(S);break}}return M}function Ke(y){const M={};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];switch(S.nodeName){case"xfov":case"yfov":case"xmag":case"ymag":case"znear":case"zfar":case"aspect_ratio":M[S.nodeName]=parseFloat(S.textContent);break}}return M}function Se(y){let M;switch(y.optics.technique){case"perspective":M=new fn(y.optics.parameters.yfov,y.optics.parameters.aspect_ratio,y.optics.parameters.znear,y.optics.parameters.zfar);break;case"orthographic":let C=y.optics.parameters.ymag,S=y.optics.parameters.xmag;const P=y.optics.parameters.aspect_ratio;S=S===void 0?C*P:S,C=C===void 0?S/P:C,S*=.5,C*=.5,M=new za(-S,S,C,-C,y.optics.parameters.znear,y.optics.parameters.zfar);break;default:M=new fn;break}return M.name=y.name||"",M}function Ce(y){const M=Ye.cameras[y];return M!==void 0?x(M,Se):(console.warn("THREE.ColladaLoader: Couldn't find camera with ID:",y),null)}function Le(y){let M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];P.nodeType===1&&P.nodeName==="technique_common"&&(M=Ve(P))}Ye.lights[y.getAttribute("id")]=M}function Ve(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"directional":case"point":case"spot":case"ambient":M.technique=P.nodeName,M.parameters=Re(P)}}return M}function Re(y){const M={};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"color":const le=r(P.textContent);M.color=new ft().fromArray(le),vt.colorSpaceToWorking(M.color,Wt);break;case"falloff_angle":M.falloffAngle=parseFloat(P.textContent);break;case"quadratic_attenuation":const de=parseFloat(P.textContent);M.distance=de?Math.sqrt(1/de):0;break}}return M}function lt(y){let M;switch(y.technique){case"directional":M=new Rp;break;case"point":M=new bx;break;case"spot":M=new Mx;break;case"ambient":M=new Cp;break}return y.parameters.color&&M.color.copy(y.parameters.color),y.parameters.distance&&(M.distance=y.parameters.distance),M}function W(y){const M=Ye.lights[y];return M!==void 0?x(M,lt):(console.warn("THREE.ColladaLoader: Couldn't find light with ID:",y),null)}function Be(y){const M={name:y.getAttribute("name"),sources:{},vertices:{},primitives:[]},C=i(y,"mesh")[0];if(C!==void 0){for(let S=0;S<C.childNodes.length;S++){const P=C.childNodes[S];if(P.nodeType!==1)continue;const le=P.getAttribute("id");switch(P.nodeName){case"source":M.sources[le]=we(P);break;case"vertices":M.vertices=Ge(P);break;case"polygons":console.warn("THREE.ColladaLoader: Unsupported primitive type: ",P.nodeName);break;case"lines":case"linestrips":case"polylist":case"triangles":M.primitives.push(Ae(P));break;default:console.log(P)}}Ye.geometries[y.getAttribute("id")]=M}}function we(y){const M={array:[],stride:3};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"float_array":M.array=r(S.textContent);break;case"Name_array":M.array=s(S.textContent);break;case"technique_common":const P=i(S,"accessor")[0];P!==void 0&&(M.stride=parseInt(P.getAttribute("stride")));break}}return M}function Ge(y){const M={};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];S.nodeType===1&&(M[S.getAttribute("semantic")]=a(S.getAttribute("source")))}return M}function Ae(y){const M={type:y.nodeName,material:y.getAttribute("material"),count:parseInt(y.getAttribute("count")),inputs:{},stride:0,hasUV:!1};for(let C=0,S=y.childNodes.length;C<S;C++){const P=y.childNodes[C];if(P.nodeType===1)switch(P.nodeName){case"input":const le=a(P.getAttribute("source")),de=P.getAttribute("semantic"),je=parseInt(P.getAttribute("offset")),De=parseInt(P.getAttribute("set")),He=De>0?de+De:de;M.inputs[He]={id:le,offset:je},M.stride=Math.max(M.stride,je+1),de==="TEXCOORD"&&(M.hasUV=!0);break;case"vcount":M.vcount=o(P.textContent);break;case"p":M.p=o(P.textContent);break}}return M}function xe(y){const M={};for(let C=0;C<y.length;C++){const S=y[C];M[S.type]===void 0&&(M[S.type]=[]),M[S.type].push(S)}return M}function Pe(y){let M=0;for(let C=0,S=y.length;C<S;C++)y[C].hasUV===!0&&M++;M>0&&M<y.length&&(y.uvsNeedsFix=!0)}function ot(y){const M={},C=y.sources,S=y.vertices,P=y.primitives;if(P.length===0)return{};const le=xe(P);for(const de in le){const je=le[de];Pe(je),M[de]=Ut(je,C,S)}return M}function Ut(y,M,C){const S={},P={array:[],stride:0},le={array:[],stride:0},de={array:[],stride:0},je={array:[],stride:0},De={array:[],stride:0},He={array:[],stride:4},et={array:[],stride:4},Ee=new en,Qe=[];let $e=0;for(let st=0;st<y.length;st++){const tt=y[st],Gt=tt.inputs;let Nt=0;switch(tt.type){case"lines":case"linestrips":Nt=tt.count*2;break;case"triangles":Nt=tt.count*3;break;case"polylist":for(let Et=0;Et<tt.count;Et++){const Tt=tt.vcount[Et];switch(Tt){case 3:Nt+=3;break;case 4:Nt+=6;break;default:Nt+=(Tt-2)*3;break}}break;default:console.warn("THREE.ColladaLoader: Unknown primitive type:",tt.type)}Ee.addGroup($e,Nt,st),$e+=Nt,tt.material&&Qe.push(tt.material);for(const Et in Gt){const Tt=Gt[Et];switch(Et){case"VERTEX":for(const _i in C){const En=C[_i];switch(_i){case"POSITION":const ws=P.array.length;if(dt(tt,M[En],Tt.offset,P.array),P.stride=M[En].stride,M.skinWeights&&M.skinIndices&&(dt(tt,M.skinIndices,Tt.offset,He.array),dt(tt,M.skinWeights,Tt.offset,et.array)),tt.hasUV===!1&&y.uvsNeedsFix===!0){const kp=(P.array.length-ws)/P.stride;for(let Ou=0;Ou<kp;Ou++)de.array.push(0,0)}break;case"NORMAL":dt(tt,M[En],Tt.offset,le.array),le.stride=M[En].stride;break;case"COLOR":dt(tt,M[En],Tt.offset,De.array),De.stride=M[En].stride;break;case"TEXCOORD":dt(tt,M[En],Tt.offset,de.array),de.stride=M[En].stride;break;case"TEXCOORD1":dt(tt,M[En],Tt.offset,je.array),de.stride=M[En].stride;break;default:console.warn('THREE.ColladaLoader: Semantic "%s" not handled in geometry build process.',_i)}}break;case"NORMAL":dt(tt,M[Tt.id],Tt.offset,le.array),le.stride=M[Tt.id].stride;break;case"COLOR":dt(tt,M[Tt.id],Tt.offset,De.array,!0),De.stride=M[Tt.id].stride;break;case"TEXCOORD":dt(tt,M[Tt.id],Tt.offset,de.array),de.stride=M[Tt.id].stride;break;case"TEXCOORD1":dt(tt,M[Tt.id],Tt.offset,je.array),je.stride=M[Tt.id].stride;break}}}return P.array.length>0&&Ee.setAttribute("position",new wt(P.array,P.stride)),le.array.length>0&&Ee.setAttribute("normal",new wt(le.array,le.stride)),De.array.length>0&&Ee.setAttribute("color",new wt(De.array,De.stride)),de.array.length>0&&Ee.setAttribute("uv",new wt(de.array,de.stride)),je.array.length>0&&Ee.setAttribute("uv1",new wt(je.array,je.stride)),He.array.length>0&&Ee.setAttribute("skinIndex",new wt(He.array,He.stride)),et.array.length>0&&Ee.setAttribute("skinWeight",new wt(et.array,et.stride)),S.data=Ee,S.type=y[0].type,S.materialKeys=Qe,S}function dt(y,M,C,S,P=!1){const le=y.p,de=y.stride,je=y.vcount;function De(Ee){let Qe=le[Ee+C]*et;const $e=Qe+et;for(;Qe<$e;Qe++)S.push(He[Qe]);if(P){const st=S.length-et-1;ei.setRGB(S[st+0],S[st+1],S[st+2],Wt),S[st+0]=ei.r,S[st+1]=ei.g,S[st+2]=ei.b}}const He=M.array,et=M.stride;if(y.vcount!==void 0){let Ee=0;for(let Qe=0,$e=je.length;Qe<$e;Qe++){const st=je[Qe];if(st===4){const tt=Ee+de*0,Gt=Ee+de*1,Nt=Ee+de*2,Et=Ee+de*3;De(tt),De(Gt),De(Et),De(Gt),De(Nt),De(Et)}else if(st===3){const tt=Ee+de*0,Gt=Ee+de*1,Nt=Ee+de*2;De(tt),De(Gt),De(Nt)}else if(st>4)for(let tt=1,Gt=st-2;tt<=Gt;tt++){const Nt=Ee+de*0,Et=Ee+de*tt,Tt=Ee+de*(tt+1);De(Nt),De(Et),De(Tt)}Ee+=de*st}}else for(let Ee=0,Qe=le.length;Ee<Qe;Ee+=de)De(Ee)}function Pn(y){return x(Ye.geometries[y],ot)}function qn(y){const M={name:y.getAttribute("name")||"",joints:{},links:[]};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];S.nodeType===1&&S.nodeName==="technique_common"&&Sr(S,M)}Ye.kinematicsModels[y.getAttribute("id")]=M}function Xa(y){return y.build!==void 0?y.build:y}function uo(y){return x(Ye.kinematicsModels[y],Xa)}function Sr(y,M){for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"joint":M.joints[S.getAttribute("sid")]=qa(S);break;case"link":M.links.push(Er(S));break}}}function qa(y){let M;for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"prismatic":case"revolute":M=ho(S);break}}return M}function ho(y){const M={sid:y.getAttribute("sid"),name:y.getAttribute("name")||"",axis:new j,limits:{min:0,max:0},type:y.nodeName,static:!1,zeroPosition:0,middlePosition:0};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"axis":const P=r(S.textContent);M.axis.fromArray(P);break;case"limits":const le=S.getElementsByTagName("max")[0],de=S.getElementsByTagName("min")[0];M.limits.max=parseFloat(le.textContent),M.limits.min=parseFloat(de.textContent);break}}return M.limits.min>=M.limits.max&&(M.static=!0),M.middlePosition=(M.limits.min+M.limits.max)/2,M}function Er(y){const M={sid:y.getAttribute("sid"),name:y.getAttribute("name")||"",attachments:[],transforms:[]};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"attachment_full":M.attachments.push(mi(S));break;case"matrix":case"translate":case"rotate":M.transforms.push(Es(S));break}}return M}function mi(y){const M={joint:y.getAttribute("joint").split("/").pop(),transforms:[],links:[]};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"link":M.links.push(Er(S));break;case"matrix":case"translate":case"rotate":M.transforms.push(Es(S));break}}return M}function Es(y){const M={type:y.nodeName},C=r(y.textContent);switch(M.type){case"matrix":M.obj=new ct,M.obj.fromArray(C).transpose();break;case"translate":M.obj=new j,M.obj.fromArray(C);break;case"rotate":M.obj=new j,M.obj.fromArray(C),M.angle=Ys.degToRad(C[3]);break}return M}function fo(y){const M={name:y.getAttribute("name")||"",rigidBodies:{}};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];S.nodeType===1&&S.nodeName==="rigid_body"&&(M.rigidBodies[S.getAttribute("name")]={},po(S,M.rigidBodies[S.getAttribute("name")]))}Ye.physicsModels[y.getAttribute("id")]=M}function po(y,M){for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];S.nodeType===1&&S.nodeName==="technique_common"&&Ts(S,M)}}function Ts(y,M){for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1)switch(S.nodeName){case"inertia":M.inertia=r(S.textContent);break;case"mass":M.mass=r(S.textContent)[0];break}}}function mo(y){const M={bindJointAxis:[]};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];S.nodeType===1&&S.nodeName==="bind_joint_axis"&&M.bindJointAxis.push(As(S))}Ye.kinematicsScenes[a(y.getAttribute("url"))]=M}function As(y){const M={target:y.getAttribute("target").split("/").pop()};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType===1&&S.nodeName==="axis"){const P=S.getElementsByTagName("param")[0];M.axis=P.textContent;const le=M.axis.split("inst_").pop().split("axis")[0];M.jointIndex=le.substring(0,le.length-1)}}return M}function go(y){return y.build!==void 0?y.build:y}function _o(y){return x(Ye.kinematicsScenes[y],go)}function ja(){const y=Object.keys(Ye.kinematicsModels)[0],M=Object.keys(Ye.kinematicsScenes)[0],C=Object.keys(Ye.visualScenes)[0];if(y===void 0||M===void 0)return;const S=uo(y),P=_o(M),le=pt(C),de=P.bindJointAxis,je={};for(let et=0,Ee=de.length;et<Ee;et++){const Qe=de[et],$e=ze.querySelector('[sid="'+Qe.target+'"]');if($e){const st=$e.parentElement;De(Qe.jointIndex,st)}}function De(et,Ee){const Qe=Ee.getAttribute("name"),$e=S.joints[et];le.traverse(function(st){st.name===Qe&&(je[et]={object:st,transforms:Ya(Ee),joint:$e,position:$e.zeroPosition})})}const He=new ct;nn={joints:S&&S.joints,getJointValue:function(et){const Ee=je[et];if(Ee)return Ee.position;console.warn("THREE.ColladaLoader: Joint "+et+" doesn't exist.")},setJointValue:function(et,Ee){const Qe=je[et];if(Qe){const $e=Qe.joint;if(Ee>$e.limits.max||Ee<$e.limits.min)console.warn("THREE.ColladaLoader: Joint "+et+" value "+Ee+" outside of limits (min: "+$e.limits.min+", max: "+$e.limits.max+").");else if($e.static)console.warn("THREE.ColladaLoader: Joint "+et+" is static.");else{const st=Qe.object,tt=$e.axis,Gt=Qe.transforms;xn.identity();for(let Nt=0;Nt<Gt.length;Nt++){const Et=Gt[Nt];if(Et.sid&&Et.sid.indexOf(et)!==-1)switch($e.type){case"revolute":xn.multiply(He.makeRotationAxis(tt,Ys.degToRad(Ee)));break;case"prismatic":xn.multiply(He.makeTranslation(tt.x*Ee,tt.y*Ee,tt.z*Ee));break;default:console.warn("THREE.ColladaLoader: Unknown joint type: "+$e.type);break}else switch(Et.type){case"matrix":xn.multiply(Et.obj);break;case"translate":xn.multiply(He.makeTranslation(Et.obj.x,Et.obj.y,Et.obj.z));break;case"scale":xn.scale(Et.obj);break;case"rotate":xn.multiply(He.makeRotationAxis(Et.obj,Et.angle));break}}st.matrix.copy(xn),st.matrix.decompose(st.position,st.quaternion,st.scale),je[et].position=Ee}}else console.log("THREE.ColladaLoader: "+et+" does not exist.")}}}function Ya(y){const M=[],C=ze.querySelector('[id="'+y.id+'"]');for(let S=0;S<C.childNodes.length;S++){const P=C.childNodes[S];if(P.nodeType!==1)continue;let le,de;switch(P.nodeName){case"matrix":le=r(P.textContent);const je=new ct().fromArray(le).transpose();M.push({sid:P.getAttribute("sid"),type:P.nodeName,obj:je});break;case"translate":case"scale":le=r(P.textContent),de=new j().fromArray(le),M.push({sid:P.getAttribute("sid"),type:P.nodeName,obj:de});break;case"rotate":le=r(P.textContent),de=new j().fromArray(le);const De=Ys.degToRad(le[3]);M.push({sid:P.getAttribute("sid"),type:P.nodeName,obj:de,angle:De});break}}return M}function $a(y){const M=y.getElementsByTagName("node");for(let C=0;C<M.length;C++){const S=M[C];S.hasAttribute("id")===!1&&S.setAttribute("id",l())}}const xn=new ct,Vi=new j;function Tr(y){const M={name:y.getAttribute("name")||"",type:y.getAttribute("type"),id:y.getAttribute("id"),sid:y.getAttribute("sid"),matrix:new ct,nodes:[],instanceCameras:[],instanceControllers:[],instanceLights:[],instanceGeometries:[],instanceNodes:[],transforms:{}};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];if(S.nodeType!==1)continue;let P;switch(S.nodeName){case"node":M.nodes.push(S.getAttribute("id")),Tr(S);break;case"instance_camera":M.instanceCameras.push(a(S.getAttribute("url")));break;case"instance_controller":M.instanceControllers.push(w(S));break;case"instance_light":M.instanceLights.push(a(S.getAttribute("url")));break;case"instance_geometry":M.instanceGeometries.push(w(S));break;case"instance_node":M.instanceNodes.push(a(S.getAttribute("url")));break;case"matrix":P=r(S.textContent),M.matrix.multiply(xn.fromArray(P).transpose()),M.transforms[S.getAttribute("sid")]=S.nodeName;break;case"translate":P=r(S.textContent),Vi.fromArray(P),M.matrix.multiply(xn.makeTranslation(Vi.x,Vi.y,Vi.z)),M.transforms[S.getAttribute("sid")]=S.nodeName;break;case"rotate":P=r(S.textContent);const le=Ys.degToRad(P[3]);M.matrix.multiply(xn.makeRotationAxis(Vi.fromArray(P),le)),M.transforms[S.getAttribute("sid")]=S.nodeName;break;case"scale":P=r(S.textContent),M.matrix.scale(Vi.fromArray(P)),M.transforms[S.getAttribute("sid")]=S.nodeName;break;case"extra":break;default:console.log(S)}}return Ue(M.id)?console.warn("THREE.ColladaLoader: There is already a node with ID %s. Exclude current node from further processing.",M.id):Ye.nodes[M.id]=M,M}function w(y){const M={id:a(y.getAttribute("url")),materials:{},skeletons:[]};for(let C=0;C<y.childNodes.length;C++){const S=y.childNodes[C];switch(S.nodeName){case"bind_material":const P=S.getElementsByTagName("instance_material");for(let le=0;le<P.length;le++){const de=P[le],je=de.getAttribute("symbol"),De=de.getAttribute("target");M.materials[je]=a(De)}break;case"skeleton":M.skeletons.push(a(S.textContent));break}}return M}function Y(y,M){const C=[],S=[];let P,le,de;for(P=0;P<y.length;P++){const He=y[P];let et;if(Ue(He))et=We(He),oe(et,M,C);else if(nt(He)){const Qe=Ye.visualScenes[He].children;for(let $e=0;$e<Qe.length;$e++){const st=Qe[$e];if(st.type==="JOINT"){const tt=We(st.id);oe(tt,M,C)}}}else console.error("THREE.ColladaLoader: Unable to find root bone of skeleton with ID:",He)}for(P=0;P<M.length;P++)for(le=0;le<C.length;le++)if(de=C[le],de.bone.name===M[P].name){S[P]=de,de.processed=!0;break}for(P=0;P<C.length;P++)de=C[P],de.processed===!1&&(S.push(de),de.processed=!0);const je=[],De=[];for(P=0;P<S.length;P++)de=S[P],je.push(de.bone),De.push(de.boneInverse);return new Pu(je,De)}function oe(y,M,C){y.traverse(function(S){if(S.isBone===!0){let P;for(let le=0;le<M.length;le++){const de=M[le];if(de.name===S.name){P=de.boneInverse;break}}P===void 0&&(P=new ct),C.push({bone:S,boneInverse:P,processed:!1})}})}function re(y){const M=[],C=y.matrix,S=y.nodes,P=y.type,le=y.instanceCameras,de=y.instanceControllers,je=y.instanceLights,De=y.instanceGeometries,He=y.instanceNodes;for(let Ee=0,Qe=S.length;Ee<Qe;Ee++)M.push(We(S[Ee]));for(let Ee=0,Qe=le.length;Ee<Qe;Ee++){const $e=Ce(le[Ee]);$e!==null&&M.push($e.clone())}for(let Ee=0,Qe=de.length;Ee<Qe;Ee++){const $e=de[Ee],st=Me($e.id),tt=Pn(st.id),Gt=qe(tt,$e.materials),Nt=$e.skeletons,Et=st.skin.joints,Tt=Y(Nt,Et);for(let _i=0,En=Gt.length;_i<En;_i++){const ws=Gt[_i];ws.isSkinnedMesh&&(ws.bind(Tt,st.skin.bindMatrix),ws.normalizeSkinWeights()),M.push(ws)}}for(let Ee=0,Qe=je.length;Ee<Qe;Ee++){const $e=W(je[Ee]);$e!==null&&M.push($e.clone())}for(let Ee=0,Qe=De.length;Ee<Qe;Ee++){const $e=De[Ee],st=Pn($e.id),tt=qe(st,$e.materials);for(let Gt=0,Nt=tt.length;Gt<Nt;Gt++)M.push(tt[Gt])}for(let Ee=0,Qe=He.length;Ee<Qe;Ee++)M.push(We(He[Ee]).clone());let et;if(S.length===0&&M.length===1)et=M[0];else{et=P==="JOINT"?new Mp:new Ks;for(let Ee=0;Ee<M.length;Ee++)et.add(M[Ee])}return et.name=P==="JOINT"?y.sid:y.name,et.matrix.copy(C),et.matrix.decompose(et.position,et.quaternion,et.scale),et}const J=new io({name:ns.DEFAULT_MATERIAL_NAME,color:16711935});function Ne(y,M){const C=[];for(let S=0,P=y.length;S<P;S++){const le=M[y[S]];le===void 0?(console.warn("THREE.ColladaLoader: Material with key %s not found. Apply fallback material.",y[S]),C.push(J)):C.push(Z(le))}return C}function qe(y,M){const C=[];for(const S in y){const P=y[S],le=Ne(P.materialKeys,M);if(le.length===0&&(S==="lines"||S==="linestrips"?le.push(new dr):le.push(new qr)),S==="lines"||S==="linestrips")for(let He=0,et=le.length;He<et;He++){const Ee=le[He];if(Ee.isMeshPhongMaterial===!0||Ee.isMeshLambertMaterial===!0){const Qe=new dr;Qe.color.copy(Ee.color),Qe.opacity=Ee.opacity,Qe.transparent=Ee.transparent,le[He]=Qe}}const de=P.data.attributes.skinIndex!==void 0,je=le.length===1?le[0]:le;let De;switch(S){case"lines":De=new Oa(P.data,je);break;case"linestrips":De=new yp(P.data,je);break;case"triangles":case"polylist":de?De=new Z0(P.data,je):De=new pn(P.data,je);break}C.push(De)}return C}function Ue(y){return Ye.nodes[y]!==void 0}function We(y){return x(Ye.nodes[y],re)}function Ze(y){const M={name:y.getAttribute("name"),children:[]};$a(y);const C=i(y,"node");for(let S=0;S<C.length;S++)M.children.push(Tr(C[S]));Ye.visualScenes[y.getAttribute("id")]=M}function rt(y){const M=new Ks;M.name=y.name;const C=y.children;for(let S=0;S<C.length;S++){const P=C[S];M.add(We(P.id))}return M}function nt(y){return Ye.visualScenes[y]!==void 0}function pt(y){return x(Ye.visualScenes[y],rt)}function Rt(y){const M=i(y,"instance_visual_scene")[0];return pt(a(M.getAttribute("url")))}function Vt(){const y=Ye.clips;if(c(y)===!0){if(c(Ye.animations)===!1){const M=[];for(const C in Ye.animations){const S=E(C);for(let P=0,le=S.length;P<le;P++)M.push(S[P])}At.push(new af("default",-1,M))}}else for(const M in y)At.push(K(M))}function zt(y){let M="";const C=[y];for(;C.length;){const S=C.shift();S.nodeType===Node.TEXT_NODE?M+=S.textContent:(M+=`
...
`,M),null}const yt=ze.getAttribute("version");console.debug("THREE.ColladaLoader: File version",yt);const on=u(i(ze,"asset")[0]),gi=new wp(this.manager);gi.setPath(this.resourcePath||t).setCrossOrigin(this.crossOrigin);let tn;kf&&(tn=new kf(this.manager),tn.setPath(this.resourcePath||t));const ei=new ft,At=[];let nn={},Sn=0;const Ye={animations:{},clips:{},controllers:{},images:{},effects:{},materials:{},cameras:{},lights:{},geometries:{},nodes:{},visualScenes:{},kinematicsModels:{},physicsModels:{},kinematicsScenes:{}};d(ze,"library_animations","animation",m),d(ze,"library_animation_clips","animation_clip",k),d(ze,"library_controllers","controller",ve),d(ze,"library_images","image",X),d(ze,"library_effects","effect",Je),d(ze,"library_materials","material",B),d(ze,"library_cameras","camera",Fe),d(ze,"library_lights","light",Le),d(ze,"library_geometries","geometry",Be),d(ze,"library_nodes","node",Tr),d(ze,"library_visual_scenes","visual_scene",Ze),d(ze,"library_kinematics_models","kinematics_model",qn),d(ze,"library_physics_models","physics_model",fo),d(ze,"scene","instance_kinematics_scene",mo),_(Ye.animations,D),_(Ye.clips,G),_(Ye.controllers,pe),_(Ye.images,$),_(Ye.effects,T),_(Ye.materials,ce),_(Ye.cameras,Se),_(Ye.lights,lt),_(Ye.geometries,ot),_(Ye.visualScenes,rt),Vt(),ja();const Yt=Rt(i(ze,"scene")[0]);return Yt.animations=At,on.upAxis==="Z_UP"&&(console.warn("THREE.ColladaLoader: You are loading an asset with a Z-UP coordinate system. The loader just rotates the asset to transform it into Y-UP. The vertex data are not converted, see #24289."),Yt.rotation.set(-Math.PI/2,0,0)),Yt.scale.multiplyScalar(on.unit),{get animations(){return console.warn("THREE.ColladaLoader: Please access animations over scene.animations now."),At},kinematics:nn,library:Ye,scene:Yt}}}const Vf=new j,zS=new Cn,$o=new ct,ji=new ct,Ko=new Xn,Jo=new j(1,1,1),Zo=new j;class Wa extends Xt{constructor(...e){super(...e),this.urdfNode=null,this.urdfName=""}copy(e,t){return super.copy(e,t),this.urdfNode=e.urdfNode,this.urdfName=e.urdfName,this}}class HS extends Wa{constructor(...e){super(...e),this.isURDFCollider=!0,this.type="URDFCollider"}}class GS extends Wa{constructor(...e){super(...e),this.isURDFVisual=!0,this.type="URDFVisual"}}class Op extends Wa{constructor(...e){super(...e),this.isURDFLink=!0,this.type="URDFLink"}}class Bp extends Wa{get jointType(){return this._jointType}set jointType(e){if(this.jointType!==e)switch(this._jointType=e,this.matrixWorldNeedsUpdate=!0,e){case"fixed":this.jointValue=[];break;case"continuous":case"revolute":case"prismatic":this.jointValue=new Array(1).fill(0);break;case"planar":this.jointValue=new Array(3).fill(0),this.axis=new j(0,0,1);break;case"floating":this.jointValue=new Array(6).fill(0);break}}get angle(){return this.jointValue[0]}constructor(...e){super(...e),this.isURDFJoint=!0,this.type="URDFJoint",this.jointValue=null,this.jointType="fixed",this.axis=new j(1,0,0),this.limit={lower:0,upper:0},this.ignoreLimits=!1,this.origPosition=null,this.origQuaternion=null,this.mimicJoints=[]}copy(e,t){return super.copy(e,t),this.jointType=e.jointType,this.axis=e.axis.clone(),this.limit.lower=e.limit.lower,this.limit.upper=e.limit.upper,this.ignoreLimits=!1,this.jointValue=[...e.jointValue],this.origPosition=e.origPosition?e.origPosition.clone():null,this.origQuaternion=e.origQuaternion?e.origQuaternion.clone():null,this.mimicJoints=[...e.mimicJoints],this}setJointValue(...e){e=e.map(i=>i===null?null:parseFloat(i)),(!this.origPosition||!this.origQuaternion)&&(this.origPosition=this.position.clone(),this.origQuaternion=this.quaternion.clone());let t=!1;switch(this.mimicJoints.forEach(i=>{t=i.updateFromMimickedJoint(...e)||t}),this.jointType){case"fixed":return t;case"continuous":case"revolute":{let i=e[0];return i==null||i===this.jointValue[0]?t:(!this.ignoreLimits&&this.jointType==="revolute"&&(i=Math.min(this.limit.upper,i),i=Math.max(this.limit.lower,i)),this.quaternion.setFromAxisAngle(this.axis,i).premultiply(this.origQuaternion),this.jointValue[0]!==i?(this.jointValue[0]=i,this.matrixWorldNeedsUpdate=!0,!0):t)}case"prismatic":{let i=e[0];return i==null||i===this.jointValue[0]?t:(this.ignoreLimits||(i=Math.min(this.limit.upper,i),i=Math.max(this.limit.lower,i)),this.position.copy(this.origPosition),Vf.copy(this.axis).applyEuler(this.rotation),this.position.addScaledVector(Vf,i),this.jointValue[0]!==i?(this.jointValue[0]=i,this.matrixWorldNeedsUpdate=!0,!0):t)}case"floating":return this.jointValue.every((i,s)=>e[s]===i||e[s]===null)?t:(this.jointValue[0]=e[0]!==null?e[0]:this.jointValue[0],this.jointValue[1]=e[1]!==null?e[1]:this.jointValue[1],this.jointValue[2]=e[2]!==null?e[2]:this.jointValue[2],this.jointValue[3]=e[3]!==null?e[3]:this.jointValue[3],this.jointValue[4]=e[4]!==null?e[4]:this.jointValue[4],this.jointValue[5]=e[5]!==null?e[5]:this.jointValue[5],ji.compose(this.origPosition,this.origQuaternion,Jo),Ko.setFromEuler(zS.set(this.jointValue[3],this.jointValue[4],this.jointValue[5],"XYZ")),Zo.set(this.jointValue[0],this.jointValue[1],this.jointValue[2]),$o.compose(Zo,Ko,Jo),ji.premultiply($o),this.position.setFromMatrixPosition(ji),this.rotation.setFromRotationMatrix(ji),this.matrixWorldNeedsUpdate=!0,!0);case"planar":return this.jointValue.every((i,s)=>e[s]===i||e[s]===null)?t:(this.jointValue[0]=e[0]!==null?e[0]:this.jointValue[0],this.jointValue[1]=e[1]!==null?e[1]:this.jointValue[1],this.jointValue[2]=e[2]!==null?e[2]:this.jointValue[2],ji.compose(this.origPosition,this.origQuaternion,Jo),Ko.setFromAxisAngle(this.axis,this.jointValue[2]),Zo.set(this.jointValue[0],this.jointValue[1],0),$o.compose(Zo,Ko,Jo),ji.premultiply($o),this.position.setFromMatrixPosition(ji),this.rotation.setFromRotationMatrix(ji),this.matrixWorldNeedsUpdate=!0,!0)}return t}}class zf extends Bp{constructor(...e){super(...e),this.type="URDFMimicJoint",this.mimicJoint=null,this.offset=0,this.multiplier=1}updateFromMimickedJoint(...e){const t=e.map(i=>i*this.multiplier+this.offset);return super.setJointValue(...t)}copy(e,t){return super.copy(e,t),this.mimicJoint=e.mimicJoint,this.offset=e.offset,this.multiplier=e.multiplier,this}}class WS extends Op{constructor(...e){super(...e),this.isURDFRobot=!0,this.urdfNode=null,this.urdfRobotNode=null,this.robotName=null,this.links=null,this.joints=null,this.colliders=null,this.visual=null,this.frames=null}copy(e,t){super.copy(e,t),this.urdfRobotNode=e.urdfRobotNode,this.robotName=e.robotName,this.links={},this.joints={},this.colliders={},this.visual={},this.traverse(i=>{i.isURDFJoint&&i.urdfName in e.joints&&(this.joints[i.urdfName]=i),i.isURDFLink&&i.urdfName in e.links&&(this.links[i.urdfName]=i),i.isURDFCollider&&i.urdfName in e.colliders&&(this.colliders[i.urdfName]=i),i.isURDFVisual&&i.urdfName in e.visual&&(this.visual[i.urdfName]=i)});for(const i in this.joints)this.joints[i].mimicJoints=this.joints[i].mimicJoints.map(s=>this.joints[s.name]);return this.frames={...this.colliders,...this.visual,...this.links,...this.joints},this}getFrame(e){return this.frames[e]}setJointValue(e,...t){const i=this.joints[e];return i?i.setJointValue(...t):!1}setJointValues(e){let t=!1;for(const i in e){const s=e[i];Array.isArray(s)?t=this.setJointValue(i,...s)||t:t=this.setJointValue(i,s)||t}return t}}const Gl=new Xn,Hf=new Cn;function Ws(n){return n?n.trim().split(/\s+/g).map(e=>parseFloat(e)):[0,0,0]}function Gf(n,e,t=!1){t||n.rotation.set(0,0,0),Hf.set(e[0],e[1],e[2],"ZYX"),Gl.setFromEuler(Hf),Gl.multiply(n.quaternion),n.quaternion.copy(Gl)}class XS{constructor(e){this.manager=e||Ap,this.loadMeshCb=this.defaultMeshLoader.bind(this),this.parseVisual=!0,this.parseCollision=!1,this.packages="",this.workingPath="",this.fetchOptions={}}loadAsync(e){return new Promise((t,i)=>{this.load(e,t,null,i)})}load(e,t,i,s){const r=this.manager,o=Pp.extractUrlBase(e),a=this.manager.resolveURL(e);r.itemStart(a),fetch(a,this.fetchOptions).then(l=>{if(l.ok)return i&&i(null),l.text();throw new Error(`URDFLoader: Failed to load url '${a}' with error code ${l.status} : ${l.statusText}.`)}).then(l=>{const c=this.parse(l,this.workingPath||o);t(c),r.itemEnd(a)}).catch(l=>{s?s(l):console.error("URDFLoader: Error loading file.",l),r.itemError(a),r.itemEnd(a)})}parse(e,t=this.workingPath){const i=this.packages,s=this.loadMeshCb,r=this.parseVisual,o=this.parseCollision,a=this.manager,l={},c={},u={};function h(A){if(!/^package:\/\//.test(A))return t?t+A:A;const[D,E]=A.replace(/^package:\/\//,"").split(/\/(.+)/);if(typeof i=="string")return i.endsWith(D)?i+"/"+E:i+"/"+D+"/"+E;if(i instanceof Function)return i(D)+"/"+E;if(typeof i=="object")return D in i?i[D]+"/"+E:(console.error(`URDFLoader : ${D} not found in provided package list.`),null)}function f(A){let D;A instanceof Document?D=[...A.children]:A instanceof Element?D=[A]:D=[...new DOMParser().parseFromString(A,"text/xml").children];const E=D.filter(R=>R.nodeName==="robot").pop();return d(E)}function d(A){const D=[...A.children],E=D.filter(F=>F.nodeName.toLowerCase()==="link"),R=D.filter(F=>F.nodeName.toLowerCase()==="joint"),N=D.filter(F=>F.nodeName.toLowerCase()==="material"),L=new WS;L.robotName=A.getAttribute("name"),L.urdfRobotNode=A,N.forEach(F=>{const z=F.getAttribute("name");u[z]=m(F)});const U={},v={};E.forEach(F=>{const z=F.getAttribute("name"),H=A.querySelector(`child[link="${z}"]`)===null;l[z]=x(F,U,v,H?L:null)}),R.forEach(F=>{const z=F.getAttribute("name");c[z]=_(F)}),L.joints=c,L.links=l,L.colliders=v,L.visual=U;const b=Object.values(c);return b.forEach(F=>{F instanceof zf&&c[F.mimicJoint].mimicJoints.push(F)}),b.forEach(F=>{const z=new Set,H=ie=>{if(z.has(ie))throw new Error("URDFLoader: Detected an infinite loop of mimic joints.");z.add(ie),ie.mimicJoints.forEach(ne=>{H(ne)})};H(F)}),L.frames={...v,...U,...l,...c},L}function _(A){const D=[...A.children],E=A.getAttribute("type");let R;const N=D.find(z=>z.nodeName.toLowerCase()==="mimic");N?(R=new zf,R.mimicJoint=N.getAttribute("joint"),R.multiplier=parseFloat(N.getAttribute("multiplier")||1),R.offset=parseFloat(N.getAttribute("offset")||0)):R=new Bp,R.urdfNode=A,R.name=A.getAttribute("name"),R.urdfName=R.name,R.jointType=E;let L=null,U=null,v=[0,0,0],b=[0,0,0];D.forEach(z=>{const H=z.nodeName.toLowerCase();H==="origin"?(v=Ws(z.getAttribute("xyz")),b=Ws(z.getAttribute("rpy"))):H==="child"?U=l[z.getAttribute("link")]:H==="parent"?L=l[z.getAttribute("link")]:H==="limit"&&(R.limit.lower=parseFloat(z.getAttribute("lower")||R.limit.lower),R.limit.upper=parseFloat(z.getAttribute("upper")||R.limit.upper))}),L.add(R),R.add(U),Gf(R,b),R.position.set(v[0],v[1],v[2]);const F=D.filter(z=>z.nodeName.toLowerCase()==="axis")[0];if(F){const z=F.getAttribute("xyz").split(/\s+/g).map(H=>parseFloat(H));R.axis=new j(z[0],z[1],z[2]),R.axis.normalize()}return R}function x(A,D,E,R=null){R===null&&(R=new Op);const N=[...A.children];return R.name=A.getAttribute("name"),R.urdfName=R.name,R.urdfNode=A,r&&N.filter(U=>U.nodeName.toLowerCase()==="visual").forEach(U=>{const v=p(U,u);if(R.add(v),U.hasAttribute("name")){const b=U.getAttribute("name");v.name=b,v.urdfName=b,D[b]=v}}),o&&N.filter(U=>U.nodeName.toLowerCase()==="collision").forEach(U=>{const v=p(U);if(R.add(v),U.hasAttribute("name")){const b=U.getAttribute("name");v.name=b,v.urdfName=b,E[b]=v}}),R}function m(A){const D=[...A.children],E=new qr;return E.name=A.getAttribute("name")||"",D.forEach(R=>{const N=R.nodeName.toLowerCase();if(N==="color"){const L=R.getAttribute("rgba").split(/\s/g).map(U=>parseFloat(U));E.color.setRGB(L[0],L[1],L[2]),E.opacity=L[3],E.transparent=L[3]<1,E.depthWrite=!E.transparent}else if(N==="texture"){const L=R.getAttribute("filename");if(L){const U=new wp(a),v=h(L);E.map=U.load(v),E.map.colorSpace=Wt}}}),E}function p(A,D={}){const E=A.nodeName.toLowerCase()==="collision",R=[...A.children];let N=null;const L=R.filter(v=>v.nodeName.toLowerCase()==="material")[0];if(L){const v=L.getAttribute("name");v&&v in D?N=D[v]:N=m(L)}else N=new qr;const U=E?new HS:new GS;return U.urdfNode=A,R.forEach(v=>{const b=v.nodeName.toLowerCase();if(b==="geometry"){const F=v.children[0].nodeName.toLowerCase();if(F==="mesh"){const z=v.children[0].getAttribute("filename"),H=h(z);if(H!==null){const ie=v.children[0].getAttribute("scale");if(ie){const ne=Ws(ie);U.scale.set(ne[0],ne[1],ne[2])}s(H,a,(ne,k)=>{k?console.error("URDFLoader: Error loading mesh.",k):ne&&(ne instanceof pn&&(ne.material=N),ne.position.set(0,0,0),ne.quaternion.identity(),U.add(ne))})}}else if(F==="box"){const z=new pn;z.geometry=new vr(1,1,1),z.material=N;const H=Ws(v.children[0].getAttribute("size"));z.scale.set(H[0],H[1],H[2]),U.add(z)}else if(F==="sphere"){const z=new pn;z.geometry=new Nu(1,30,30),z.material=N;const H=parseFloat(v.children[0].getAttribute("radius"))||0;z.scale.set(H,H,H),U.add(z)}else if(F==="cylinder"){const z=new pn;z.geometry=new Lu(1,1,1,30),z.material=N;const H=parseFloat(v.children[0].getAttribute("radius"))||0,ie=parseFloat(v.children[0].getAttribute("length"))||0;z.scale.set(H,ie,H),z.rotation.set(Math.PI/2,0,0),U.add(z)}}else if(b==="origin"){const F=Ws(v.getAttribute("xyz")),z=Ws(v.getAttribute("rpy"));U.position.set(F[0],F[1],F[2]),U.rotation.set(0,0,0),Gf(U,z)}}),U}return f(e)}defaultMeshLoader(e,t,i){/\.stl$/i.test(e)?new kS(t).load(e,r=>{const o=new pn(r,new qr);i(o)}):/\.dae$/i.test(e)?new VS(t).load(e,r=>i(r.scene)):console.warn(`URDFLoader: Could not load model at ${e}.
No loader available`)}}const qS={class:"three-viewer"},jS={class:"visibility-controls"},YS={key:0},$S={key:1},KS={key:2},Wf=5,JS=mr({__name:"ThreeViewer",props:{selectedNode:{}},emits:["urdf-loaded","node-selected"],setup(n,{expose:e,emit:t}){const i=n,s=t,r=sn(null),o=Ra({links:!0,joints:!0,collisions:!0,sensors:!0}),a=ai(()=>{const se=Object.values(o).filter(Boolean).length,q=Object.keys(o).length;return se===0?"none":se===q?"all":"mixed"});let l,c,u,h,f,d=null,_=new Tx,x=new at,m=[],p=null;const A=new io({color:16760376,transparent:!0,opacity:.35,depthWrite:!1}),D=()=>{if(!r.value)return;l=new vp,l.background=new ft(2503224),c=new fn(75,r.value.clientWidth/r.value.clientHeight,.1,1e3),c.position.set(3,-3,3),c.up.set(0,0,1),c.lookAt(0,0,0),u=new ES({antialias:!0}),u.setSize(r.value.clientWidth,r.value.clientHeight),u.setPixelRatio(window.devicePixelRatio),r.value.appendChild(u.domElement),h=new AS(c,u.domElement),h.enableDamping=!0,h.dampingFactor=.05;const se=new Cp(16777215,.5);l.add(se);const q=new Rp(16777215,.8);q.position.set(5,-5,10),l.add(q);const te=new Ax(10,10);te.rotation.x=Math.PI/2,l.add(te);const pe=new wx(2);l.add(pe),window.addEventListener("resize",E),u.domElement.addEventListener("mousedown",N),u.domElement.addEventListener("click",L),R()},E=()=>{r.value&&(c.aspect=r.value.clientWidth/r.value.clientHeight,c.updateProjectionMatrix(),u.setSize(r.value.clientWidth,r.value.clientHeight))},R=()=>{f=requestAnimationFrame(R),h.update(),u.render(l,c)},N=se=>{p={x:se.clientX,y:se.clientY}},L=se=>{if(!r.value||!d)return;if(p){const pe=Math.abs(se.clientX-p.x),_e=Math.abs(se.clientY-p.y);if(pe>Wf||_e>Wf){p=null;return}}p=null;const q=r.value.getBoundingClientRect();x.x=(se.clientX-q.left)/q.width*2-1,x.y=-((se.clientY-q.top)/q.height)*2+1,_.setFromCamera(x,c);const te=_.intersectObject(d,!0);if(te.length>0){const pe=te[0];if(pe&&pe.object){const _e=pe.object,Me=U(_e);if(Me){s("node-selected",Me);return}}}s("node-selected",null)},U=se=>{let q=se;for(;q;){if(q.userData.urdfNode)return q.userData.urdfNode;q=q.parent}return null},v=()=>{m.forEach(se=>{l.remove(se)}),m=[]},b=se=>{const q=[];se.traverse(te=>{te.isMesh&&te.userData?.isCollisionMesh&&q.push(te),te.isURDFCollider&&(te.visible=!0,te.isMesh&&q.push(te))}),q.forEach((te,pe)=>{te.material&&te.material!==A&&te.material!==te.userData.originalMaterial&&te.material.dispose&&te.material.dispose(),te.material=A,te.visible=!0})},F=se=>{if(v(),!se||!se.object3D)return;const q=se.object3D,te=(_e,Me=[])=>(_e!==q&&(_e.isURDFLink||_e.isURDFJoint)||(_e.isMesh&&_e.geometry&&Me.push(_e),_e.children&&_e.children.forEach(X=>{te(X,Me)})),Me);te(q).forEach(_e=>{let Me=!1;if(_e.userData?.isCollisionMesh?Me=o.collisions:_e.userData?.isSensor?Me=o.sensors:_e.userData?.isJointMesh?Me=o.joints:_e.userData?.isLinkMesh&&(Me=o.links),!Me)return;const X=new sx(_e.geometry),$=new dr({color:65280}),ye=new Oa(X,$);_e.getWorldPosition(ye.position),_e.getWorldQuaternion(ye.quaternion),_e.getWorldScale(ye.scale),l.add(ye),m.push(ye)})};Ci(()=>i.selectedNode,se=>{F(se??null)}),Ci(()=>({...o}),()=>{F(i.selectedNode??null)},{deep:!0});const z=(se,q)=>{o[se]=q,d&&H(d)},H=se=>{se.traverse(q=>{if(q.isURDFCollider)q.visible=o.collisions,q.traverse(te=>{te.isMesh&&(te.visible=o.collisions)});else if(q.isMesh){if(q.userData?.isCollisionMesh)return;q.userData?.isLinkMesh?q.visible=o.links:q.userData?.isJointMesh&&(q.visible=o.joints)}q.userData?.isSensor&&(q.visible=o.sensors,q.traverse(te=>{te.isMesh&&(te.visible=o.sensors)}))})},ie=se=>{z(se,!o[se])},ne=()=>{const se=a.value,q=se==="none"||se==="mixed";Object.keys(o).forEach(te=>{o[te]=q}),d&&H(d)},k=se=>{se.traverse(q=>{q.userData=q.userData||{};let te=!1,pe=q;for(;pe&&!te;)pe.isURDFCollider&&(te=!0),pe=pe.parent;if(q.userData.isCollisionMesh=te,!te&&q.isMesh){let Me=!1,X=!1;for(pe=q.parent;pe;){if(pe.isURDFJoint){X=!0;break}else if(pe.isURDFLink){Me=!0;break}pe=pe.parent}q.userData.isLinkMesh=Me,q.userData.isJointMesh=X}else q.userData.isLinkMesh=!1,q.userData.isJointMesh=!1;const _e=q.userData?.isSensor||q.userData?.type==="sensor"||q.name?.toLowerCase().includes("sensor")||q.name?.toLowerCase().includes("camera")||q.name?.toLowerCase().includes("lidar")||q.name?.toLowerCase().includes("imu");q.userData.isSensor=_e})},G=se=>{const q=te=>{const pe={name:te.name||"unnamed",type:te.isURDFRobot?"robot":te.isURDFLink?"link":te.isURDFJoint?"joint":"link",children:[],properties:{},object3D:te};if(te.userData=te.userData||{},te.userData.urdfNode=pe,te.isURDFJoint&&te.jointType&&(pe.properties.type=te.jointType,te.axis&&(pe.properties.axis=[te.axis.x,te.axis.y,te.axis.z])),te.isURDFLink||te.isURDFRobot){const _e=[];te.children&&te.children.forEach(Me=>{Me.isURDFCollider&&_e.push({name:Me.urdfName||Me.name||"unnamed_collision",visible:Me.visible})}),_e.length>0&&(pe.properties.collisionGeometry=_e)}return te.position&&(pe.properties.position=[te.position.x,te.position.y,te.position.z]),te.rotation&&(pe.properties.rotation=[te.rotation.x,te.rotation.y,te.rotation.z]),te.children&&te.children.forEach(_e=>{(_e.isURDFLink||_e.isURDFJoint)&&pe.children.push(q(_e))}),pe};return q(se)};e({loadURDFContent:(se,q,te="")=>{d&&(l.remove(d),d=null);const pe=new Tp;pe.onLoad=()=>{d&&(k(d),b(d),H(d))};const _e=new XS(pe);_e.parseCollision=!0,te&&(_e.packages=$=>te);const Me=_e.loadMeshCb;if(Me?_e.loadMeshCb=($,ye,Je)=>{Me.call(_e,$,ye,Ie=>{Ie||console.warn(`[Mesh Loader] Failed to load mesh: ${$}`),Je(Ie)})}:console.warn("[Mesh Loader] No default mesh loader found - mesh loading may not work correctly"),se.startsWith("http://")||se.startsWith("https://"))_e.load(se,$=>{d=$,l.add(d);const ye=G(d);s("urdf-loaded",ye)},void 0,$=>{console.error("Error loading URDF:",$),alert(`Failed to load URDF: ${$}`)});else{d=_e.parse(se),l.add(d),k(d),b(d),H(d);const $=G(d);s("urdf-loaded",$)}}});const ve=()=>{f&&cancelAnimationFrame(f),window.removeEventListener("resize",E),u&&u.domElement&&(u.domElement.removeEventListener("mousedown",N),u.domElement.removeEventListener("click",L)),v(),u&&u.dispose(),r.value&&u&&r.value.removeChild(u.domElement)};return oo(()=>{D()}),Da(()=>{ve()}),(se,q)=>(St(),Lt("div",qS,[Xe("div",jS,[Xe("button",{class:cn(["visibility-btn all-btn",{"all-visible":a.value==="all","all-hidden":a.value==="none","mixed-state":a.value==="mixed"}]),onClick:ne,title:"Show/Hide All Components"},[a.value==="all"?(St(),Lt("span",YS,"👁️ All")):a.value==="none"?(St(),Lt("span",$S,"👁️ None")):(St(),Lt("span",KS,"👁️ Mixed"))],2),q[8]||(q[8]=Xe("div",{class:"divider"},null,-1)),Xe("button",{class:cn(["visibility-btn",{active:o.links}]),onClick:q[0]||(q[0]=te=>ie("links")),title:"Toggle Links Visibility"},[q[4]||(q[4]=Xe("span",{class:"icon"},"🔗",-1)),Xe("span",{class:cn({strikethrough:!o.links})},"Links",2)],2),Xe("button",{class:cn(["visibility-btn",{active:o.joints}]),onClick:q[1]||(q[1]=te=>ie("joints")),title:"Toggle Joints Visibility"},[q[5]||(q[5]=Xe("span",{class:"icon"},"🔧",-1)),Xe("span",{class:cn({strikethrough:!o.joints})},"Joints",2)],2),Xe("button",{class:cn(["visibility-btn",{active:o.collisions}]),onClick:q[2]||(q[2]=te=>ie("collisions")),title:"Toggle Collision Geometry Visibility"},[q[6]||(q[6]=Xe("span",{class:"icon"},"💥",-1)),Xe("span",{class:cn({strikethrough:!o.collisions})},"Collisions",2)],2),Xe("button",{class:cn(["visibility-btn",{active:o.sensors}]),onClick:q[3]||(q[3]=te=>ie("sensors")),title:"Toggle Sensors Visibility"},[q[7]||(q[7]=Xe("span",{class:"icon"},"📡",-1)),Xe("span",{class:cn({strikethrough:!o.sensors})},"Sensors",2)],2)]),Xe("div",{ref_key:"canvasContainer",ref:r,class:"canvas-container"},null,512)]))}}),ZS=gr(JS,[["__scopeId","data-v-fef39c88"]]),QS={class:"properties-panel"},eE={class:"panel-content"},tE={key:0,class:"empty-state"},nE={key:1,class:"properties-container"},iE={class:"properties-list"},sE={class:"property-key"},rE={class:"property-value"},oE={key:0,class:"collision-section"},aE={class:"collapse-icon"},lE={class:"collision-count"},cE={key:0,class:"collision-list"},uE={class:"collision-name"},hE=mr({__name:"PropertiesPanel",props:{node:{}},setup(n){const e=n,t=ai(()=>e.node!==null),i=sn(!0),s=ai(()=>{if(!e.node)return[];const a=[];if(a.push({key:"Name",value:e.node.name}),a.push({key:"Type",value:e.node.type}),e.node.object3D){const l=e.node.object3D,c=new j,u=new Xn,h=new Cn;l.getWorldPosition(c),l.getWorldQuaternion(u),h.setFromQuaternion(u),a.push({key:"Position",value:`[${c.x.toFixed(3)}, ${c.y.toFixed(3)}, ${c.z.toFixed(3)}]`}),a.push({key:"Rotation",value:`[${h.x.toFixed(3)}, ${h.y.toFixed(3)}, ${h.z.toFixed(3)}]`})}else e.node.properties&&(e.node.properties.position&&a.push({key:"Position",value:JSON.stringify(e.node.properties.position)}),e.node.properties.rotation&&a.push({key:"Rotation",value:JSON.stringify(e.node.properties.rotation)}));if(e.node.properties)for(const[l,c]of Object.entries(e.node.properties))l!=="position"&&l!=="rotation"&&l!=="collisionGeometry"&&a.push({key:l.charAt(0).toUpperCase()+l.slice(1),value:typeof c=="object"?JSON.stringify(c,null,2):String(c)});return a}),r=ai(()=>!e.node||!e.node.properties?[]:e.node.properties.collisionGeometry||[]),o=ai(()=>r.value.length>0);return(a,l)=>(St(),Lt("aside",QS,[l[3]||(l[3]=Xe("div",{class:"panel-header"},[Xe("h2",null,"Properties")],-1)),Xe("div",eE,[t.value?(St(),Lt("div",nE,[Xe("div",iE,[(St(!0),Lt(wn,null,da(s.value,c=>(St(),Lt("div",{key:c.key,class:"property-item"},[Xe("div",sE,un(c.key),1),Xe("div",rE,un(c.value),1)]))),128))]),o.value?(St(),Lt("div",oE,[Xe("div",{class:"collision-header",onClick:l[0]||(l[0]=c=>i.value=!i.value)},[Xe("span",aE,un(i.value?"▼":"▶"),1),l[2]||(l[2]=Xe("h3",null,"Collision Geometry",-1)),Xe("span",lE,"("+un(r.value.length)+")",1)]),i.value?(St(),Lt("div",cE,[(St(!0),Lt(wn,null,da(r.value,(c,u)=>(St(),Lt("div",{key:u,class:"collision-item"},[Xe("div",uE,un(c.name),1)]))),128))])):Ui("",!0)])):Ui("",!0)])):(St(),Lt("div",tE,[...l[1]||(l[1]=[Xe("p",null,"No component selected",-1),Xe("p",{class:"hint"},"Select a component from the hierarchy to view its properties",-1)])]))])]))}}),fE=gr(hE,[["__scopeId","data-v-9645ac98"]]),dE={class:"console-title"},pE={class:"collapse-icon"},mE=["title"],gE={key:0,class:"no-logs"},_E={class:"log-time"},xE={class:"log-type"},vE={class:"log-message"},ME=mr({__name:"ConsolePanel",setup(n){const e=sn([]),t=sn(!0),i=sn(!0),s=sn(null);let r=0;const o={log:console.log,warn:console.warn,error:console.error,info:console.info},a=(x,m)=>{const p=m.map(A=>{if(typeof A=="object")try{return JSON.stringify(A,null,2)}catch{return String(A)}return String(A)}).join(" ");e.value.push({id:r++,timestamp:new Date,type:x,message:p}),i.value&&!t.value&&$l(()=>{s.value&&(s.value.scrollTop=s.value.scrollHeight)})},l=()=>{console.log=(...x)=>{o.log(...x),a("log",x)},console.warn=(...x)=>{o.warn(...x),a("warn",x)},console.error=(...x)=>{o.error(...x),a("error",x)},console.info=(...x)=>{o.info(...x),a("info",x)}},c=()=>{console.log=o.log,console.warn=o.warn,console.error=o.error,console.info=o.info},u=()=>{t.value=!t.value,!t.value&&i.value&&$l(()=>{s.value&&(s.value.scrollTop=s.value.scrollHeight)})},h=()=>{i.value=!i.value,i.value&&s.value&&(s.value.scrollTop=s.value.scrollHeight)},f=()=>{e.value=[]},d=x=>{const m=x.toLocaleTimeString("en-US",{hour12:!1,hour:"2-digit",minute:"2-digit",second:"2-digit"}),p=x.getMilliseconds().toString().padStart(3,"0");return`${m}.${p}`},_=x=>`log-entry log-${x}`;return oo(()=>{l()}),Da(()=>{c()}),(x,m)=>(St(),Lt("div",{class:cn(["console-panel",{collapsed:t.value}])},[Xe("div",{class:"console-header",onClick:u},[Xe("span",dE,[Xe("span",pE,un(t.value?"▲":"▼"),1),pu(" Console Logs ("+un(e.value.length)+") ",1)]),Xe("div",{class:"console-actions",onClick:m[0]||(m[0]=Yd(()=>{},["stop"]))},[Xe("button",{class:cn(["console-btn",{active:i.value}]),onClick:h,title:i.value?"Disable auto-scroll":"Enable auto-scroll"},un(i.value?"📌":"📍")+" Auto-scroll ",11,mE),Xe("button",{class:"console-btn",onClick:f,title:"Clear logs"}," 🗑️ Clear ")])]),t.value?Ui("",!0):(St(),Lt("div",{key:0,class:"console-content",ref_key:"logsContainer",ref:s},[e.value.length===0?(St(),Lt("div",gE," No console logs yet ")):Ui("",!0),(St(!0),Lt(wn,null,da(e.value,p=>(St(),Lt("div",{key:p.id,class:cn(_(p.type))},[Xe("span",_E,un(d(p.timestamp)),1),Xe("span",xE,un(p.type.toUpperCase()),1),Xe("span",vE,un(p.message),1)],2))),128))],512))],2))}}),yE=gr(ME,[["__scopeId","data-v-64a5f72d"]]),bE={class:"urdf-editor"},SE={class:"toolbar"},EE={class:"toolbar-actions"},TE={class:"upload-dropdown"},AE={key:0,class:"dropdown-menu"},wE={class:"editor-container"},RE=mr({__name:"App",setup(n){const e=sn(null),t=sn(null),i=sn(!1),s=sn(!1),r=sn(""),o=sn(""),a=sn(null);Ci(r,L=>{if(L&&!o.value){const U=L.lastIndexOf("/");U!==-1&&(o.value=L.substring(0,U+1))}});const l=L=>{e.value===L?e.value=null:e.value=L},c=L=>{e.value=L},u=L=>{t.value=L,e.value=null},h=()=>{i.value=!i.value},f=()=>{i.value=!1},d=L=>{L.target.closest(".upload-dropdown")||f()};oo(()=>{document.addEventListener("click",d)}),Da(()=>{document.removeEventListener("click",d)});const _=()=>{f(),document.getElementById("file-upload")?.click()},x=()=>{f(),s.value=!0},m=()=>{s.value=!1,p()},p=()=>{r.value="",o.value=""},A=async()=>{if(r.value.trim())try{let L=o.value.trim();L||(L=r.value.substring(0,r.value.lastIndexOf("/")+1));const U=r.value.split("/"),v=U[U.length-1]||"loaded_from_url.urdf";a.value&&a.value.loadURDFContent(r.value,v,L),s.value=!1,p()}catch(L){console.error("Error loading URDF from URL:",L),alert(`Failed to load URDF from URL: ${L}`),s.value=!1,p()}},D=L=>{const U=L.target;if(U.files&&U.files[0]){const v=U.files[0],b=new FileReader;b.onload=F=>{const z=F.target?.result;if(a.value)try{a.value.loadURDFContent(z,v.name,"")}catch(H){console.error("Error loading URDF:",H),alert(`Failed to load URDF: ${H}`)}},b.readAsText(v)}},E=()=>{if(!t.value)return;const L=R(t.value),U=new Blob([L],{type:"application/xml"}),v=URL.createObjectURL(U),b=document.createElement("a");b.href=v,b.download=`${t.value.name}.urdf`;try{document.body?(b.style&&(b.style.display="none"),document.body.appendChild(b),b.click(),setTimeout(()=>{try{document.body&&document.body.contains(b)&&document.body.removeChild(b)}catch{}URL.revokeObjectURL(v)},100)):(b.click(),setTimeout(()=>{URL.revokeObjectURL(v)},100))}catch{b.click(),setTimeout(()=>{URL.revokeObjectURL(v)},100)}},R=L=>{let U=`<?xml version="1.0"?>
`;return U+=N(L,0),U},N=(L,U)=>{const v="  ".repeat(U);let b="";if(L.type==="robot"){b+=`${v}<robot name="${L.name}">
`;for(const F of L.children)b+=N(F,U+1);b+=`${v}</robot>
`}else if(L.type==="link"){b+=`${v}<link name="${L.name}">
`;for(const F of L.children)b+=N(F,U+1);b+=`${v}</link>
`}else if(L.type==="joint"){b+=`${v}<joint name="${L.name}" type="${L.properties?.type||"fixed"}">
`;for(const F of L.children)b+=N(F,U+1);b+=`${v}</joint>
`}return b};return(L,U)=>(St(),Lt("div",bE,[Xe("header",SE,[U[4]||(U[4]=Xe("h1",null,"URDF Editor",-1)),Xe("div",EE,[Xe("div",TE,[Xe("button",{class:"btn upload-btn",onClick:h},[...U[3]||(U[3]=[pu(" Upload URDF ",-1),Xe("span",{class:"dropdown-arrow"},"▼",-1)])]),i.value?(St(),Lt("div",AE,[Xe("button",{onClick:_,class:"dropdown-item"}," 📁 From Local File "),Xe("button",{onClick:x,class:"dropdown-item"}," 🌐 From URL ")])):Ui("",!0)]),Xe("input",{id:"file-upload",type:"file",accept:".urdf,.xml,application/xml,text/xml",onChange:D,style:{display:"none"}},null,32),Xe("button",{class:"btn",disabled:!0,onClick:E},"Download URDF")])]),Xe("div",wE,[On(R_,{root:t.value,selected:e.value,onSelect:l},null,8,["root","selected"]),On(ZS,{ref_key:"threeViewerRef",ref:a,class:"main-viewer","selected-node":e.value,onUrdfLoaded:u,onNodeSelected:c},null,8,["selected-node"]),On(fE,{node:e.value},null,8,["node"])]),s.value?(St(),Lt("div",{key:0,class:"modal-overlay",onClick:m},[Xe("div",{class:"modal-dialog",onClick:U[2]||(U[2]=Yd(()=>{},["stop"]))},[U[5]||(U[5]=Xe("h3",null,"Load URDF from URL",-1)),Hu(Xe("input",{"onUpdate:modelValue":U[0]||(U[0]=v=>r.value=v),type:"text",placeholder:"Enter URDF file URL",class:"url-input",onKeyup:_h(A,["enter"])},null,544),[[gh,r.value]]),Hu(Xe("input",{"onUpdate:modelValue":U[1]||(U[1]=v=>o.value=v),type:"text",placeholder:"Package path URL (optional - defaults to URDF folder)",class:"url-input",onKeyup:_h(A,["enter"])},null,544),[[gh,o.value]]),U[6]||(U[6]=Xe("div",{class:"modal-help-text"}," Package path is used to resolve package:// mesh references. Leave empty to use the URDF's folder as the default. ",-1)),Xe("div",{class:"modal-actions"},[Xe("button",{class:"btn btn-secondary",onClick:m},"Cancel"),Xe("button",{class:"btn",onClick:A},"Load")])])])):Ui("",!0),On(yE)]))}}),CE=gr(RE,[["__scopeId","data-v-c623ff2e"]]),PE=c_(CE);PE.mount("#app");
