...
`}return f};return(c,u)=>(Lt(),Qt("div",mM,[pt("header",_M,[u[1]||(u[1]=pt("h1",null,"URDF Editor",-1)),pt("div",gM,[u[0]||(u[0]=pt("label",{for:"file-upload",class:"btn"},"Upload URDF",-1)),pt("input",{id:"file-upload",type:"file",accept:".urdf,.xml,application/xml,text/xml",onChange:r,style:{display:"none"}},null,32),pt("button",{class:"btn",disabled:!t.value,onClick:o},"Download URDF",8,xM)])]),pt("div",vM,[un(Tm,{root:t.value,selected:e.value,onSelect:i},null,8,["root","selected"]),un(oM,{class:"main-viewer",onUrdfLoaded:s}),un(pM,{node:e.value},null,8,["node"])])]))}}),MM=nr(SM,[["__scopeId","data-v-1b66a0ef"]]),EM=um(MM);EM.mount("#app");
