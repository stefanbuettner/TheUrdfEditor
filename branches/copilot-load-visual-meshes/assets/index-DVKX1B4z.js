...
`)+`
`+d);const D=A+m+o,E=A+d+a,R=Af(s,s.VERTEX_SHADER,D),I=Af(s,s.FRAGMENT_SHADER,E);s.attachShader(x,R),s.attachShader(x,I),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function L(N){if(n.debug.checkShaderErrors){const k=s.getProgramInfoLog(x)||"",z=s.getShaderInfoLog(R)||"",K=s.getShaderInfoLog(I)||"",$=k.trim(),O=z.trim(),G=K.trim();let Y=!0,me=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,R,I);else{const ge=Rf(s,R,"vertex"),de=Rf(s,I,"fragment");_t("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,lb=[new X(1,0,0),new X(-1,0,0),new X(0,1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1)],cb=[new X(0,-1,0),new X(0,-1,0),new X(0,0,1),new X(0,0,-1),new X(0,-1,0),new X(0,-1,0)],Ff=new ct,Ir=new X,kl=new X;function ub(n,e,t){let i=new Du;const s=new at,r=new at,o=new Bt,a=new ox,l=new ax,c={},u=t.maxTextureSize,h={[Li]:Tn,[Tn]:Li,[ri]:ri},f=new fi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new at},radius:{value:4}},vertexShader:ob,fragmentShader:ab}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new en;_.setAttribute("position",new Bn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new fn(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=na;let d=this.type;this.render=function(I,L,F){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||I.length===0)return;I.type===P_&&(nt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),I.type=na);const v=n.getRenderTarget(),S=n.getActiveCubeFace(),N=n.getActiveMipmapLevel(),k=n.state;k.setBlending(wi),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const z=d!==this.type;z&&L.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach($=>$.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,$=I.length;K<$;K++){const O=I[K],G=O.shadow;if(G===void 0){nt("WebGLShadowMap:",O,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const Y=G.getFrameExtents();if(s.multiply(Y),r.copy(G.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/Y.x),s.x=r.x*Y.x,G.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/Y.y),s.y=r.y*Y.y,G.mapSize.y=r.y)),G.map===null||z===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Fr){if(O.isPointLight){nt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new ci(s.x,s.y,{format:cr,type:Ni,minFilter:Kt,magFilter:Kt,generateMipmaps:!1}),G.map.texture.name=O.name+".shadowMap",G.map.depthTexture=new io(s.x,s.y,$n),G.map.depthTexture.name=O.name+".shadowMapDepth",G.map.depthTexture.format=Ii,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=sn,G.map.depthTexture.magFilter=sn}else{O.isPointLight?(G.map=new xp(s.x),G.map.depthTexture=new nx(s.x,hi)):(G.map=new ci(s.x,s.y),G.map.depthTexture=new io(s.x,s.y,hi)),G.map.depthTexture.name=O.name+".shadowMap",G.map.depthTexture.format=Ii;const ge=n.state.buffers.depth.getReversed();this.type===na?(G.map.depthTexture.compareFunction=ge?Tu:Eu,G.map.depthTexture.minFilter=Kt,G.map.depthTexture.magFilter=Kt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=sn,G.map.depthTexture.magFilter=sn)}G.camera.updateProjectionMatrix()}const me=G.map.isWebGLCubeRenderTarget?6:1;for(let ge=0;ge<me;ge++){if(G.map.isWebGLCubeRenderTarget)n.setRenderTarget(G.map,ge),n.clear();else{ge===0&&(n.setRenderTarget(G.map),n.clear());const de=G.getViewport(ge);o.set(r.x*de.x,r.y*de.y,r.x*de.z,r.y*de.w),k.viewport(o)}if(O.isPointLight){const de=G.camera,Re=G.matrix,Se=O.distance||de.far;Se!==de.far&&(de.far=Se,de.updateProjectionMatrix()),Ir.setFromMatrixPosition(O.matrixWorld),de.position.copy(Ir),kl.copy(de.position),kl.add(lb[ge]),de.up.copy(cb[ge]),de.lookAt(kl),de.updateMatrixWorld(),Re.makeTranslation(-Ir.x,-Ir.y,-Ir.z),Ff.multiplyMatrices(de.projectionMatrix,de.matrixWorldInverse),G._frustum.setFromProjectionMatrix(Ff,de.coordinateSystem,de.reversedDepth)}else G.updateMatrices(O);i=G.getFrustum(),E(L,F,G.camera,O,this.type)}G.isPointLightShadow!==!0&&this.type===Fr&&A(G,F),G.needsUpdate=!1}d=this.type,m.needsUpdate=!1,n.setRenderTarget(v,S,N)};function A(I,L){const F=e.update(x);f.defines.VSM_SAMPLES!==I.blurSamples&&(f.defines.VSM_SAMPLES=I.blurSamples,p.defines.VSM_SAMPLES=I.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new ci(s.x,s.y,{format:cr,type:Ni})),f.uniforms.shadow_pass.value=I.map.depthTexture,f.uniforms.resolution.value=I.mapSize,f.uniforms.radius.value=I.radius,n.setRenderTarget(I.mapPass),n.clear(),n.renderBufferDirect(L,null,F,f,x,null),p.uniforms.shadow_pass.value=I.mapPass.texture,p.uniforms.resolution.value=I.mapSize,p.uniforms.radius.value=I.radius,n.setRenderTarget(I.map),n.clear(),n.renderBufferDirect(L,null,F,p,x,null)}function D(I,L,F,v){let S=null;const N=F.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(N!==void 0)S=N;else if(S=F.isPointLight===!0?l:a,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const k=S.uuid,z=L.uuid;let K=c[k];K===void 0&&(K={},c[k]=K);let $=K[z];$===void 0&&($=S.clone(),K[z]=$,L.addEventListener("dispose",R)),S=$}if(S.visible=L.visible,S.wireframe=L.wireframe,v===Fr?S.side=L.shadowSide!==null?L.shadowSide:L.side:S.side=L.shadowSide!==null?L.shadowSide:h[L.side],S.alphaMap=L.alphaMap,S.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,S.map=L.map,S.clipShadows=L.clipShadows,S.clippingPlanes=L.clippingPlanes,S.clipIntersection=L.clipIntersection,S.displacementMap=L.displacementMap,S.displacementScale=L.displacementScale,S.displacementBias=L.displacementBias,S.wireframeLinewidth=L.wireframeLinewidth,S.linewidth=L.linewidth,F.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const k=n.properties.get(S);k.light=F}return S}function E(I,L,F,v,S){if(I.visible===!1)return;if(I.layers.test(L.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&S===Fr)&&(!I.frustumCulled||i.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,I.matrixWorld);const z=e.update(I),K=I.material;if(Array.isArray(K)){const $=z.groups;for(let O=0,G=$.length;O<G;O++){const Y=$[O],me=K[Y.materialIndex];if(me&&me.visible){const ge=D(I,me,v,S);I.onBeforeShadow(n,I,L,F,z,ge,Y),n.renderBufferDirect(F,null,z,ge,I,Y),I.onAfterShadow(n,I,L,F,z,ge,Y)}}}else if(K.visible){const $=D(I,K,v,S);I.onBeforeShadow(n,I,L,F,z,$,null),n.renderBufferDirect(F,null,z,$,I,null),I.onAfterShadow(n,I,L,F,z,$,null)}}const k=I.children;for(let z=0,K=k.length;z<K;z++)E(k[z],L,F,v,S)}function R(I){I.target.removeEventListener("dispose",R);for(const F in c){const v=c[F],S=I.target.uuid;S in v&&(v[S].dispose(),delete v[S])}}}const hb={[nc]:ic,[sc]:ac,[rc]:lc,[ar]:oc,[ic]:nc,[ac]:sc,[lc]:rc,[oc]:ar};function fb(n,e){function t(){let W=!1;const Oe=new Bt;let Ee=null;const Ge=new Bt(0,0,0,0);return{setMask:function(ye){Ee!==ye&&!W&&(n.colorMask(ye,ye,ye,ye),Ee=ye)},setLocked:function(ye){W=ye},setClear:function(ye,pe,we,ot,Nt){Nt===!0&&(ye*=ot,pe*=ot,we*=ot),Oe.set(ye,pe,we,ot),Ge.equals(Oe)===!1&&(n.clearColor(ye,pe,we,ot),Ge.copy(Oe))},reset:function(){W=!1,Ee=null,Ge.set(-1,0,0,0)}}}function i(){let W=!1,Oe=!1,Ee=null,Ge=null,ye=null;return{setReversed:function(pe){if(Oe!==pe){const we=e.get("EXT_clip_control");pe?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),Oe=pe;const ot=ye;ye=null,this.setClear(ot)}},getReversed:function(){return Oe},setTest:function(pe){pe?te(n.DEPTH_TEST):be(n.DEPTH_TEST)},setMask:function(pe){Ee!==pe&&!W&&(n.depthMask(pe),Ee=pe)},setFunc:function(pe){if(Oe&&(pe=hb[pe]),Ge!==pe){switch(pe){case nc:n.depthFunc(n.NEVER);break;case ic:n.depthFunc(n.ALWAYS);break;case sc:n.depthFunc(n.LESS);break;case ar:n.depthFunc(n.LEQUAL);break;case rc:n.depthFunc(n.EQUAL);break;case oc:n.depthFunc(n.GEQUAL);break;case ac:n.depthFunc(n.GREATER);break;case lc:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Ge=pe}},setLocked:function(pe){W=pe},setClear:function(pe){ye!==pe&&(Oe&&(pe=1-pe),n.clearDepth(pe),ye=pe)},reset:function(){W=!1,Ee=null,Ge=null,ye=null,Oe=!1}}}function s(){let W=!1,Oe=null,Ee=null,Ge=null,ye=null,pe=null,we=null,ot=null,Nt=null;return{setTest:function(dt){W||(dt?te(n.STENCIL_TEST):be(n.STENCIL_TEST))},setMask:function(dt){Oe!==dt&&!W&&(n.stencilMask(dt),Oe=dt)},setFunc:function(dt,wn,Xn){(Ee!==dt||Ge!==wn||ye!==Xn)&&(n.stencilFunc(dt,wn,Xn),Ee=dt,Ge=wn,ye=Xn)},setOp:function(dt,wn,Xn){(pe!==dt||we!==wn||ot!==Xn)&&(n.stencilOp(dt,wn,Xn),pe=dt,we=wn,ot=Xn)},setLocked:function(dt){W=dt},setClear:function(dt){Nt!==dt&&(n.clearStencil(dt),Nt=dt)},reset:function(){W=!1,Oe=null,Ee=null,Ge=null,ye=null,pe=null,we=null,ot=null,Nt=null}}}const r=new t,o=new i,a=new s,l=new WeakMap,c=new WeakMap;let u={},h={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,A=null,D=null,E=null,R=null,I=null,L=new ft(0,0,0),F=0,v=!1,S=null,N=null,k=null,z=null,K=null;const $=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let O=!1,G=0;const Y=n.getParameter(n.VERSION);Y.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(Y)[1]),O=G>=1):Y.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),O=G>=2);let me=null,ge={};const de=n.getParameter(n.SCISSOR_BOX),Re=n.getParameter(n.VIEWPORT),Se=new Bt().fromArray(de),Ne=new Bt().fromArray(Re);function Pe(W,Oe,Ee,Ge){const ye=new Uint8Array(4),pe=n.createTexture();n.bindTexture(W,pe),n.texParameteri(W,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(W,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let we=0;we<Ee;we++)W===n.TEXTURE_3D||W===n.TEXTURE_2D_ARRAY?n.texImage3D(Oe,0,n.RGBA,1,1,Ge,0,n.RGBA,n.UNSIGNED_BYTE,ye):n.texImage2D(Oe+we,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ye);return pe}const q={};q[n.TEXTURE_2D]=Pe(n.TEXTURE_2D,n.TEXTURE_2D,1),q[n.TEXTURE_CUBE_MAP]=Pe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[n.TEXTURE_2D_ARRAY]=Pe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),q[n.TEXTURE_3D]=Pe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),te(n.DEPTH_TEST),o.setFunc(ar),se(!1),ce(vh),te(n.CULL_FACE),Q(wi);function te(W){u[W]!==!0&&(n.enable(W),u[W]=!0)}function be(W){u[W]!==!1&&(n.disable(W),u[W]=!1)}function Qe(W,Oe){return h[W]!==Oe?(n.bindFramebuffer(W,Oe),h[W]=Oe,W===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=Oe),W===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=Oe),!0):!1}function Be(W,Oe){let Ee=p,Ge=!1;if(W){Ee=f.get(Oe),Ee===void 0&&(Ee=[],f.set(Oe,Ee));const ye=W.textures;if(Ee.length!==ye.length||Ee[0]!==n.COLOR_ATTACHMENT0){for(let pe=0,we=ye.length;pe<we;pe++)Ee[pe]=n.COLOR_ATTACHMENT0+pe;Ee.length=ye.length,Ge=!0}}else Ee[0]!==n.BACK&&(Ee[0]=n.BACK,Ge=!0);Ge&&n.drawBuffers(Ee)}function Mt(W){return _!==W?(n.useProgram(W),_=W,!0):!1}const B={[hs]:n.FUNC_ADD,[L_]:n.FUNC_SUBTRACT,[N_]:n.FUNC_REVERSE_SUBTRACT};B[I_]=n.MIN,B[U_]=n.MAX;const H={[F_]:n.ZERO,[O_]:n.ONE,[B_]:n.SRC_COLOR,[ec]:n.SRC_ALPHA,[W_]:n.SRC_ALPHA_SATURATE,[H_]:n.DST_COLOR,[V_]:n.DST_ALPHA,[k_]:n.ONE_MINUS_SRC_COLOR,[tc]:n.ONE_MINUS_SRC_ALPHA,[G_]:n.ONE_MINUS_DST_COLOR,[z_]:n.ONE_MINUS_DST_ALPHA,[X_]:n.CONSTANT_COLOR,[q_]:n.ONE_MINUS_CONSTANT_COLOR,[j_]:n.CONSTANT_ALPHA,[Y_]:n.ONE_MINUS_CONSTANT_ALPHA};function Q(W,Oe,Ee,Ge,ye,pe,we,ot,Nt,dt){if(W===wi){x===!0&&(be(n.BLEND),x=!1);return}if(x===!1&&(te(n.BLEND),x=!0),W!==D_){if(W!==m||dt!==v){if((d!==hs||E!==hs)&&(n.blendEquation(n.FUNC_ADD),d=hs,E=hs),dt)switch(W){case nr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Mh:n.blendFunc(n.ONE,n.ONE);break;case yh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Sh:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:_t("WebGLState: Invalid blending: ",W);break}else switch(W){case nr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Mh:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case yh:_t("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Sh:_t("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:_t("WebGLState: Invalid blending: ",W);break}A=null,D=null,R=null,I=null,L.set(0,0,0),F=0,m=W,v=dt}return}ye=ye||Oe,pe=pe||Ee,we=we||Ge,(Oe!==d||ye!==E)&&(n.blendEquationSeparate(B[Oe],B[ye]),d=Oe,E=ye),(Ee!==A||Ge!==D||pe!==R||we!==I)&&(n.blendFuncSeparate(H[Ee],H[Ge],H[pe],H[we]),A=Ee,D=Ge,R=pe,I=we),(ot.equals(L)===!1||Nt!==F)&&(n.blendColor(ot.r,ot.g,ot.b,Nt),L.copy(ot),F=Nt),m=W,v=!1}function le(W,Oe){W.side===ri?be(n.CULL_FACE):te(n.CULL_FACE);let Ee=W.side===Tn;Oe&&(Ee=!Ee),se(Ee),W.blending===nr&&W.transparent===!1?Q(wi):Q(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),o.setFunc(W.depthFunc),o.setTest(W.depthTest),o.setMask(W.depthWrite),r.setMask(W.colorWrite);const Ge=W.stencilWrite;a.setTest(Ge),Ge&&(a.setMask(W.stencilWriteMask),a.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),a.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),_e(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?te(n.SAMPLE_ALPHA_TO_COVERAGE):be(n.SAMPLE_ALPHA_TO_COVERAGE)}function se(W){S!==W&&(W?n.frontFace(n.CW):n.frontFace(n.CCW),S=W)}function ce(W){W!==R_?(te(n.CULL_FACE),W!==N&&(W===vh?n.cullFace(n.BACK):W===C_?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):be(n.CULL_FACE),N=W}function U(W){W!==k&&(O&&n.lineWidth(W),k=W)}function _e(W,Oe,Ee){W?(te(n.POLYGON_OFFSET_FILL),(z!==Oe||K!==Ee)&&(n.polygonOffset(Oe,Ee),z=Oe,K=Ee)):be(n.POLYGON_OFFSET_FILL)}function he(W){W?te(n.SCISSOR_TEST):be(n.SCISSOR_TEST)}function ae(W){W===void 0&&(W=n.TEXTURE0+$-1),me!==W&&(n.activeTexture(W),me=W)}function fe(W,Oe,Ee){Ee===void 0&&(me===null?Ee=n.TEXTURE0+$-1:Ee=me);let Ge=ge[Ee];Ge===void 0&&(Ge={type:void 0,texture:void 0},ge[Ee]=Ge),(Ge.type!==W||Ge.texture!==Oe)&&(me!==Ee&&(n.activeTexture(Ee),me=Ee),n.bindTexture(W,Oe||q[W]),Ge.type=W,Ge.texture=Oe)}function T(){const W=ge[me];W!==void 0&&W.type!==void 0&&(n.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function g(){try{n.compressedTexImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function V(){try{n.compressedTexImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function ee(){try{n.texSubImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function oe(){try{n.texSubImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function J(){try{n.compressedTexSubImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function Ue(){try{n.compressedTexSubImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function Me(){try{n.texStorage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function ke(){try{n.texStorage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function $e(){try{n.texImage2D(...arguments)}catch(W){_t("WebGLState:",W)}}function xe(){try{n.texImage3D(...arguments)}catch(W){_t("WebGLState:",W)}}function Ae(W){Se.equals(W)===!1&&(n.scissor(W.x,W.y,W.z,W.w),Se.copy(W))}function De(W){Ne.equals(W)===!1&&(n.viewport(W.x,W.y,W.z,W.w),Ne.copy(W))}function Ve(W,Oe){let Ee=c.get(Oe);Ee===void 0&&(Ee=new WeakMap,c.set(Oe,Ee));let Ge=Ee.get(W);Ge===void 0&&(Ge=n.getUniformBlockIndex(Oe,W.name),Ee.set(W,Ge))}function Te(W,Oe){const Ge=c.get(Oe).get(W);l.get(Oe)!==Ge&&(n.uniformBlockBinding(Oe,Ge,W.__bindingPointIndex),l.set(Oe,Ge))}function lt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),o.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},me=null,ge={},h={},f=new WeakMap,p=[],_=null,x=!1,m=null,d=null,A=null,D=null,E=null,R=null,I=null,L=new ft(0,0,0),F=0,v=!1,S=null,N=null,k=null,z=null,K=null,Se.set(0,0,n.canvas.width,n.canvas.height),Ne.set(0,0,n.canvas.width,n.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:te,disable:be,bindFramebuffer:Qe,drawBuffers:Be,useProgram:Mt,setBlending:Q,setMaterial:le,setFlipSided:se,setCullFace:ce,setLineWidth:U,setPolygonOffset:_e,setScissorTest:he,activeTexture:ae,bindTexture:fe,unbindTexture:T,compressedTexImage2D:g,compressedTexImage3D:V,texImage2D:$e,texImage3D:xe,updateUBOMapping:Ve,uniformBlockBinding:Te,texStorage2D:Me,texStorage3D:ke,texSubImage2D:ee,texSubImage3D:oe,compressedTexSubImage2D:J,compressedTexSubImage3D:Ue,scissor:Ae,viewport:De,reset:lt}}function db(n,e,t,i,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new at,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(T,g){return p?new OffscreenCanvas(T,g):to("canvas")}function x(T,g,V){let ee=1;const oe=fe(T);if((oe.width>V||oe.height>V)&&(ee=V/Math.max(oe.width,oe.height)),ee<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const J=Math.floor(ee*oe.width),Ue=Math.floor(ee*oe.height);h===void 0&&(h=_(J,Ue));const Me=g?_(J,Ue):h;return Me.width=J,Me.height=Ue,Me.getContext("2d").drawImage(T,0,0,J,Ue),nt("WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+J+"x"+Ue+")."),Me}else return"data"in T&&nt("WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),T;return T}function m(T){return T.generateMipmaps}function d(T){n.generateMipmap(T)}function A(T){return T.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?n.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function D(T,g,V,ee,oe=!1){if(T!==null){if(n[T]!==void 0)return n[T];nt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let J=g;if(g===n.RED&&(V===n.FLOAT&&(J=n.R32F),V===n.HALF_FLOAT&&(J=n.R16F),V===n.UNSIGNED_BYTE&&(J=n.R8)),g===n.RED_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.R8UI),V===n.UNSIGNED_SHORT&&(J=n.R16UI),V===n.UNSIGNED_INT&&(J=n.R32UI),V===n.BYTE&&(J=n.R8I),V===n.SHORT&&(J=n.R16I),V===n.INT&&(J=n.R32I)),g===n.RG&&(V===n.FLOAT&&(J=n.RG32F),V===n.HALF_FLOAT&&(J=n.RG16F),V===n.UNSIGNED_BYTE&&(J=n.RG8)),g===n.RG_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.RG8UI),V===n.UNSIGNED_SHORT&&(J=n.RG16UI),V===n.UNSIGNED_INT&&(J=n.RG32UI),V===n.BYTE&&(J=n.RG8I),V===n.SHORT&&(J=n.RG16I),V===n.INT&&(J=n.RG32I)),g===n.RGB_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.RGB8UI),V===n.UNSIGNED_SHORT&&(J=n.RGB16UI),V===n.UNSIGNED_INT&&(J=n.RGB32UI),V===n.BYTE&&(J=n.RGB8I),V===n.SHORT&&(J=n.RGB16I),V===n.INT&&(J=n.RGB32I)),g===n.RGBA_INTEGER&&(V===n.UNSIGNED_BYTE&&(J=n.RGBA8UI),V===n.UNSIGNED_SHORT&&(J=n.RGBA16UI),V===n.UNSIGNED_INT&&(J=n.RGBA32UI),V===n.BYTE&&(J=n.RGBA8I),V===n.SHORT&&(J=n.RGBA16I),V===n.INT&&(J=n.RGBA32I)),g===n.RGB&&(V===n.UNSIGNED_INT_5_9_9_9_REV&&(J=n.RGB9_E5),V===n.UNSIGNED_INT_10F_11F_11F_REV&&(J=n.R11F_G11F_B10F)),g===n.RGBA){const Ue=oe?ma:vt.getTransfer(ee);V===n.FLOAT&&(J=n.RGBA32F),V===n.HALF_FLOAT&&(J=n.RGBA16F),V===n.UNSIGNED_BYTE&&(J=Ue===Lt?n.SRGB8_ALPHA8:n.RGBA8),V===n.UNSIGNED_SHORT_4_4_4_4&&(J=n.RGBA4),V===n.UNSIGNED_SHORT_5_5_5_1&&(J=n.RGB5_A1)}return(J===n.R16F||J===n.R32F||J===n.RG16F||J===n.RG32F||J===n.RGBA16F||J===n.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function E(T,g){let V;return T?g===null||g===hi||g===eo?V=n.DEPTH24_STENCIL8:g===$n?V=n.DEPTH32F_STENCIL8:g===Qr&&(V=n.DEPTH24_STENCIL8,nt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===hi||g===eo?V=n.DEPTH_COMPONENT24:g===$n?V=n.DEPTH_COMPONENT32F:g===Qr&&(V=n.DEPTH_COMPONENT16),V}function R(T,g){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==sn&&T.minFilter!==Kt?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function I(T){const g=T.target;g.removeEventListener("dispose",I),F(g),g.isVideoTexture&&u.delete(g)}function L(T){const g=T.target;g.removeEventListener("dispose",L),S(g)}function F(T){const g=i.get(T);if(g.__webglInit===void 0)return;const V=T.source,ee=f.get(V);if(ee){const oe=ee[g.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&v(T),Object.keys(ee).length===0&&f.delete(V)}i.remove(T)}function v(T){const g=i.get(T);n.deleteTexture(g.__webglTexture);const V=T.source,ee=f.get(V);delete ee[g.__cacheKey],o.memory.textures--}function S(T){const g=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(g.__webglFramebuffer[ee]))for(let oe=0;oe<g.__webglFramebuffer[ee].length;oe++)n.deleteFramebuffer(g.__webglFramebuffer[ee][oe]);else n.deleteFramebuffer(g.__webglFramebuffer[ee]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[ee])}else{if(Array.isArray(g.__webglFramebuffer))for(let ee=0;ee<g.__webglFramebuffer.length;ee++)n.deleteFramebuffer(g.__webglFramebuffer[ee]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let ee=0;ee<g.__webglColorRenderbuffer.length;ee++)g.__webglColorRenderbuffer[ee]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[ee]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const V=T.textures;for(let ee=0,oe=V.length;ee<oe;ee++){const J=i.get(V[ee]);J.__webglTexture&&(n.deleteTexture(J.__webglTexture),o.memory.textures--),i.remove(V[ee])}i.remove(T)}let N=0;function k(){N=0}function z(){const T=N;return T>=s.maxTextures&&nt("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),N+=1,T}function K(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function $(T,g){const V=i.get(T);if(T.isVideoTexture&&he(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&V.__version!==T.version){const ee=T.image;if(ee===null)nt("WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)nt("WebGLRenderer: Texture marked for update but image is incomplete");else{q(V,T,g);return}}else T.isExternalTexture&&(V.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,V.__webglTexture,n.TEXTURE0+g)}function O(T,g){const V=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&V.__version!==T.version){q(V,T,g);return}else T.isExternalTexture&&(V.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,V.__webglTexture,n.TEXTURE0+g)}function G(T,g){const V=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&V.__version!==T.version){q(V,T,g);return}t.bindTexture(n.TEXTURE_3D,V.__webglTexture,n.TEXTURE0+g)}function Y(T,g){const V=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&V.__version!==T.version){te(V,T,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture,n.TEXTURE0+g)}const me={[ds]:n.REPEAT,[On]:n.CLAMP_TO_EDGE,[hc]:n.MIRRORED_REPEAT},ge={[sn]:n.NEAREST,[J_]:n.NEAREST_MIPMAP_NEAREST,[Mo]:n.NEAREST_MIPMAP_LINEAR,[Kt]:n.LINEAR,[rl]:n.LINEAR_MIPMAP_NEAREST,[Ai]:n.LINEAR_MIPMAP_LINEAR},de={[n0]:n.NEVER,[a0]:n.ALWAYS,[i0]:n.LESS,[Eu]:n.LEQUAL,[s0]:n.EQUAL,[Tu]:n.GEQUAL,[r0]:n.GREATER,[o0]:n.NOTEQUAL};function Re(T,g){if(g.type===$n&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Kt||g.magFilter===rl||g.magFilter===Mo||g.magFilter===Ai||g.minFilter===Kt||g.minFilter===rl||g.minFilter===Mo||g.minFilter===Ai)&&nt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(T,n.TEXTURE_WRAP_S,me[g.wrapS]),n.texParameteri(T,n.TEXTURE_WRAP_T,me[g.wrapT]),(T===n.TEXTURE_3D||T===n.TEXTURE_2D_ARRAY)&&n.texParameteri(T,n.TEXTURE_WRAP_R,me[g.wrapR]),n.texParameteri(T,n.TEXTURE_MAG_FILTER,ge[g.magFilter]),n.texParameteri(T,n.TEXTURE_MIN_FILTER,ge[g.minFilter]),g.compareFunction&&(n.texParameteri(T,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(T,n.TEXTURE_COMPARE_FUNC,de[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===sn||g.minFilter!==Mo&&g.minFilter!==Ai||g.type===$n&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const V=e.get("EXT_texture_filter_anisotropic");n.texParameterf(T,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function Se(T,g){let V=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",I));const ee=g.source;let oe=f.get(ee);oe===void 0&&(oe={},f.set(ee,oe));const J=K(g);if(J!==T.__cacheKey){oe[J]===void 0&&(oe[J]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,V=!0),oe[J].usedTimes++;const Ue=oe[T.__cacheKey];Ue!==void 0&&(oe[T.__cacheKey].usedTimes--,Ue.usedTimes===0&&v(g)),T.__cacheKey=J,T.__webglTexture=oe[J].texture}return V}function Ne(T,g,V){return Math.floor(Math.floor(T/V)/g)}function Pe(T,g,V,ee){const J=T.updateRanges;if(J.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,g.width,g.height,V,ee,g.data);else{J.sort((xe,Ae)=>xe.start-Ae.start);let Ue=0;for(let xe=1;xe<J.length;xe++){const Ae=J[Ue],De=J[xe],Ve=Ae.start+Ae.count,Te=Ne(De.start,g.width,4),lt=Ne(Ae.start,g.width,4);De.start<=Ve+1&&Te===lt&&Ne(De.start+De.count-1,g.width,4)===Te?Ae.count=Math.max(Ae.count,De.start+De.count-Ae.start):(++Ue,J[Ue]=De)}J.length=Ue+1;const Me=n.getParameter(n.UNPACK_ROW_LENGTH),ke=n.getParameter(n.UNPACK_SKIP_PIXELS),$e=n.getParameter(n.UNPACK_SKIP_ROWS);n.pixelStorei(n.UNPACK_ROW_LENGTH,g.width);for(let xe=0,Ae=J.length;xe<Ae;xe++){const De=J[xe],Ve=Math.floor(De.start/4),Te=Math.ceil(De.count/4),lt=Ve%g.width,W=Math.floor(Ve/g.width),Oe=Te,Ee=1;n.pixelStorei(n.UNPACK_SKIP_PIXELS,lt),n.pixelStorei(n.UNPACK_SKIP_ROWS,W),t.texSubImage2D(n.TEXTURE_2D,0,lt,W,Oe,Ee,V,ee,g.data)}T.clearUpdateRanges(),n.pixelStorei(n.UNPACK_ROW_LENGTH,Me),n.pixelStorei(n.UNPACK_SKIP_PIXELS,ke),n.pixelStorei(n.UNPACK_SKIP_ROWS,$e)}}function q(T,g,V){let ee=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(ee=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(ee=n.TEXTURE_3D);const oe=Se(T,g),J=g.source;t.bindTexture(ee,T.__webglTexture,n.TEXTURE0+V);const Ue=i.get(J);if(J.version!==Ue.__version||oe===!0){t.activeTexture(n.TEXTURE0+V);const Me=vt.getPrimaries(vt.workingColorSpace),ke=g.colorSpace===Yi?null:vt.getPrimaries(g.colorSpace),$e=g.colorSpace===Yi||Me===ke?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,$e);let xe=x(g.image,!1,s.maxTextureSize);xe=ae(g,xe);const Ae=r.convert(g.format,g.colorSpace),De=r.convert(g.type);let Ve=D(g.internalFormat,Ae,De,g.colorSpace,g.isVideoTexture);Re(ee,g);let Te;const lt=g.mipmaps,W=g.isVideoTexture!==!0,Oe=Ue.__version===void 0||oe===!0,Ee=J.dataReady,Ge=R(g,xe);if(g.isDepthTexture)Ve=E(g.format===ps,g.type),Oe&&(W?t.texStorage2D(n.TEXTURE_2D,1,Ve,xe.width,xe.height):t.texImage2D(n.TEXTURE_2D,0,Ve,xe.width,xe.height,0,Ae,De,null));else if(g.isDataTexture)if(lt.length>0){W&&Oe&&t.texStorage2D(n.TEXTURE_2D,Ge,Ve,lt[0].width,lt[0].height);for(let ye=0,pe=lt.length;ye<pe;ye++)Te=lt[ye],W?Ee&&t.texSubImage2D(n.TEXTURE_2D,ye,0,0,Te.width,Te.height,Ae,De,Te.data):t.texImage2D(n.TEXTURE_2D,ye,Ve,Te.width,Te.height,0,Ae,De,Te.data);g.generateMipmaps=!1}else W?(Oe&&t.texStorage2D(n.TEXTURE_2D,Ge,Ve,xe.width,xe.height),Ee&&Pe(g,xe,Ae,De)):t.texImage2D(n.TEXTURE_2D,0,Ve,xe.width,xe.height,0,Ae,De,xe.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){W&&Oe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ge,Ve,lt[0].width,lt[0].height,xe.depth);for(let ye=0,pe=lt.length;ye<pe;ye++)if(Te=lt[ye],g.format!==zn)if(Ae!==null)if(W){if(Ee)if(g.layerUpdates.size>0){const we=df(Te.width,Te.height,g.format,g.type);for(const ot of g.layerUpdates){const Nt=Te.data.subarray(ot*we/Te.data.BYTES_PER_ELEMENT,(ot+1)*we/Te.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ye,0,0,ot,Te.width,Te.height,1,Ae,Nt)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ye,0,0,0,Te.width,Te.height,xe.depth,Ae,Te.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ye,Ve,Te.width,Te.height,xe.depth,0,Te.data,0,0);else nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else W?Ee&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ye,0,0,0,Te.width,Te.height,xe.depth,Ae,De,Te.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ye,Ve,Te.width,Te.height,xe.depth,0,Ae,De,Te.data)}else{W&&Oe&&t.texStorage2D(n.TEXTURE_2D,Ge,Ve,lt[0].width,lt[0].height);for(let ye=0,pe=lt.length;ye<pe;ye++)Te=lt[ye],g.format!==zn?Ae!==null?W?Ee&&t.compressedTexSubImage2D(n.TEXTURE_2D,ye,0,0,Te.width,Te.height,Ae,Te.data):t.compressedTexImage2D(n.TEXTURE_2D,ye,Ve,Te.width,Te.height,0,Te.data):nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):W?Ee&&t.texSubImage2D(n.TEXTURE_2D,ye,0,0,Te.width,Te.height,Ae,De,Te.data):t.texImage2D(n.TEXTURE_2D,ye,Ve,Te.width,Te.height,0,Ae,De,Te.data)}else if(g.isDataArrayTexture)if(W){if(Oe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Ge,Ve,xe.width,xe.height,xe.depth),Ee)if(g.layerUpdates.size>0){const ye=df(xe.width,xe.height,g.format,g.type);for(const pe of g.layerUpdates){const we=xe.data.subarray(pe*ye/xe.data.BYTES_PER_ELEMENT,(pe+1)*ye/xe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,pe,xe.width,xe.height,1,Ae,De,we)}g.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,xe.width,xe.height,xe.depth,Ae,De,xe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ve,xe.width,xe.height,xe.depth,0,Ae,De,xe.data);else if(g.isData3DTexture)W?(Oe&&t.texStorage3D(n.TEXTURE_3D,Ge,Ve,xe.width,xe.height,xe.depth),Ee&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,xe.width,xe.height,xe.depth,Ae,De,xe.data)):t.texImage3D(n.TEXTURE_3D,0,Ve,xe.width,xe.height,xe.depth,0,Ae,De,xe.data);else if(g.isFramebufferTexture){if(Oe)if(W)t.texStorage2D(n.TEXTURE_2D,Ge,Ve,xe.width,xe.height);else{let ye=xe.width,pe=xe.height;for(let we=0;we<Ge;we++)t.texImage2D(n.TEXTURE_2D,we,Ve,ye,pe,0,Ae,De,null),ye>>=1,pe>>=1}}else if(lt.length>0){if(W&&Oe){const ye=fe(lt[0]);t.texStorage2D(n.TEXTURE_2D,Ge,Ve,ye.width,ye.height)}for(let ye=0,pe=lt.length;ye<pe;ye++)Te=lt[ye],W?Ee&&t.texSubImage2D(n.TEXTURE_2D,ye,0,0,Ae,De,Te):t.texImage2D(n.TEXTURE_2D,ye,Ve,Ae,De,Te);g.generateMipmaps=!1}else if(W){if(Oe){const ye=fe(xe);t.texStorage2D(n.TEXTURE_2D,Ge,Ve,ye.width,ye.height)}Ee&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ae,De,xe)}else t.texImage2D(n.TEXTURE_2D,0,Ve,Ae,De,xe);m(g)&&d(ee),Ue.__version=J.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function te(T,g,V){if(g.image.length!==6)return;const ee=Se(T,g),oe=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,T.__webglTexture,n.TEXTURE0+V);const J=i.get(oe);if(oe.version!==J.__version||ee===!0){t.activeTexture(n.TEXTURE0+V);const Ue=vt.getPrimaries(vt.workingColorSpace),Me=g.colorSpace===Yi?null:vt.getPrimaries(g.colorSpace),ke=g.colorSpace===Yi||Ue===Me?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ke);const $e=g.isCompressedTexture||g.image[0].isCompressedTexture,xe=g.image[0]&&g.image[0].isDataTexture,Ae=[];for(let pe=0;pe<6;pe++)!$e&&!xe?Ae[pe]=x(g.image[pe],!0,s.maxCubemapSize):Ae[pe]=xe?g.image[pe].image:g.image[pe],Ae[pe]=ae(g,Ae[pe]);const De=Ae[0],Ve=r.convert(g.format,g.colorSpace),Te=r.convert(g.type),lt=D(g.internalFormat,Ve,Te,g.colorSpace),W=g.isVideoTexture!==!0,Oe=J.__version===void 0||ee===!0,Ee=oe.dataReady;let Ge=R(g,De);Re(n.TEXTURE_CUBE_MAP,g);let ye;if($e){W&&Oe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ge,lt,De.width,De.height);for(let pe=0;pe<6;pe++){ye=Ae[pe].mipmaps;for(let we=0;we<ye.length;we++){const ot=ye[we];g.format!==zn?Ve!==null?W?Ee&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we,0,0,ot.width,ot.height,Ve,ot.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we,lt,ot.width,ot.height,0,ot.data):nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):W?Ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we,0,0,ot.width,ot.height,Ve,Te,ot.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we,lt,ot.width,ot.height,0,Ve,Te,ot.data)}}}else{if(ye=g.mipmaps,W&&Oe){ye.length>0&&Ge++;const pe=fe(Ae[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Ge,lt,pe.width,pe.height)}for(let pe=0;pe<6;pe++)if(xe){W?Ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,0,0,Ae[pe].width,Ae[pe].height,Ve,Te,Ae[pe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,lt,Ae[pe].width,Ae[pe].height,0,Ve,Te,Ae[pe].data);for(let we=0;we<ye.length;we++){const Nt=ye[we].image[pe].image;W?Ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we+1,0,0,Nt.width,Nt.height,Ve,Te,Nt.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we+1,lt,Nt.width,Nt.height,0,Ve,Te,Nt.data)}}else{W?Ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,0,0,Ve,Te,Ae[pe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,lt,Ve,Te,Ae[pe]);for(let we=0;we<ye.length;we++){const ot=ye[we];W?Ee&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we+1,0,0,Ve,Te,ot.image[pe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+pe,we+1,lt,Ve,Te,ot.image[pe])}}}m(g)&&d(n.TEXTURE_CUBE_MAP),J.__version=oe.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function be(T,g,V,ee,oe,J){const Ue=r.convert(V.format,V.colorSpace),Me=r.convert(V.type),ke=D(V.internalFormat,Ue,Me,V.colorSpace),$e=i.get(g),xe=i.get(V);if(xe.__renderTarget=g,!$e.__hasExternalTextures){const Ae=Math.max(1,g.width>>J),De=Math.max(1,g.height>>J);oe===n.TEXTURE_3D||oe===n.TEXTURE_2D_ARRAY?t.texImage3D(oe,J,ke,Ae,De,g.depth,0,Ue,Me,null):t.texImage2D(oe,J,ke,Ae,De,0,Ue,Me,null)}t.bindFramebuffer(n.FRAMEBUFFER,T),_e(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ee,oe,xe.__webglTexture,0,U(g)):(oe===n.TEXTURE_2D||oe>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,ee,oe,xe.__webglTexture,J),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Qe(T,g,V){if(n.bindRenderbuffer(n.RENDERBUFFER,T),g.depthBuffer){const ee=g.depthTexture,oe=ee&&ee.isDepthTexture?ee.type:null,J=E(g.stencilBuffer,oe),Ue=g.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;_e(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,U(g),J,g.width,g.height):V?n.renderbufferStorageMultisample(n.RENDERBUFFER,U(g),J,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,J,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Ue,n.RENDERBUFFER,T)}else{const ee=g.textures;for(let oe=0;oe<ee.length;oe++){const J=ee[oe],Ue=r.convert(J.format,J.colorSpace),Me=r.convert(J.type),ke=D(J.internalFormat,Ue,Me,J.colorSpace);_e(g)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,U(g),ke,g.width,g.height):V?n.renderbufferStorageMultisample(n.RENDERBUFFER,U(g),ke,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,ke,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Be(T,g,V){const ee=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const oe=i.get(g.depthTexture);if(oe.__renderTarget=g,(!oe.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),ee){if(oe.__webglInit===void 0&&(oe.__webglInit=!0,g.depthTexture.addEventListener("dispose",I)),oe.__webglTexture===void 0){oe.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,oe.__webglTexture),Re(n.TEXTURE_CUBE_MAP,g.depthTexture);const $e=r.convert(g.depthTexture.format),xe=r.convert(g.depthTexture.type);let Ae;g.depthTexture.format===Ii?Ae=n.DEPTH_COMPONENT24:g.depthTexture.format===ps&&(Ae=n.DEPTH24_STENCIL8);for(let De=0;De<6;De++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+De,0,Ae,g.width,g.height,0,$e,xe,null)}}else $(g.depthTexture,0);const J=oe.__webglTexture,Ue=U(g),Me=ee?n.TEXTURE_CUBE_MAP_POSITIVE_X+V:n.TEXTURE_2D,ke=g.depthTexture.format===ps?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(g.depthTexture.format===Ii)_e(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ke,Me,J,0,Ue):n.framebufferTexture2D(n.FRAMEBUFFER,ke,Me,J,0);else if(g.depthTexture.format===ps)_e(g)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,ke,Me,J,0,Ue):n.framebufferTexture2D(n.FRAMEBUFFER,ke,Me,J,0);else throw new Error("Unknown depthTexture format")}function Mt(T){const g=i.get(T),V=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const ee=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),ee){const oe=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,ee.removeEventListener("dispose",oe)};ee.addEventListener("dispose",oe),g.__depthDisposeCallback=oe}g.__boundDepthTexture=ee}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(V)for(let ee=0;ee<6;ee++)Be(g.__webglFramebuffer[ee],T,ee);else{const ee=T.texture.mipmaps;ee&&ee.length>0?Be(g.__webglFramebuffer[0],T,0):Be(g.__webglFramebuffer,T,0)}else if(V){g.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)if(t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[ee]),g.__webglDepthbuffer[ee]===void 0)g.__webglDepthbuffer[ee]=n.createRenderbuffer(),Qe(g.__webglDepthbuffer[ee],T,!1);else{const oe=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,J=g.__webglDepthbuffer[ee];n.bindRenderbuffer(n.RENDERBUFFER,J),n.framebufferRenderbuffer(n.FRAMEBUFFER,oe,n.RENDERBUFFER,J)}}else{const ee=T.texture.mipmaps;if(ee&&ee.length>0?t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=n.createRenderbuffer(),Qe(g.__webglDepthbuffer,T,!1);else{const oe=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,J=g.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,J),n.framebufferRenderbuffer(n.FRAMEBUFFER,oe,n.RENDERBUFFER,J)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function B(T,g,V){const ee=i.get(T);g!==void 0&&be(ee.__webglFramebuffer,T,T.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),V!==void 0&&Mt(T)}function H(T){const g=T.texture,V=i.get(T),ee=i.get(g);T.addEventListener("dispose",L);const oe=T.textures,J=T.isWebGLCubeRenderTarget===!0,Ue=oe.length>1;if(Ue||(ee.__webglTexture===void 0&&(ee.__webglTexture=n.createTexture()),ee.__version=g.version,o.memory.textures++),J){V.__webglFramebuffer=[];for(let Me=0;Me<6;Me++)if(g.mipmaps&&g.mipmaps.length>0){V.__webglFramebuffer[Me]=[];for(let ke=0;ke<g.mipmaps.length;ke++)V.__webglFramebuffer[Me][ke]=n.createFramebuffer()}else V.__webglFramebuffer[Me]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){V.__webglFramebuffer=[];for(let Me=0;Me<g.mipmaps.length;Me++)V.__webglFramebuffer[Me]=n.createFramebuffer()}else V.__webglFramebuffer=n.createFramebuffer();if(Ue)for(let Me=0,ke=oe.length;Me<ke;Me++){const $e=i.get(oe[Me]);$e.__webglTexture===void 0&&($e.__webglTexture=n.createTexture(),o.memory.textures++)}if(T.samples>0&&_e(T)===!1){V.__webglMultisampledFramebuffer=n.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let Me=0;Me<oe.length;Me++){const ke=oe[Me];V.__webglColorRenderbuffer[Me]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,V.__webglColorRenderbuffer[Me]);const $e=r.convert(ke.format,ke.colorSpace),xe=r.convert(ke.type),Ae=D(ke.internalFormat,$e,xe,ke.colorSpace,T.isXRRenderTarget===!0),De=U(T);n.renderbufferStorageMultisample(n.RENDERBUFFER,De,Ae,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Me,n.RENDERBUFFER,V.__webglColorRenderbuffer[Me])}n.bindRenderbuffer(n.RENDERBUFFER,null),T.depthBuffer&&(V.__webglDepthRenderbuffer=n.createRenderbuffer(),Qe(V.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(J){t.bindTexture(n.TEXTURE_CUBE_MAP,ee.__webglTexture),Re(n.TEXTURE_CUBE_MAP,g);for(let Me=0;Me<6;Me++)if(g.mipmaps&&g.mipmaps.length>0)for(let ke=0;ke<g.mipmaps.length;ke++)be(V.__webglFramebuffer[Me][ke],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Me,ke);else be(V.__webglFramebuffer[Me],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0);m(g)&&d(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ue){for(let Me=0,ke=oe.length;Me<ke;Me++){const $e=oe[Me],xe=i.get($e);let Ae=n.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Ae=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Ae,xe.__webglTexture),Re(Ae,$e),be(V.__webglFramebuffer,T,$e,n.COLOR_ATTACHMENT0+Me,Ae,0),m($e)&&d(Ae)}t.unbindTexture()}else{let Me=n.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Me=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(Me,ee.__webglTexture),Re(Me,g),g.mipmaps&&g.mipmaps.length>0)for(let ke=0;ke<g.mipmaps.length;ke++)be(V.__webglFramebuffer[ke],T,g,n.COLOR_ATTACHMENT0,Me,ke);else be(V.__webglFramebuffer,T,g,n.COLOR_ATTACHMENT0,Me,0);m(g)&&d(Me),t.unbindTexture()}T.depthBuffer&&Mt(T)}function Q(T){const g=T.textures;for(let V=0,ee=g.length;V<ee;V++){const oe=g[V];if(m(oe)){const J=A(T),Ue=i.get(oe).__webglTexture;t.bindTexture(J,Ue),d(J),t.unbindTexture()}}}const le=[],se=[];function ce(T){if(T.samples>0){if(_e(T)===!1){const g=T.textures,V=T.width,ee=T.height;let oe=n.COLOR_BUFFER_BIT;const J=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Ue=i.get(T),Me=g.length>1;if(Me)for(let $e=0;$e<g.length;$e++)t.bindFramebuffer(n.FRAMEBUFFER,Ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+$e,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+$e,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Ue.__webglMultisampledFramebuffer);const ke=T.texture.mipmaps;ke&&ke.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ue.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ue.__webglFramebuffer);for(let $e=0;$e<g.length;$e++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(oe|=n.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(oe|=n.STENCIL_BUFFER_BIT)),Me){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Ue.__webglColorRenderbuffer[$e]);const xe=i.get(g[$e]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,xe,0)}n.blitFramebuffer(0,0,V,ee,0,0,V,ee,oe,n.NEAREST),l===!0&&(le.length=0,se.length=0,le.push(n.COLOR_ATTACHMENT0+$e),T.depthBuffer&&T.resolveDepthBuffer===!1&&(le.push(J),se.push(J),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,se)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,le))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),Me)for(let $e=0;$e<g.length;$e++){t.bindFramebuffer(n.FRAMEBUFFER,Ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+$e,n.RENDERBUFFER,Ue.__webglColorRenderbuffer[$e]);const xe=i.get(g[$e]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+$e,n.TEXTURE_2D,xe,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Ue.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function U(T){return Math.min(s.maxSamples,T.samples)}function _e(T){const g=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function he(T){const g=o.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function ae(T,g){const V=T.colorSpace,ee=T.format,oe=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||V!==ur&&V!==Yi&&(vt.getTransfer(V)===Lt?(ee!==zn||oe!==Nn)&&nt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):_t("WebGLTextures: Unsupported texture color space:",V)),g}function fe(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=k,this.setTexture2D=$,this.setTexture2DArray=O,this.setTexture3D=G,this.setTextureCube=Y,this.rebindTextures=B,this.setupRenderTarget=H,this.updateRenderTargetMipmap=Q,this.updateMultisampleRenderTarget=ce,this.setupDepthRenderbuffer=Mt,this.setupFrameBufferTexture=be,this.useMultisampledRTT=_e,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function pb(n,e){function t(i,s=Yi){let r;const o=vt.getTransfer(s);if(i===Nn)return n.UNSIGNED_BYTE;if(i===xu)return n.UNSIGNED_SHORT_4_4_4_4;if(i===vu)return n.UNSIGNED_SHORT_5_5_5_1;if(i===rp)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===op)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===ip)return n.BYTE;if(i===sp)return n.SHORT;if(i===Qr)return n.UNSIGNED_SHORT;if(i===_u)return n.INT;if(i===hi)return n.UNSIGNED_INT;if(i===$n)return n.FLOAT;if(i===Ni)return n.HALF_FLOAT;if(i===ap)return n.ALPHA;if(i===lp)return n.RGB;if(i===zn)return n.RGBA;if(i===Ii)return n.DEPTH_COMPONENT;if(i===ps)return n.DEPTH_STENCIL;if(i===cp)return n.RED;if(i===Mu)return n.RED_INTEGER;if(i===cr)return n.RG;if(i===yu)return n.RG_INTEGER;if(i===Su)return n.RGBA_INTEGER;if(i===ia||i===sa||i===ra||i===oa)if(o===Lt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===ia)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===sa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ra)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===oa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===ia)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===sa)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ra)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===oa)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===fc||i===dc||i===pc||i===mc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===fc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===dc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===pc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===mc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===gc||i===_c||i===xc||i===vc||i===Mc||i===yc||i===Sc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===gc||i===_c)return o===Lt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===xc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===vc)return r.COMPRESSED_R11_EAC;if(i===Mc)return r.COMPRESSED_SIGNED_R11_EAC;if(i===yc)return r.COMPRESSED_RG11_EAC;if(i===Sc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===bc||i===Ec||i===Tc||i===Ac||i===wc||i===Rc||i===Cc||i===Pc||i===Dc||i===Lc||i===Nc||i===Ic||i===Uc||i===Fc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===bc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ec)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Tc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Ac)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===wc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Rc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Cc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Pc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Dc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Lc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Nc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ic)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Uc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Fc)return o===Lt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Oc||i===Bc||i===kc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Oc)return o===Lt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Bc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===kc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Vc||i===zc||i===Hc||i===Gc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Vc)return r.COMPRESSED_RED_RGTC1_EXT;if(i===zc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Hc)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Gc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===eo?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const mb=`
void main() {
